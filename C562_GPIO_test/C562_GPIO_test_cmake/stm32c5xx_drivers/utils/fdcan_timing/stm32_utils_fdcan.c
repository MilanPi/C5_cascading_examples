/**
  **********************************************************************************************************************
  * @file    stm32_stm32_utils_fdcan.c
...
/**
  ...
  * @retval STM32_STM32_UTILS_FDCAN_OK            Configuration matching the bus parameters was found.
  * @retval STM32_STM32_UTILS_FDCAN_ERROR         No configuration matching the bus parameters was found. Data output
  *                                               must be discarded.
  * @retval STM32_STM32_UTILS_FDCAN_INVALID_PARAM Pointer parameter is NULL.
  */
