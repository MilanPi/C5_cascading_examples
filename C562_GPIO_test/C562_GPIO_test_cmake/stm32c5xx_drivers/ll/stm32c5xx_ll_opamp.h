...
#define LL_OPAMP_INPUT_NONINVERT_IO0             (0x00000000U)        /*!< OPAMP non inverting input connected to
                                                 GPIO pin (pin PA1 for OPAMP1) */
#define LL_OPAMP_INPUT_NONINVERT_IO1             (OPAMP_CSR_VP_SEL_0) /*!< OPAMP non inverting input connected to
                                                 GPIO pin (pin pin PB0 for OPAMP1) */
#define LL_OPAMP_INPUT_NONINVERT_DAC1_CH1        (OPAMP_CSR_VP_SEL)   /*!< OPAMP non inverting input connected to
                                                 DAC1 channel output(channel1 for OPAMP1) */
/**
  * @}
  */
...
#define LL_OPAMP_INPUT_INVERT_IO0                (0x00000000U)         /*!< OPAMP inverting input connected
                                                 to GPIO pin (valid also in PGA mode for filtering).
...
#define LL_OPAMP_INPUT_INVERT_CONNECT_NO         (OPAMP_CSR_VM_SEL_1)  /*!< OPAMP inverting input not externally
                                                 connected (intended for OPAMP in mode follower or PGA without
                                                 external capacitors for filtering) */
#define LL_OPAMP_INPUT_INVERT_OPAMP_OUT          (OPAMP_CSR_VM_SEL_1 | OPAMP_CSR_VM_SEL_0) /*!< OPAMP inverting input
                                                 connected to OPAMP OUT (intended for OPAMP in mode follower) */
/**
  * @}
  */
...
/** @defgroup OPAMP_LL_EC_TIM_CTRL_INPUT OPAMP Timer-controlled input selection
  ...
  *       ex LL_OPAMP_MUX_INPUTS_CTRL_TIM2_CH6 | LL_OPAMP_MUX_INPUTS_CTRL_TIM2_CH4
  * @{
  */
#define LL_OPAMP_MUX_INPUTS_CTRL_DISABLE         (0x00000000UL)  /*!< Timer-controlled input selection disabled */
#define LL_OPAMP_MUX_INPUTS_CTRL_TIM1_CH6        (OPAMP_TCMR_TIMCM_SEL_0)   /*!< Timer-controlled input selection using
                                                                                 TIM1 OC6 */
#define LL_OPAMP_MUX_INPUTS_CTRL_TIM2_CH4        (OPAMP_TCMR_TIMCM_SEL_1)   /*!< Timer-controlled input selection using
                                                                                 TIM2 OC4 */
#define LL_OPAMP_MUX_INPUTS_CTRL_TIM8_CH6        (OPAMP_TCMR_TIMCM_SEL_1 \
                                                  | OPAMP_TCMR_TIMCM_SEL_0) /*!< Timer-controlled input selection using
                                                                                 TIM8 OC6 */
#define LL_OPAMP_MUX_INPUTS_CTRL_TIM12_CH1       (OPAMP_TCMR_TIMCM_SEL_2)   /*!< Timer-controlled input selection using
                                                                                 TIM12 OC1 */
#define LL_OPAMP_MUX_INPUTS_CTRL_TIM15_CH2       (OPAMP_TCMR_TIMCM_SEL_2 \
                                                  | OPAMP_TCMR_TIMCM_SEL_0) /*!< Timer-controlled input selection using
                                                                                 TIM15 OC2 */
#define LL_OPAMP_MUX_INPUTS_CTRL_TIM20_CH6       (OPAMP_TCMR_TIMCM_SEL_2 \
                                                  | OPAMP_TCMR_TIMCM_SEL_1) /*!< Timer-controlled input selection using
                                                                                 TIM20 OC6 */
...
#define LL_OPAMP_MUX_PGA_GAIN_CTRL_DISABLE       (0x00000000UL) /*!< Timer-controlled programmable gain
                                                                    selection disabled */
#define LL_OPAMP_MUX_PGA_GAIN_CTRL_TIM1_CH6      (OPAMP_TCMR_TIMPGA_SEL_0)   /*!< Timer-controlled programmable gain
                                                                                  selection using TIM1 OC6 */
#define LL_OPAMP_MUX_PGA_GAIN_CTRL_TIM3_CH2      (OPAMP_TCMR_TIMPGA_SEL_1)   /*!< Timer-controlled programmable gain
                                                                                  selection using TIM3 OC2 */
#define LL_OPAMP_MUX_PGA_GAIN_CTRL_TIM8_CH6      (OPAMP_TCMR_TIMPGA_SEL_1 \
                                                  | OPAMP_TCMR_TIMPGA_SEL_0) /*!< Timer-controlled programmable gain
                                                                                  selection using TIM8 OC6 */
#define LL_OPAMP_MUX_PGA_GAIN_CTRL_TIM9_CH1      (OPAMP_TCMR_TIMPGA_SEL_2)   /*!< Timer-controlled programmable gain
                                                                                  selection using TIM9 OC1 */
#define LL_OPAMP_MUX_PGA_GAIN_CTRL_TIM15_CH2     (OPAMP_TCMR_TIMPGA_SEL_2 \
                                                  | OPAMP_TCMR_TIMPGA_SEL_0) /*!< Timer-controlled programmable gain
                                                                                  selection using TIM15 OC2 */
#define LL_OPAMP_MUX_PGA_GAIN_CTRL_TIM20_CH6     (OPAMP_TCMR_TIMPGA_SEL_2 \
                                                  | OPAMP_TCMR_TIMPGA_SEL_1) /*!< Timer-controlled programmable gain
                                                                                  selection using TIM20 OC6 */
...
__STATIC_INLINE void LL_OPAMP_SetConfigurationMode(OPAMP_TypeDef *p_opamp, uint32_t mode)
{
  ...
  MODIFY_REG(p_opamp->CSR, OPAMP_CSR_VM_SEL | OPAMP_CSR_CALON, mode);
}
...
{
  uint32_t tmp_csr = READ_BIT(p_opamp->CSR, OPAMP_CSR_VM_SEL);
...
{
  MODIFY_REG(p_opamp->CSR, (OPAMP_CSR_PGA_GAIN_4 | OPAMP_CSR_PGA_GAIN_3), mode);
}
...
{
  return (uint32_t)(READ_BIT(p_opamp->CSR, (OPAMP_CSR_PGA_GAIN_4 | OPAMP_CSR_PGA_GAIN_3)));
}
...
__STATIC_INLINE void LL_OPAMP_SetConfig(OPAMP_TypeDef *p_opamp, uint32_t reg_value)
{
  MODIFY_REG(p_opamp->CSR, ((OPAMP_CSR_CALON)                                       /* To set functional mode */
                            | (uint32_t)(OPAMP_CSR_OPAHSM)                          /* To set high speed mode */
                            | (uint32_t)(OPAMP_CSR_VM_SEL)                          /* To set inverting input */
                            | (uint32_t)(OPAMP_CSR_VP_SEL)                          /* To set non inverting input */
                            | (uint32_t)(OPAMP_CSR_OPAINTOEN)                       /* To set output connection */
                           ), reg_value);
}
...
/**
  ...
  *         @arg @ref LL_OPAMP_INPUT_INVERT_OPAMP_OUT
...
{
  return ((READ_BIT(p_opamp->CSR, OPAMP_CSR_CALOUT) == OPAMP_CSR_CALOUT) ? 0UL : 1UL);
}
...
# add InputNonInverting
  */
__STATIC_INLINE uint32_t LL_OPAMP_GetInputMuxNonInvertingSecondary(OPAMP_TypeDef *p_opamp)
{
  return (uint32_t)(READ_BIT(p_opamp->TCMR, OPAMP_TCMR_VPS_SEL) << 1UL);
}
...
{
  MODIFY_REG(p_opamp->TCMR, OPAMP_TCMR_VMS_SEL,
             ((input_inverting_sec == LL_OPAMP_INPUT_INVERT_IO1
               || input_inverting_sec == LL_OPAMP_INPUT_INVERT_OPAMP_OUT) ? 1UL : 0UL));
}
...
/**
  ...
  *         @arg @ref LL_OPAMP_INPUT_INVERT_OPAMP_OUT
  */
__STATIC_INLINE uint32_t LL_OPAMP_GetInputMuxInvertingSecondary(OPAMP_TypeDef *p_opamp)
{
  uint32_t csr_value = READ_BIT(p_opamp->CSR, OPAMP_CSR_VM_SEL_1);
  uint32_t tcmr_value = READ_BIT(p_opamp->TCMR, OPAMP_TCMR_VMS_SEL);
...
{
  MODIFY_REG(p_opamp->TCMR, (OPAMP_TCMR_VPS_SEL | OPAMP_TCMR_VMS_SEL),
...
/**
  ...
  * @rmtoll
  *  TCMR     TCMEN          LL_OPAMP_SetMuxInputsCtrl
  * @param  p_opamp OPAMP instance
  * @param  mux_inputs_ctrl This parameter can be one of the following values:
# add InputsMuxMode
  */
__STATIC_INLINE void LL_OPAMP_SetMuxInputsCtrl(OPAMP_TypeDef *p_opamp, uint32_t mux_inputs_ctrl)
{
  MODIFY_REG(p_opamp->TCMR, OPAMP_TCMR_TIMCM_SEL, mux_inputs_ctrl);
}

/**
  * @brief  Get OPAMP inputs multiplexer mode.
  * @rmtoll
  *  TCMR     TCMEN          LL_OPAMP_GetMuxInputsCtrl
  * @param  p_opamp OPAMP instance
  * @retval Returned value can be one of the following values:
# add InputsMuxMode
  */
__STATIC_INLINE uint32_t LL_OPAMP_GetMuxInputsCtrl(OPAMP_TypeDef *p_opamp)
{
  return (uint32_t)(READ_BIT(p_opamp->TCMR, OPAMP_TCMR_TIMCM_SEL));
}
...
{
  MODIFY_REG(p_opamp->TCMR, OPAMP_TCMR_PGAS_GAIN, (gain_secondary >> 6UL));
}
...
{
  return (uint32_t)(READ_BIT(p_opamp->TCMR, OPAMP_TCMR_PGAS_GAIN) << 6UL);
}
...
{
  MODIFY_REG(p_opamp->TCMR,  OPAMP_TCMR_TIMPGA_SEL, mux_pga_ctrl);
}
...
# add MuxPGAMode
  */
__STATIC_INLINE uint32_t LL_OPAMP_GetMuxPGAGainCtrl(OPAMP_TypeDef *p_opamp)
{
  return (uint32_t)(READ_BIT(p_opamp->TCMR, OPAMP_TCMR_TIMPGA_SEL));
}
...
{
  MODIFY_REG(p_opamp->CSR, OPAMP_CSR_OPAINTOEN, opamp_out);
}
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_OPAMP_GetOutputConnection(OPAMP_TypeDef *p_opamp)
{
  return ((READ_BIT(p_opamp->CSR, OPAMP_CSR_OPAINTOEN) != 0UL) \
