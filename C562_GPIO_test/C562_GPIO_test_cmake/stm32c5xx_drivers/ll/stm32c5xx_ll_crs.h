...
/** @defgroup CRS_LL_EC_AUTO_TRIMMING Auto trimming
  * @{
  */
#define LL_CRS_AUTO_TRIMMING_DISABLE       0U                      /*!< Auto trimming disable (default) */
#define LL_CRS_AUTO_TRIMMING_ENABLE        CRS_CR_AUTOTRIMEN       /*!< Auto trimming enable */
/**
  * @}
  */
...
#define LL_CRS_SYNC_SOURCE_HSE_1MHZ   (CRS_CFGR_SYNCSRC_0 | \
                                       CRS_CFGR_SYNCSRC_1)    /*!< Synchro Signal source HSE 1MHz */
/**
  * @}
  */
...
/**
  ...
  */
#define LL_CRS_WRITE_REG(instance, reg, value) WRITE_REG((instance)->reg, (value))
...
/**
  ...
  */
#define LL_CRS_READ_REG(instance, reg) READ_REG((instance)->reg)
/**
  * @}
  */
...
/**
  ...
  */
#define LL_CRS_READ_FREQ_ERROR_DIRECTION(value) (READ_BIT((value), CRS_ISR_FEDIR))
...
/**
  ...
  */
#define LL_CRS_READ_FREQ_ERROR_CAPTURE(value) (READ_BIT((value), CRS_ISR_FECAP) >> CRS_ISR_FECAP_Pos)
/**
  * @}
  */
...
{
  return ((READ_BIT(crsx->CR, CRS_CR_CEN) == (CRS_CR_CEN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(crsx->CR, CRS_CR_AUTOTRIMEN);
}
...
{
  CLEAR_BIT(crsx->CR, CRS_CR_AUTOTRIMEN);
}
...
{
  return ((READ_BIT(crsx->CR, CRS_CR_AUTOTRIMEN) == (CRS_CR_AUTOTRIMEN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(crsx->CR, CRS_CR_TRIM, value << CRS_CR_TRIM_Pos);
}
...
{
  return (uint32_t)(READ_BIT(crsx->CR, CRS_CR_TRIM) >> CRS_CR_TRIM_Pos);
}
...
/**
  ...
  *         Otherwise it can be calculated in using macro @ref LL_CRS_CALCULATE_RELOAD(_FTARGET_, _FSYNC_).
  */
__STATIC_INLINE void LL_CRS_SetReloadCounter(CRS_TypeDef *crsx, uint32_t value)
{
  MODIFY_REG(crsx->CFGR, CRS_CFGR_RELOAD, value);
}
...
{
  return (uint32_t)(READ_BIT(crsx->CFGR, CRS_CFGR_RELOAD));
}
...
{
  MODIFY_REG(crsx->CFGR, CRS_CFGR_FELIM, value << CRS_CFGR_FELIM_Pos);
}
...
{
  return (uint32_t)(READ_BIT(crsx->CFGR, CRS_CFGR_FELIM) >> CRS_CFGR_FELIM_Pos);
}
...
{
  MODIFY_REG(crsx->CFGR, CRS_CFGR_SYNCDIV, divider);
}
...
{
  return (uint32_t)(READ_BIT(crsx->CFGR, CRS_CFGR_SYNCDIV));
}
...
{
  MODIFY_REG(crsx->CFGR, CRS_CFGR_SYNCSRC, source);
}
...
{
  return (uint32_t)(READ_BIT(crsx->CFGR, CRS_CFGR_SYNCSRC));
}
...
{
  MODIFY_REG(crsx->CFGR, CRS_CFGR_SYNCPOL, polarity);
}
...
{
  return (uint32_t)(READ_BIT(crsx->CFGR, CRS_CFGR_SYNCPOL));
}

/**
  * @brief   Configure CRS for the trimming.
  * @rmtoll
  ...
  * @param   auto_trimming LL_CRS_AUTO_TRIMMING_DISABLE to disable the auto trimming.
                          LL_CRS_AUTO_TRIMMING_ENABLE to enable the auto trimming.
...
{
  WRITE_REG(crsx->CR, ((trimming << CRS_CR_TRIM_Pos) | auto_trimming));
}
...
{
  return (uint32_t)(READ_BIT(crsx->ISR, CRS_ISR_FEDIR));
}
...
{
  return (uint32_t)(READ_BIT(crsx->ISR, CRS_ISR_FECAP) >> CRS_ISR_FECAP_Pos);
}

/**
  * @brief  Get the frequency error counter value and error direction latched in the time of the last SYNC event.
  * @rmtoll
...
{
  return (uint32_t)(READ_REG(crsx->ISR) & (CRS_ISR_FECAP | CRS_ISR_FEDIR));
}
...
{
  return ((READ_BIT(crsx->ISR, mask) != 0UL) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(crsx->ISR, CRS_ISR_SYNCOKF) == (CRS_ISR_SYNCOKF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(crsx->ISR, CRS_ISR_SYNCWARNF) == (CRS_ISR_SYNCWARNF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(crsx->ISR, CRS_ISR_ERRF) == (CRS_ISR_ERRF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(crsx->ISR, CRS_ISR_ESYNCF) == (CRS_ISR_ESYNCF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(crsx->ISR, CRS_ISR_SYNCERR) == (CRS_ISR_SYNCERR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(crsx->ISR, CRS_ISR_SYNCMISS) == (CRS_ISR_SYNCMISS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(crsx->ISR, CRS_ISR_TRIMOVF) == (CRS_ISR_TRIMOVF)) ? 1UL : 0UL);
}
...
{
  WRITE_REG(crsx->ICR, CRS_ICR_SYNCOKC);
}
...
{
  WRITE_REG(crsx->ICR, CRS_ICR_SYNCWARNC);
}
...
{
  WRITE_REG(crsx->ICR, CRS_ICR_ERRC);
}
...
{
  WRITE_REG(crsx->ICR, CRS_ICR_ESYNCC);
}
...
{
  return ((READ_BIT(crsx->CR, mask) == (mask)) ? 1UL : 0UL);
}
...
{
  SET_BIT(crsx->CR, CRS_CR_SYNCOKIE);
}
...
{
  CLEAR_BIT(crsx->CR, CRS_CR_SYNCOKIE);
}
...
{
  return ((READ_BIT(crsx->CR, CRS_CR_SYNCOKIE) == (CRS_CR_SYNCOKIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(crsx->CR, CRS_CR_SYNCWARNIE);
}
...
{
  CLEAR_BIT(crsx->CR, CRS_CR_SYNCWARNIE);
}
...
{
  return ((READ_BIT(crsx->CR, CRS_CR_SYNCWARNIE) == (CRS_CR_SYNCWARNIE)) ? 1UL : 0UL);
}
...
{
  CLEAR_BIT(crsx->CR, CRS_CR_ERRIE);
}
...
{
  return ((READ_BIT(crsx->CR, CRS_CR_ERRIE) == (CRS_CR_ERRIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(crsx->CR, CRS_CR_ESYNCIE);
}
...
{
  CLEAR_BIT(crsx->CR, CRS_CR_ESYNCIE);
}
...
{
  return ((READ_BIT(crsx->CR, CRS_CR_ESYNCIE) == (CRS_CR_ESYNCIE)) ? 1UL : 0UL);
}
