...
/** @defgroup LPUART_LL_EC_CLEAR_FLAG Clear Flags Defines
  * @brief    Flags defines which can be used with LL_LPUART_WRITE_REG function.
  * @{
  */
...
#define LL_LPUART_ICR_TXFECF               USART_ICR_TXFECF              /*!< TXFIFO empty clear flag */
/**
  * @}
  */

/** @defgroup LPUART_LL_EC_GET_FLAG Get Flags Defines
  * @brief    Flags defines which can be used with LL_LPUART_READ_REG function.
  * @{
  */
...
/** @defgroup LPUART_LL_EC_IT IT Defines
  * @brief    IT defines which can be used with LL_LPUART_READ_REG and  LL_LPUART_WRITE_REG functions.
  * @{
  */
...
/** @defgroup LPUART_LL_EC_DATAWIDTH Datawidth
  * @{
  */
#define LL_LPUART_DATAWIDTH_7_BIT    USART_CR1_M1              /*!< 7 bits word length : Start bit, 7 data bits, n stop bits */
#define LL_LPUART_DATAWIDTH_8_BIT    0x00000000U               /*!< 8 bits word length : Start bit, 8 data bits, n stop bits */
#define LL_LPUART_DATAWIDTH_9_BIT    USART_CR1_M0              /*!< 9 bits word length : Start bit, 9 data bits, n stop bits */
/**
  * @}
  */
...
/**
  ...
  */
#define LL_LPUART_WRITE_REG(instance, reg, value) WRITE_REG((instance)->reg, (value))
...
/**
  ...
  */
#define LL_LPUART_READ_REG(instance, reg) READ_REG((instance)->reg)
/**
  * @}
  */
...
{
  SET_BIT(p_lpuart->CR1, USART_CR1_UE);
}
...
{
  CLEAR_BIT(p_lpuart->CR1, USART_CR1_UE);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_UE) == (USART_CR1_UE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_lpuart->CR1, USART_CR1_FIFOEN);
}
...
{
  CLEAR_BIT(p_lpuart->CR1, USART_CR1_FIFOEN);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_FIFOEN) == (USART_CR1_FIFOEN)) ? 1UL : 0UL);
}
...
{
  ATOMIC_MODIFY_REG(p_lpuart->CR3, USART_CR3_TXFTCFG, threshold << USART_CR3_TXFTCFG_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR3, USART_CR3_TXFTCFG) >> USART_CR3_TXFTCFG_Pos);
}
...
{
  ATOMIC_MODIFY_REG(p_lpuart->CR3, USART_CR3_RXFTCFG, threshold << USART_CR3_RXFTCFG_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR3, USART_CR3_RXFTCFG) >> USART_CR3_RXFTCFG_Pos);
}
...
{
  ATOMIC_MODIFY_REG(p_lpuart->CR3, USART_CR3_TXFTCFG | USART_CR3_RXFTCFG, (tx_threshold << USART_CR3_TXFTCFG_Pos) | \
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_UESM);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_UESM);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_UESM) == (USART_CR1_UESM)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_lpuart->CR1, (USART_CR1_M0 | USART_CR1_M1 | USART_CR1_PCE | USART_CR1_PS | USART_CR1_TE
                             | USART_CR1_RE), cr1_config);

  MODIFY_REG(p_lpuart->CR2, (USART_CR2_STOP_0 | USART_CR2_STOP_1), cr2_config);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_RE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_RE);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR1, USART_CR1_RE) == (USART_CR1_RE));
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_TE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_TE);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR1, USART_CR1_TE) == (USART_CR1_TE));
}
...
{
  ATOMIC_MODIFY_REG(p_lpuart->CR1, USART_CR1_RE | USART_CR1_TE, transfer_direction);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR1, USART_CR1_RE | USART_CR1_TE));
}
...
{
  MODIFY_REG(p_lpuart->CR1, USART_CR1_PS | USART_CR1_PCE, parity);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR1, USART_CR1_PS | USART_CR1_PCE));
}
...
{
  MODIFY_REG(p_lpuart->CR1, USART_CR1_WAKE, method);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR1, USART_CR1_WAKE));
}
...
{
  MODIFY_REG(p_lpuart->CR1, USART_CR1_M, data_width);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR1, USART_CR1_M));
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_MME);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_MME);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_MME) == (USART_CR1_MME)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_lpuart->PRESC, USART_PRESC_PRESCALER, (uint16_t)prescaler_value);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->PRESC, USART_PRESC_PRESCALER));
}
...
{
  MODIFY_REG(p_lpuart->CR2, USART_CR2_STOP, stop_bits);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR2, USART_CR2_STOP));
}
...
__STATIC_INLINE void LL_LPUART_ConfigCharacter(USART_TypeDef *p_lpuart, uint32_t data_width, uint32_t parity,
                                               uint32_t stop_bits)
{
  MODIFY_REG(p_lpuart->CR1, USART_CR1_PS | USART_CR1_PCE | USART_CR1_M, parity | data_width);
  MODIFY_REG(p_lpuart->CR2, USART_CR2_STOP, stop_bits);
}
...
{
  MODIFY_REG(p_lpuart->CR2, USART_CR2_SWAP, swap_config);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR2, USART_CR2_SWAP));
}
...
{
  MODIFY_REG(p_lpuart->CR2, USART_CR2_RXINV, pin_inv_method);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR2, USART_CR2_RXINV));
}
...
{
  MODIFY_REG(p_lpuart->CR2, USART_CR2_TXINV, pin_inv_method);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR2, USART_CR2_TXINV));
}
...
{
  MODIFY_REG(p_lpuart->CR2, USART_CR2_DATAINV, data_logic);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR2, USART_CR2_DATAINV));
}
...
{
  MODIFY_REG(p_lpuart->CR2, USART_CR2_MSBFIRST, bit_order);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR2, USART_CR2_MSBFIRST));
}

/**
  * @brief  Set a 8 bit address of the LPUART node as set in ADD field of CR2.
  * @rmtoll
...
{
  MODIFY_REG(p_lpuart->CR2, USART_CR2_ADD, (node_address << USART_CR2_ADD_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR2, USART_CR2_ADD) >> USART_CR2_ADD_Pos);
}
...
/**
  ...
  * @note   If 4-bit Address Detection is selected in ADDM7,
  *         only 4bits (b3-b0) of node address value are relevant (b7-b4 are not relevant)
  *         If 7-bit Address Detection is selected in ADDM7,
  *         only 8bits (b7-b0) of node address value are relevant
  */
__STATIC_INLINE void LL_LPUART_SetNodeAddressLength(USART_TypeDef *p_lpuart, uint32_t address_len)
{
  MODIFY_REG(p_lpuart->CR2, USART_CR2_ADDM7, address_len);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR2, USART_CR2_ADDM7));
}
...
{
  MODIFY_REG(p_lpuart->CR2, USART_CR2_ADD | USART_CR2_ADDM7,
...
{
  ATOMIC_SET_BIT(p_lpuart->CR3, USART_CR3_RTSE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR3, USART_CR3_RTSE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR3, USART_CR3_CTSE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR3, USART_CR3_CTSE);
}
...
{
  MODIFY_REG(p_lpuart->CR3, USART_CR3_RTSE | USART_CR3_CTSE, hardware_flow_control);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR3, USART_CR3_RTSE | USART_CR3_CTSE));
}
...
{
  CLEAR_BIT(p_lpuart->CR3, USART_CR3_OVRDIS);
}
...
{
  SET_BIT(p_lpuart->CR3, USART_CR3_OVRDIS);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_OVRDIS) != USART_CR3_OVRDIS) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_lpuart->CR3, USART_CR3_WUS, type);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR3, USART_CR3_WUS));
}
...
{
  SET_BIT(p_lpuart->CR3, USART_CR3_HDSEL);
}
...
{
  CLEAR_BIT(p_lpuart->CR3, USART_CR3_HDSEL);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_HDSEL) == (USART_CR3_HDSEL)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_lpuart->CR1, USART_CR1_DEDT, time << USART_CR1_DEDT_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR1, USART_CR1_DEDT) >> USART_CR1_DEDT_Pos);
}
...
{
  MODIFY_REG(p_lpuart->CR1, USART_CR1_DEAT, time << USART_CR1_DEAT_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR1, USART_CR1_DEAT) >> USART_CR1_DEAT_Pos);
}
...
{
  SET_BIT(p_lpuart->CR3, USART_CR3_DEM);
}
...
{
  CLEAR_BIT(p_lpuart->CR3, USART_CR3_DEM);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_DEM) == (USART_CR3_DEM)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_lpuart->CR3, USART_CR3_DEP, polarity);
}
...
{
  return (uint32_t)(READ_BIT(p_lpuart->CR3, USART_CR3_DEP));
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_PE) == (USART_ISR_PE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_FE) == (USART_ISR_FE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_NE) == (USART_ISR_NE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_ORE) == (USART_ISR_ORE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_IDLE) == (USART_ISR_IDLE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_RXNE_RXFNE) == (USART_ISR_RXNE_RXFNE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_TC) == (USART_ISR_TC)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_TXE_TXFNF) == (USART_ISR_TXE_TXFNF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_CTSIF) == (USART_ISR_CTSIF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_CTS) == (USART_ISR_CTS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_BUSY) == (USART_ISR_BUSY)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_CMF) == (USART_ISR_CMF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_SBKF) == (USART_ISR_SBKF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_RWU) == (USART_ISR_RWU)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_WUF) == (USART_ISR_WUF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_TEACK) == (USART_ISR_TEACK)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_REACK) == (USART_ISR_REACK)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_TXFE) == (USART_ISR_TXFE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_RXFF) == (USART_ISR_RXFF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_TXFT) == (USART_ISR_TXFT)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->ISR, USART_ISR_RXFT) == (USART_ISR_RXFT)) ? 1UL : 0UL);
}
...
{
  WRITE_REG(p_lpuart->ICR, USART_ICR_PECF);
}
...
{
  WRITE_REG(p_lpuart->ICR, USART_ICR_FECF);
}
...
{
  WRITE_REG(p_lpuart->ICR, USART_ICR_NECF);
}
...
{
  WRITE_REG(p_lpuart->ICR, USART_ICR_ORECF);
}
...
{
  WRITE_REG(p_lpuart->ICR, USART_ICR_IDLECF);
}
...
{
  WRITE_REG(p_lpuart->ICR, USART_ICR_TCCF);
}
...
{
  WRITE_REG(p_lpuart->ICR, USART_ICR_CTSCF);
}
...
{
  WRITE_REG(p_lpuart->ICR, USART_ICR_CMCF);
}
...
{
  WRITE_REG(p_lpuart->ICR, USART_ICR_WUCF);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_IDLEIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_RXNEIE_RXFNEIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_TCIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_TXEIE_TXFNFIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_PEIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_CMIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_TXFEIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR1, USART_CR1_RXFFIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR3, USART_CR3_EIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR3, USART_CR3_CTSIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR3, USART_CR3_WUFIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR3, USART_CR3_TXFTIE);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR3, USART_CR3_RXFTIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_IDLEIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_RXNEIE_RXFNEIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_TCIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_TXEIE_TXFNFIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_PEIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_CMIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_TXFEIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR1, USART_CR1_RXFFIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR3, USART_CR3_EIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR3, USART_CR3_CTSIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR3, USART_CR3_WUFIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR3, USART_CR3_TXFTIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR3, USART_CR3_RXFTIE);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_IDLEIE) == (USART_CR1_IDLEIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_RXNEIE_RXFNEIE) == (USART_CR1_RXNEIE_RXFNEIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_TCIE) == (USART_CR1_TCIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_TXEIE_TXFNFIE) == (USART_CR1_TXEIE_TXFNFIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_PEIE) == (USART_CR1_PEIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_CMIE) == (USART_CR1_CMIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_TXFEIE) == (USART_CR1_TXFEIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR1, USART_CR1_RXFFIE) == (USART_CR1_RXFFIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_EIE) == (USART_CR3_EIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_CTSIE) == (USART_CR3_CTSIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_WUFIE) == (USART_CR3_WUFIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_TXFTIE) == (USART_CR3_TXFTIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_RXFTIE) == (USART_CR3_RXFTIE)) ? 1UL : 0UL);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR3, USART_CR3_DMAR);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR3, USART_CR3_DMAR);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_DMAR) == (USART_CR3_DMAR)) ? 1UL : 0UL);
}
...
{
  ATOMIC_SET_BIT(p_lpuart->CR3, USART_CR3_DMAT);
}
...
{
  ATOMIC_CLEAR_BIT(p_lpuart->CR3, USART_CR3_DMAT);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_DMAT) == (USART_CR3_DMAT)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_lpuart->CR3, USART_CR3_DDRE);
}
...
{
  CLEAR_BIT(p_lpuart->CR3, USART_CR3_DDRE);
}
...
{
  return ((READ_BIT(p_lpuart->CR3, USART_CR3_DDRE) == (USART_CR3_DDRE)) ? 1UL : 0UL);
}
...
{
  return (uint8_t)(READ_BIT(p_lpuart->RDR, USART_RDR_RDR) & 0xFFU);
}
...
{
  return (uint16_t)(READ_BIT(p_lpuart->RDR, USART_RDR_RDR));
}
...
{
  SET_BIT(p_lpuart->RQR, (uint16_t)USART_RQR_SBKRQ);
}
...
{
  SET_BIT(p_lpuart->RQR, (uint16_t)USART_RQR_MMRQ);
}
...
{
  SET_BIT(p_lpuart->RQR, (uint16_t)USART_RQR_RXFRQ);
}
...
{
  SET_BIT(p_lpuart->RQR, (uint16_t)USART_RQR_TXFRQ);
}
