...
{
  SET_BIT(p_spix->CFG1, SPI_CFG1_DRDS);
}
...
{
  CLEAR_BIT(p_spix->CFG1, SPI_CFG1_DRDS);
}
...
{
  return ((READ_BIT(p_spix->CFG1, SPI_CFG1_DRDS) == SPI_CFG1_DRDS) ? 1UL : 0UL);
}
...
/** @defgroup I2S_LL_EC_DATA_FORMAT Data Format
  * @{
  */
#define LL_I2S_DATA_FORMAT_16BIT               (0x00000000UL)                                                   /*!< 16-bit on 16-bit channel               */
#define LL_I2S_DATA_FORMAT_16BIT_EXTENDED      (SPI_I2SCFGR_CHLEN)                                              /*!< 16-bit on 32-bit channel               */
#define LL_I2S_DATA_FORMAT_24BIT_RIGHT_ALIGNED (SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_DATLEN_0)                       /*!< 24-bit on 32-bit channel right aligned */
#define LL_I2S_DATA_FORMAT_24BIT_LEFT_ALIGNED  (SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_DATLEN_0 | SPI_I2SCFGR_DATFMT)  /*!< 24-bit on 32-bit channel left aligned  */
#define LL_I2S_DATA_FORMAT_32BIT               (SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_DATLEN_1)                       /*!< 32-bit on 32-bit channel               */
/**
  * @}
  */
...
#define LL_I2S_AUDIO_FREQ_192KHZ                192000UL       /*!< Audio Frequency configuration 192000 Hz       */
#define LL_I2S_AUDIO_FREQ_96KHZ                 96000UL        /*!< Audio Frequency configuration 96000 Hz        */
#define LL_I2S_AUDIO_FREQ_48KHZ                 48000UL        /*!< Audio Frequency configuration 48000 Hz        */
#define LL_I2S_AUDIO_FREQ_44KHZ                 44100UL        /*!< Audio Frequency configuration 44100 Hz        */
#define LL_I2S_AUDIO_FREQ_32KHZ                 32000UL        /*!< Audio Frequency configuration 32000 Hz        */
#define LL_I2S_AUDIO_FREQ_22KHZ                 22050UL        /*!< Audio Frequency configuration 22050 Hz        */
#define LL_I2S_AUDIO_FREQ_16KHZ                 16000UL        /*!< Audio Frequency configuration 16000 Hz        */
#define LL_I2S_AUDIO_FREQ_11KHZ                 11025UL        /*!< Audio Frequency configuration 11025 Hz        */
#define LL_I2S_AUDIO_FREQ_8KHZ                  8000UL         /*!< Audio Frequency configuration 8000 Hz         */
#define LL_I2S_AUDIO_FREQ_DEFAULT               0UL            /*!< Audio Freq not specified. Register I2SDIV = 0 */
/**
  * @}
  */
...
/**
  ...
  * @param  __VALUE__ Value to be written in the register
  */
#define LL_I2S_WRITE_REG(__INSTANCE__, __REG__, __VALUE__) WRITE_REG(__INSTANCE__->__REG__, (__VALUE__))
...
/**
  ...
  * @retval Register value
  */
#define LL_I2S_READ_REG(__INSTANCE__, __REG__) READ_REG(__INSTANCE__->__REG__)
/**
  * @}
  */
...
/**
  ...
  * @param  data_length This parameter can be one of the following values:
  *         @arg @ref LL_I2S_DATA_FORMAT_16BIT
  *         @arg @ref LL_I2S_DATA_FORMAT_16BIT_EXTENDED
  *         @arg @ref LL_I2S_DATA_FORMAT_24BIT_RIGHT_ALIGNED
  *         @arg @ref LL_I2S_DATA_FORMAT_24BIT_LEFT_ALIGNED
  *         @arg @ref LL_I2S_DATA_FORMAT_32BIT
  */
__STATIC_INLINE void LL_I2S_SetDataFormat(SPI_TypeDef *p_spix, uint32_t data_length)
{
  MODIFY_REG(p_spix->I2SCFGR, SPI_I2SCFGR_DATLEN | SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_DATFMT, data_length);
}
...
{
  return (uint32_t)(READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_DATLEN | SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_DATFMT));
}

/**
  * @brief  Invert the default polarity of WS signal
  * @rmtoll
  *  I2SCFGR      FIXCH         LL_I2S_EnableChannelDetectionErr
  * @param  p_spix SPI Handle
  */
__STATIC_INLINE void LL_I2S_EnableChannelDetectionErr(SPI_TypeDef *p_spix)
{
  SET_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_FIXCH);
}

/**
  * @brief  Use the default polarity of WS signal
  * @rmtoll
  *  I2SCFGR      FIXCH         LL_I2S_DisableChannelDetectionErr
  * @param  p_spix SPI Handle
  */
__STATIC_INLINE void LL_I2S_DisableChannelDetectionErr(SPI_TypeDef *p_spix)
{
  CLEAR_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_FIXCH);
}

/**
  * @brief  Check if polarity of WS signal is inverted
  * @rmtoll
  *  I2SCFGR      FIXCH         LL_I2S_IsEnabledChannelDetectionErr
  * @param  p_spix SPI Handle
  * @retval State of bit (1 or 0)
  */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledChannelDetectionErr(SPI_TypeDef *p_spix)
{
  return ((READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_FIXCH) == (SPI_I2SCFGR_FIXCH)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_WSINV);
}
...
{
  CLEAR_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_WSINV);
}
...
{
  return ((READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_WSINV) == (SPI_I2SCFGR_WSINV)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_spix->I2SCFGR, SPI_I2SCFGR_CKPOL, clock_polarity);
}
...
{
  return (uint32_t)(READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_CKPOL));
}
...
{
  MODIFY_REG(p_spix->I2SCFGR, SPI_I2SCFGR_I2SSTD | SPI_I2SCFGR_PCMSYNC, standard);
}
...
{
  return (uint32_t)(READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_I2SSTD | SPI_I2SCFGR_PCMSYNC));
}
...
/**
  ...
  */
__STATIC_INLINE void LL_I2S_SetTransferMode(SPI_TypeDef *p_spix, uint32_t standard)
{
  MODIFY_REG(p_spix->I2SCFGR, SPI_I2SCFGR_I2SCFG, standard);
}
...
{
  return (uint32_t)(READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_I2SCFG));
}
...
{
  SET_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_I2SMOD);
}
...
{
  CLEAR_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_I2SMOD);
}
...
{
  return ((READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_I2SMOD) == (SPI_I2SCFGR_I2SMOD)) ? 1UL : 0UL);
}

/**
  * @brief  Swap the SDO and SDI pin
  * @rmtoll
  *  CFG2         IOSWP         LL_I2S_EnableMosiMisoSwap
  * @param  p_spix SPI Instance
  * @note   This configuration can not be changed when I2S is enabled.
  */
__STATIC_INLINE void LL_I2S_EnableMosiMisoSwap(SPI_TypeDef *p_spix)
{
...
/**
  ...
  * @note   This configuration can not be changed when I2S is enabled.
  */
__STATIC_INLINE void LL_I2S_DisableMosiMisoSwap(SPI_TypeDef *p_spix)
{
...
/**
  ...
  * @retval State of bit (1 or 0)
  */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledMosiMisoSwap(SPI_TypeDef *p_spix)
{
...
{
  LL_SPI_StartMasterTransfer(p_spix);
}
...
{
  MODIFY_REG(p_spix->I2SCFGR, SPI_I2SCFGR_I2SDIV, (prescaler_linear << SPI_I2SCFGR_I2SDIV_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_I2SDIV) >> SPI_I2SCFGR_I2SDIV_Pos);
}
...
{
  MODIFY_REG(p_spix->I2SCFGR, SPI_I2SCFGR_ODD, prescaler_parity << SPI_I2SCFGR_ODD_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_ODD) >> SPI_I2SCFGR_ODD_Pos);
}
...
{
  SET_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_MCKOE);
}
...
{
  CLEAR_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_MCKOE);
}
...
{
  return ((READ_BIT(p_spix->I2SCFGR, SPI_I2SCFGR_MCKOE) == (SPI_I2SCFGR_MCKOE)) ? 1UL : 0UL);
}
...
{
  LL_SPI_DisableDMAReq_RX(p_spix);
}
...
{
  LL_SPI_DisableDMAReq_TX(p_spix);
}
...
{
  return LL_SPI_ReceiveData16(p_spix);
}
...
{
  return LL_SPI_ReceiveData32(p_spix);
}
...
{
  LL_SPI_TransmitData16(p_spix, tx_data);
}
...
{
  LL_SPI_TransmitData32(p_spix, tx_data);
}
