...
/**
  ...
  */
#define LL_RNG_WRITE_REG(instance, reg, value) WRITE_REG((instance)->reg, (value))
/**
  ...
  */
#define LL_RNG_READ_REG(instance, reg) READ_REG((instance)->reg)
/**
  * @}
  */
/**
...
{
  MODIFY_REG(rngx->CR, (RNG_CR_RNG_CONFIG1 | RNG_CR_RNG_CONFIG2 | RNG_CR_RNG_CONFIG3 | RNG_CR_CLKDIV | RNG_CR_CED
...
{
  return READ_BIT(rngx->CR, (RNG_CR_RNG_CONFIG1 | RNG_CR_RNG_CONFIG2 | RNG_CR_RNG_CONFIG3 | RNG_CR_CLKDIV | RNG_CR_CED
                             | RNG_CR_NISTC));
}
/**
  * @}
...
{
  return ((READ_BIT(rngx->SR, RNG_SR_BUSY) == (RNG_SR_BUSY)) ? 1UL : 0UL);
}
/**
...
{
  MODIFY_REG(rngx->NSCR, osc, (src << POSITION_VAL(osc)));
}
/**
...
/**
  ...
  * @retval Return 32-bit RNG Additional  Health Test configuration
  */
