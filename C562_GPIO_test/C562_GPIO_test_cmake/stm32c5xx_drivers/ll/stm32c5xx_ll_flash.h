...
/** @defgroup FLASH_ECC_Error_Flags FLASH ECC Error flags
  * @{
  */
#define LL_FLASH_FLAG_ECCC            FLASH_ECCCORR_ECCC                 /*!< LL FLASH ECC single error flag */
#define LL_FLASH_FLAG_ECCD            FLASH_ECCDETR_ECCD                 /*!< LL FLASH ECC double error flag */
/**
  * @}
  */
...
/** @defgroup FLASH_ECC_Area_Flags FLASH ECC Area flags
  * @{
  */
#define LL_FLASH_FLAG_DATA_ECC        FLASH_ECCCORR_DATA_ECC             /* ECC error in data flash flag   */
...
#define LL_FLASH_FLAG_ECC_AREA_ALL    (FLASH_ECCCORR_DATA_ECC | FLASH_ECCCORR_BK_ECC | \
...
/** @defgroup FLASH_Latency FLASH Latency
  * @{
  */
#define LL_FLASH_LATENCY_0WS  0x00000000U  /*!< LL FLASH Zero wait state      */
#define LL_FLASH_LATENCY_1WS  FLASH_ACR_LATENCY_0  /*!< LL FLASH One wait state       */
#define LL_FLASH_LATENCY_2WS  FLASH_ACR_LATENCY_1  /*!< LL FLASH Two wait states      */
#define LL_FLASH_LATENCY_3WS  FLASH_ACR_LATENCY_2  /*!< LL FLASH Three wait states    */
#define LL_FLASH_LATENCY_4WS  FLASH_ACR_LATENCY_3  /*!< LL FLASH Four wait states     */
#define LL_FLASH_LATENCY_5WS  FLASH_ACR_LATENCY_4  /*!< LL FLASH Five wait state      */
#define LL_FLASH_LATENCY_6WS  FLASH_ACR_LATENCY_5  /*!< LL FLASH Six wait state       */
#define LL_FLASH_LATENCY_7WS  FLASH_ACR_LATENCY_6  /*!< LL FLASH Seven wait states    */
#define LL_FLASH_LATENCY_8WS  FLASH_ACR_LATENCY_7  /*!< LL FLASH Eight wait states    */
#define LL_FLASH_LATENCY_9WS  FLASH_ACR_LATENCY_8  /*!< LL FLASH Nine wait states     */
#define LL_FLASH_LATENCY_10WS FLASH_ACR_LATENCY_9  /*!< LL FLASH Ten wait state       */
#define LL_FLASH_LATENCY_11WS FLASH_ACR_LATENCY_10 /*!< LL FLASH Eleven wait state    */
#define LL_FLASH_LATENCY_12WS FLASH_ACR_LATENCY_11 /*!< LL FLASH Twelve wait states   */
#define LL_FLASH_LATENCY_13WS FLASH_ACR_LATENCY_12 /*!< LL FLASH Thirteen wait states */
#define LL_FLASH_LATENCY_14WS FLASH_ACR_LATENCY_13 /*!< LL FLASH Fourteen wait states */
#define LL_FLASH_LATENCY_15WS FLASH_ACR_LATENCY_14 /*!< LL FLASH Fifteen wait states  */
/**
  * @}
  */
...
/** @defgroup FLASH_ProgrammingDelay FLASH Programming Delay
  * @{
  */
#define LL_FLASH_PROGRAM_DELAY_0 0x00000000U            /*!< LL FLASH programming delay for Flash frequency at
                                                                 68 MHz or less */
#define LL_FLASH_PROGRAM_DELAY_1 FLASH_ACR_WRHIGHFREQ_0 /*!< LL FLASH programming delay for Flash frequency between
                                                                 68 MHz and 136 MHz */
#define LL_FLASH_PROGRAM_DELAY_2 FLASH_ACR_WRHIGHFREQ_1 /*!< LL FLASH programming delay for Flash frequency between
                                                                 136 MHz and 200 MHz */
/**
  * @}
  */

/** @defgroup FLASH_EmptyBootLocation FLASH Empty Boot Locatiion
  * @{
  */
#define LL_FLASH_BOOT_LOCATION_PROGRAMMED 0x00000000U   /*!< LL FLASH boot location is programmed */
#define LL_FLASH_BOOT_LOCATION_EMPTY FLASH_ACR_EMPTY    /*!< LL FLASH boot location is empty */
...
/** @defgroup FLASH_Bank_Selection FLASH Bank Selection
  * @{
  */
#define LL_FLASH_BANK_1 0x00    /*!< LL FLASH bank 1 selection */
#define LL_FLASH_BANK_2 0x40    /*!< LL FLASH bank 2 selection */
/**
  * @}
  */
...
/** @defgroup FLASH_Erase_Bank_Selection FLASH Erase Bank Selection
  * @{
  */
#define LL_FLASH_ERASE_BANK_1 0x00000000U       /*!< LL FLASH Page erase bank 1 */
#define LL_FLASH_ERASE_BANK_2 FLASH_CR_BKSEL    /*!< LL FLASH Page erase bank 2 */
/**
  * @}
  */
/** @defgroup FLASH_Erase_Area_Selection FLASH Erase Area Selection
  * @{
  */
#define LL_FLASH_ERASE_USER_AREA  0x00000000U       /*!< LL FLASH Page erase USER area */
#define LL_FLASH_ERASE_EDATA_AREA FLASH_CR_EDATASEL    /*!< LL FLASH Page erase EDATA area */
/**
  * @}
  */
...
#define LL_FLASH_OB_NO_RST_STOP_MODE FLASH_OPTSR_PRG_NRST_STOP /*!< LL FLASH option bytes no reset in stop mode */
/**
  * @}
  */
...
#define LL_FLASH_OB_NO_RST_STDBY_MODE FLASH_OPTSR_PRG_NRST_STDBY /*!< LL FLASH option bytes no reset in standby mode */
/**
  * @}
  */
...
/** @defgroup FLASH_OB_Erase_Sram1_System_Reset FLASH OB Erase Sram1 System Reset
  * @{
  */
#define LL_FLASH_OB_ERASED_SRAM1_SYS_RST     0x00000000U         /*!< LL FLASH OB erased sram in sys reset */
#define LL_FLASH_OB_NOT_ERASED_SRAM1_SYS_RST FLASH_OPTSR2_PRG_SRAM1_RST /*!< LL FLASH OB not erased sram1 in sys reset */
/**
  * @}
  */
...
/** @defgroup FLASH_OB_Erase_Sram2_System_Reset FLASH OB Erase Sram2 System Reset
  * @{
  */
#define LL_FLASH_OB_ERASED_SRAM2_SYS_RST     0x00000000U         /*!< LL FLASH OB erased sram in sys reset */
#define LL_FLASH_OB_NOT_ERASED_SRAM2_SYS_RST FLASH_OPTSR2_PRG_SRAM2_RST /*!< LL FLASH OB not erased sram1 in sys reset */
/**
  * @}
  */
...
#define LL_FLASH_OB_IWDG_SW FLASH_OPTSR_PRG_IWDG_SW /*!< LL FLASH OB IWDG Software selection */
/**
  * @}
  */
...
#define LL_FLASH_OB_WWDG_SW FLASH_OPTSR_PRG_WWDG_SW /*!< LL FLASH OB WWDG Software selection */
/**
  * @}
  */
...
/** @defgroup FLASH_OB_Single_Dual_Bank FLASH OB Dual Bank 256K
  * @{
  */
#define LL_FLASH_OB_DUAL_BANK     0x00000000U             /*!< LL FLASH OB dual bank   */
#define LL_FLASH_OB_SINGLE_BANK   FLASH_OPTSR_PRG_SINGLE_BANK /*!< LL FLASH OB single bank */
/**
  * @}
  */
...
#define LL_FLASH_OB_BANK_SWAPPED     FLASH_OPTSR_PRG_SWAP_BANK /*!< LL FLASH OB Bank swapped     */
/**
  * @}
  */
...
/** @defgroup FLASH_HDPEXT_Bank_Selection FLASH HDPEXT Bank Selection
  * @{
  */
#define LL_FLASH_HDPEXT_BANK_1 FLASH_HDPEXTR_HDP1_EXT_Pos  /*!< LL FLASH HDPEXT bank 1 */
#define LL_FLASH_HDPEXT_BANK_2 FLASH_HDPEXTR_HDP2_EXT_Pos  /*!< LL FLASH HDPEXT bank 2 */
/**
  * @}
  */
...
/** @defgroup FLASH_OB_BootAddr_Lock FLASH OB Boot Address Lock
  * @{
  */
#define LL_FLASH_OB_BOOT_NOT_LOCKED 0xC3U /*!< LL FLASH Boot OBs not locked  */
#define LL_FLASH_OB_BOOT_LOCKED     0xB4U /*!< LL FLASH Boot OBs locked      */
/**
  * @}
  */
...
/** @defgroup FLASH_OB_Boot0_Selection FLASH OB Boot0 Selection
  * @{
  */
#define LL_FLASH_OB_BOOT0_BOOT0   0x00000000U          /*!< LL FLASH OB Boot0 BOOT0  */
#define LL_FLASH_OB_BOOT0_BOOTPIN FLASH_OPTSR_PRG_BOOT_SEL /*!< LL FLASH OB Boot0 BOOTPIN */
/**
  * @}
  */
...
/** @defgroup FLASH_OB_BOOT0_Option FLASH OB BOOT0 Option bit
  * @{
  */
#define LL_FLASH_OB_BOOT0_DISABLED 0x00000000U       /*!< LL FLASH OB BOOT0 0 */
#define LL_FLASH_OB_BOOT0_ENABLED FLASH_OPTSR_PRG_BOOT0 /*!< LL FLASH OB BOOT0 1 */
/**
  * @}
  */
...
/** @defgroup FLASH_OB_Read_Protection_Level FLASH OB Read Protection Level
  * @{
  */
#define LL_FLASH_OB_RDP_LEVEL_0     0xEDU /*!< LL FLASH option bytes RDP Level 0                    */
#define LL_FLASH_OB_RDP_LEVEL_2_WBS 0xD1U /*!< LL FLASH option bytes RDP Level 2 with Boundary Scan */
#define LL_FLASH_OB_RDP_LEVEL_2     0x72U /*!< LL FLASH option bytes RDP Level 2                    */
/**
  * @}
  */
...
#define LL_FLASH_OB_WRP_PAGE_0_1    (0x00000001UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page0 & 1   */
#define LL_FLASH_OB_WRP_PAGE_2_3    (0x00000002UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page2 & 3   */
#define LL_FLASH_OB_WRP_PAGE_4_5    (0x00000004UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page4 & 5   */
#define LL_FLASH_OB_WRP_PAGE_6_7    (0x00000008UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page6 & 7   */
#define LL_FLASH_OB_WRP_PAGE_8_9    (0x00000010UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page8 & 9   */
#define LL_FLASH_OB_WRP_PAGE_10_11  (0x00000020UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page10 & 11 */
#define LL_FLASH_OB_WRP_PAGE_12_13  (0x00000040UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page12 & 13 */
#define LL_FLASH_OB_WRP_PAGE_14_15  (0x00000080UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page14 & 15 */
#define LL_FLASH_OB_WRP_PAGE_16_17  (0x00000100UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page16 & 17 */
#define LL_FLASH_OB_WRP_PAGE_18_19  (0x00000200UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page18 & 19 */
#define LL_FLASH_OB_WRP_PAGE_20_21  (0x00000400UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page20 & 21 */
#define LL_FLASH_OB_WRP_PAGE_22_23  (0x00000800UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page22 & 23 */
#define LL_FLASH_OB_WRP_PAGE_24_25  (0x00001000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page24 & 25 */
#define LL_FLASH_OB_WRP_PAGE_26_27  (0x00002000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page26 & 27 */
#define LL_FLASH_OB_WRP_PAGE_28_29  (0x00004000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page28 & 29 */
#define LL_FLASH_OB_WRP_PAGE_30_31  (0x00008000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page30 & 31 */
#define LL_FLASH_OB_WRP_PAGE_32_33  (0x00010000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page32 & 33 */
#define LL_FLASH_OB_WRP_PAGE_34_35  (0x00020000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page34 & 35 */
#define LL_FLASH_OB_WRP_PAGE_36_37  (0x00040000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page36 & 37 */
#define LL_FLASH_OB_WRP_PAGE_38_39  (0x00080000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page38 & 39 */
#define LL_FLASH_OB_WRP_PAGE_40_41  (0x00100000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page40 & 41 */
#define LL_FLASH_OB_WRP_PAGE_42_43  (0x00200000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page42 & 43 */
#define LL_FLASH_OB_WRP_PAGE_44_45  (0x00400000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page44 & 45 */
#define LL_FLASH_OB_WRP_PAGE_46_47  (0x00800000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page46 & 47 */
#define LL_FLASH_OB_WRP_PAGE_48_49  (0x01000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page48 & 49 */
#define LL_FLASH_OB_WRP_PAGE_50_51  (0x02000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page50 & 51 */
#define LL_FLASH_OB_WRP_PAGE_52_53  (0x04000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page52 & 53 */
#define LL_FLASH_OB_WRP_PAGE_54_55  (0x08000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page54 & 55 */
#define LL_FLASH_OB_WRP_PAGE_56_57  (0x10000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page56 & 57 */
#define LL_FLASH_OB_WRP_PAGE_58_59  (0x20000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page58 & 59 */
#define LL_FLASH_OB_WRP_PAGE_60_61  (0x40000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page60 & 61 */
#define LL_FLASH_OB_WRP_PAGE_62_63  (0x80000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page62 & 63 */
#define LL_FLASH_OB_WRP_PAGE_ALL    FLASH_WRP1R_PRG_WRPSG1_Msk   /*!< Write protection of all Pages */
#else
#define LL_FLASH_OB_WRP_PAGE_0      (0x00000001UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page0  */
#define LL_FLASH_OB_WRP_PAGE_1      (0x00000002UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page1  */
#define LL_FLASH_OB_WRP_PAGE_2      (0x00000004UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page2  */
#define LL_FLASH_OB_WRP_PAGE_3      (0x00000008UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page3  */
#define LL_FLASH_OB_WRP_PAGE_4      (0x00000010UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page4  */
#define LL_FLASH_OB_WRP_PAGE_5      (0x00000020UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page5  */
#define LL_FLASH_OB_WRP_PAGE_6      (0x00000040UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page6  */
#define LL_FLASH_OB_WRP_PAGE_7      (0x00000080UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page7  */
#define LL_FLASH_OB_WRP_PAGE_8      (0x00000100UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page8  */
#define LL_FLASH_OB_WRP_PAGE_9      (0x00000200UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page9  */
#define LL_FLASH_OB_WRP_PAGE_10     (0x00000400UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page10 */
#define LL_FLASH_OB_WRP_PAGE_11     (0x00000800UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page11 */
#define LL_FLASH_OB_WRP_PAGE_12     (0x00001000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page12 */
#define LL_FLASH_OB_WRP_PAGE_13     (0x00002000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page13 */
#define LL_FLASH_OB_WRP_PAGE_14     (0x00004000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page14 */
#define LL_FLASH_OB_WRP_PAGE_15     (0x00008000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page15 */
#define LL_FLASH_OB_WRP_PAGE_16     (0x00010000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page16 */
#define LL_FLASH_OB_WRP_PAGE_17     (0x00020000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page17 */
#define LL_FLASH_OB_WRP_PAGE_18     (0x00040000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page18 */
#define LL_FLASH_OB_WRP_PAGE_19     (0x00080000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page19 */
#define LL_FLASH_OB_WRP_PAGE_20     (0x00100000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page20 */
#define LL_FLASH_OB_WRP_PAGE_21     (0x00200000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page21 */
#define LL_FLASH_OB_WRP_PAGE_22     (0x00400000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page22 */
#define LL_FLASH_OB_WRP_PAGE_23     (0x00800000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page23 */
#define LL_FLASH_OB_WRP_PAGE_24     (0x01000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page24 */
#define LL_FLASH_OB_WRP_PAGE_25     (0x02000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page25 */
#define LL_FLASH_OB_WRP_PAGE_26     (0x04000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page26 */
#define LL_FLASH_OB_WRP_PAGE_27     (0x08000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page27 */
#define LL_FLASH_OB_WRP_PAGE_28     (0x10000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page28 */
#define LL_FLASH_OB_WRP_PAGE_29     (0x20000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page29 */
#define LL_FLASH_OB_WRP_PAGE_30     (0x40000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page30 */
#define LL_FLASH_OB_WRP_PAGE_31     (0x80000000UL << FLASH_WRP1R_PRG_WRPSG1_Pos) /*!< Write protection of Page31 */
#define LL_FLASH_OB_WRP_PAGE_ALL    FLASH_WRP1R_PRG_WRPSG1_Msk   /*!< Write protection of all Pages */
#endif /* STM32C5A3xx */
/**
  * @}
...
/** @defgroup LL_FLASH_OB_OTP_Lock_Blocks FLASH OTP Lock Blocks
  * @{
  */
#define LL_FLASH_OB_OTP_BLK_0       (0x00000001UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block0  */
#define LL_FLASH_OB_OTP_BLK_1       (0x00000002UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block1  */
#define LL_FLASH_OB_OTP_BLK_2       (0x00000004UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block2  */
#define LL_FLASH_OB_OTP_BLK_3       (0x00000008UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block3  */
#define LL_FLASH_OB_OTP_BLK_4       (0x00000010UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block4  */
#define LL_FLASH_OB_OTP_BLK_5       (0x00000020UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block5  */
#define LL_FLASH_OB_OTP_BLK_6       (0x00000040UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block6  */
#define LL_FLASH_OB_OTP_BLK_7       (0x00000080UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block7  */
#define LL_FLASH_OB_OTP_BLK_8       (0x00000100UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block8  */
#define LL_FLASH_OB_OTP_BLK_9       (0x00000200UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block9  */
#define LL_FLASH_OB_OTP_BLK_10      (0x00000400UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block10 */
#define LL_FLASH_OB_OTP_BLK_11      (0x00000800UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block11 */
#define LL_FLASH_OB_OTP_BLK_12      (0x00001000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block12 */
#define LL_FLASH_OB_OTP_BLK_13      (0x00002000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block13 */
#define LL_FLASH_OB_OTP_BLK_14      (0x00004000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block14 */
#define LL_FLASH_OB_OTP_BLK_15      (0x00008000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block15 */
#define LL_FLASH_OB_OTP_BLK_16      (0x00010000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block16 */
#define LL_FLASH_OB_OTP_BLK_17      (0x00020000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block17 */
#define LL_FLASH_OB_OTP_BLK_18      (0x00040000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block18 */
#define LL_FLASH_OB_OTP_BLK_19      (0x00080000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block19 */
#define LL_FLASH_OB_OTP_BLK_20      (0x00100000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block20 */
#define LL_FLASH_OB_OTP_BLK_21      (0x00200000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block21 */
#define LL_FLASH_OB_OTP_BLK_22      (0x00400000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block22 */
#define LL_FLASH_OB_OTP_BLK_23      (0x00800000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block23 */
#define LL_FLASH_OB_OTP_BLK_24      (0x01000000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block24 */
#define LL_FLASH_OB_OTP_BLK_25      (0x02000000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block25 */
#define LL_FLASH_OB_OTP_BLK_26      (0x04000000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block26 */
#define LL_FLASH_OB_OTP_BLK_27      (0x08000000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block27 */
#define LL_FLASH_OB_OTP_BLK_28      (0x10000000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block28 */
#define LL_FLASH_OB_OTP_BLK_29      (0x20000000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block29 */
#define LL_FLASH_OB_OTP_BLK_30      (0x40000000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block30 */
#define LL_FLASH_OB_OTP_BLK_31      (0x80000000UL << FLASH_OTPBLR_PRG_LOCKBL_Pos)  /*!< OTP Lock Block31 */
...
#define LL_FLASH_INTERRUPTED_SINGLE_WRITE FLASH_OPSR_CODE_OP_0                          /*!< LL FLASH interrupted single write        */
#define LL_FLASH_INTERRUPTED_PAGE_ERASE   (FLASH_OPSR_CODE_OP_1 | FLASH_OPSR_CODE_OP_0) /*!< LL FLASH interrupted page erase          */
#define LL_FLASH_INTERRUPTED_BANK_ERASE   FLASH_OPSR_CODE_OP_2                          /*!< LL FLASH interrupted bank erase          */
#define LL_FLASH_INTERRUPTED_MASS_ERASE   (FLASH_OPSR_CODE_OP_2 | FLASH_OPSR_CODE_OP_0) /*!< LL FLASH interrupted mass erase          */
#define LL_FLASH_INTERRUPTED_OB_CHANGE    (FLASH_OPSR_CODE_OP_2 | FLASH_OPSR_CODE_OP_1) /*!< LL FLASH interrupted option bytes change */
/**
  * @}
  */
...
/**
  * @brief  Read a bits value in FLASH register.
  * @param  instance FLASH instance.
  * @param  reg      Register to be read
...
{
  MODIFY_REG(flashx->ACR, FLASH_ACR_WRHIGHFREQ, delay);
}
...
{
  return (READ_BIT(flashx->ACR, FLASH_ACR_WRHIGHFREQ));
}
...
{
  MODIFY_REG(flashx->ACR, FLASH_ACR_EMPTY, empty_status);
}
...
{
  return (READ_BIT(flashx->ACR, FLASH_ACR_EMPTY));
}
...
{
  return (READ_BIT(flashx->OPSR, flags));
}
...
{
  return (((READ_BIT(flashx->OPSR, FLASH_OPSR_DATA_OP)) == (FLASH_OPSR_DATA_OP)) ? 1UL : 0UL);
}
...
{
  return (((READ_BIT(flashx->OPSR, FLASH_OPSR_BK_OP)) == (FLASH_OPSR_BK_OP)) ? 1UL : 0UL);
}
...
{
  return (((READ_BIT(flashx->OPSR, FLASH_OPSR_OTP_OP)) == (FLASH_OPSR_OTP_OP)) ? 1UL : 0UL);
}
...
{
  return (READ_BIT(flashx->OPSR, FLASH_OPSR_ADDR_OP) >> FLASH_OPSR_ADDR_OP_Pos);
}
...
{
  SET_BIT(flashx->OPTCR, FLASH_OPTCR_OPTLOCK);
}
...
{
  return ((READ_BIT(flashx->OPTCR, FLASH_OPTCR_OPTLOCK) == (FLASH_OPTCR_OPTLOCK)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->OPTCR, FLASH_OPTCR_OPTSTRT);
}
...
{
  return ((READ_BIT(flashx->OPTCR, FLASH_OPTCR_SWAP_BANK) == (FLASH_OPTCR_SWAP_BANK)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(flashx->SR, flags) != 0U) ? 1UL : 0UL);
}
...
{
  return (READ_BIT(flashx->SR, flags));
}
...
{
  return ((READ_BIT(flashx->SR, FLASH_SR_WBNE) == (FLASH_SR_WBNE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(flashx->SR, FLASH_SR_DBNE) == (FLASH_SR_DBNE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(flashx->SR, FLASH_SR_OEMLOCK) == (FLASH_SR_OEMLOCK)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(flashx->SR, FLASH_SR_BSLOCK) == (FLASH_SR_BSLOCK)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->CCR, FLASH_CCR_CLR_EOP);
}
...
{
  SET_BIT(flashx->CCR, FLASH_CCR_CLR_WRPERR);
}
...
{
  SET_BIT(flashx->CCR, FLASH_CCR_CLR_PGSERR);
}
...
{
  return ((READ_BIT(flashx->SR, FLASH_SR_STRBERR) == (FLASH_SR_STRBERR)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->CCR, FLASH_CCR_CLR_STRBERR);
}
...
{
  return ((READ_BIT(flashx->SR, FLASH_SR_INCERR) == (FLASH_SR_INCERR)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->CCR, FLASH_CCR_CLR_INCERR);
}
/**
...
{
  return ((READ_BIT(flashx->SR, FLASH_SR_OPTCHANGEERR) == (FLASH_SR_OPTCHANGEERR)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->CCR, FLASH_CCR_CLR_OPTCHANGEERR);
}
...
/**
  ...
  * @rmtoll
  *  CR        BKSEL/BER           LL_FLASH_BANK_EnableBankErase
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values :
  ...
  */
__STATIC_INLINE void LL_FLASH_BANK_EnableBankErase(FLASH_TypeDef *flashx, uint32_t bank)
{
  MODIFY_REG(flashx->CR, (FLASH_CR_BKSEL | FLASH_CR_BER), (bank | FLASH_CR_BER));
}

/**
  * @brief  Disable the flash bank erase.
  * @rmtoll
  *  CR           BKSEL/BER           LL_FLASH_BANK_DisableBankErase
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values :
  *         @arg @ref LL_FLASH_ERASE_BANK_1
  *         @arg @ref LL_FLASH_ERASE_BANK_2
  */
__STATIC_INLINE void LL_FLASH_BANK_DisableBankErase(FLASH_TypeDef *flashx, uint32_t bank)
{
  CLEAR_BIT(flashx->CR, (bank | FLASH_CR_BER));
}

/**
  * @brief  Check if the flash bank erase is enabled or disabled.
  * @rmtoll
  *  CR           BKSEL/BER           LL_FLASH_BANK_IsEnabledBankErase
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values :
  *         @arg @ref LL_FLASH_ERASE_BANK_1
  ...
  */
__STATIC_INLINE uint32_t LL_FLASH_BANK_IsEnabledBankErase(const FLASH_TypeDef *flashx, const uint32_t bank)
{
  return ((READ_BIT(flashx->CR, (FLASH_CR_BKSEL | FLASH_CR_BER)) == (bank | FLASH_CR_BER)) ? 1UL : 0UL);
}
...
{
  CLEAR_BIT(flashx->CR, FLASH_CR_PER | FLASH_CR_BER | FLASH_CR_MER | FLASH_CR_PG);
}
...
/**
  ...
  * @rmtoll
  *  CR           BKSEL/EDATASEL/PNB           LL_FLASH_BANK_SetPageEraseIndex
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values :
  *         @arg @ref LL_FLASH_ERASE_BANK_1
  ...
  */
__STATIC_INLINE void LL_FLASH_BANK_SetPageEraseIndex(FLASH_TypeDef *flashx, uint32_t bank, uint32_t area, uint32_t page)
{
  MODIFY_REG(flashx->CR, (FLASH_CR_BKSEL | FLASH_CR_EDATASEL | FLASH_CR_PNB), \
...
/**
  ...
  * @rmtoll
  *  CR           BKER/EDATASEL/PNB/PER/STRT           LL_FLASH_BANK_StartErasePage
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values :
  *         @arg @ref LL_FLASH_ERASE_BANK_1
  ...
  * @param  page This parameter can take any value in [0:31]
  */
__STATIC_INLINE void LL_FLASH_BANK_StartErasePage(FLASH_TypeDef *flashx, uint32_t bank, uint32_t area, uint32_t page)
{
  MODIFY_REG(flashx->CR, (FLASH_CR_BKSEL | FLASH_CR_EDATASEL | FLASH_CR_PNB | FLASH_CR_STRT | FLASH_CR_PER), \
...
/**
  ...
  * @rmtoll
  *  CR           BER/STRT           LL_FLASH_BANK_StartEraseBank
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values :
  *         @arg @ref LL_FLASH_ERASE_BANK_1
  *         @arg @ref LL_FLASH_ERASE_BANK_2
  */
__STATIC_INLINE void LL_FLASH_BANK_StartEraseBank(FLASH_TypeDef *flashx, uint32_t bank)
{
  MODIFY_REG(flashx->CR, (FLASH_CR_BER | FLASH_CR_STRT), (bank | FLASH_CR_STRT));
}
...
{
  SET_BIT(flashx->CR, (FLASH_CR_MER | FLASH_CR_STRT));
}
...
{
  SET_BIT(flashx->CR, FLASH_CR_WRPERRIE);
}
...
{
  CLEAR_BIT(flashx->CR, FLASH_CR_WRPERRIE);
}
...
{
  return ((READ_BIT(flashx->CR, FLASH_CR_WRPERRIE) == (FLASH_CR_WRPERRIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->CR, FLASH_CR_PGSERRIE);
}
...
{
  CLEAR_BIT(flashx->CR, FLASH_CR_PGSERRIE);
}
...
{
  return ((READ_BIT(flashx->CR, FLASH_CR_PGSERRIE) == (FLASH_CR_PGSERRIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->CR, FLASH_CR_STRBERRIE);
}
...
{
  CLEAR_BIT(flashx->CR, FLASH_CR_STRBERRIE);
}
...
{
  return ((READ_BIT(flashx->CR, FLASH_CR_STRBERRIE) == (FLASH_CR_STRBERRIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->CR, FLASH_CR_INCERRIE);
}
...
{
  CLEAR_BIT(flashx->CR, FLASH_CR_INCERRIE);
}
...
{
  return ((READ_BIT(flashx->CR, FLASH_CR_INCERRIE) == (FLASH_CR_INCERRIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->CR, FLASH_CR_OPTCHANGEERRIE);
}
...
{
  CLEAR_BIT(flashx->CR, FLASH_CR_OPTCHANGEERRIE);
}
...
{
  return ((READ_BIT(flashx->CR, FLASH_CR_OPTCHANGEERRIE) == (FLASH_CR_OPTCHANGEERRIE)) ? 1UL : 0UL);
}

/**
  * @brief  Enable the flash privileged protection for the registers.
  * @rmtoll
  *  PRIVCFGR          PRIV          LL_FLASH_EnablePrivilege
  * @param  flashx FLASH instance.
  */
__STATIC_INLINE void LL_FLASH_EnablePrivilege(FLASH_TypeDef *flashx)
{
  SET_BIT(flashx->PRIVCFGR, FLASH_PRIVCFGR_PRIV);
}

/**
  * @brief  Disable the flash privileged protection for the registers.
  * @rmtoll
  *  PRIVCFGR          PRIV          LL_FLASH_DisablePrivilege
  * @param  flashx FLASH instance.
  */
__STATIC_INLINE void LL_FLASH_DisablePrivilege(FLASH_TypeDef *flashx)
{
  CLEAR_BIT(flashx->PRIVCFGR, FLASH_PRIVCFGR_PRIV);
}

/**
  * @brief  Check if the flash privileged protection for the registers is enabled or disabled.
  * @rmtoll
  *  PRIVCFGR          PRIV          LL_FLASH_IsEnabledPrivilege
  * @param  flashx FLASH instance.
  * @retval State of flash privilege (1 enabled / 0 disabled).
  */
__STATIC_INLINE uint32_t LL_FLASH_IsEnabledPrivilege(const FLASH_TypeDef *flashx)
{
  return ((READ_BIT(flashx->PRIVCFGR, FLASH_PRIVCFGR_PRIV) == (FLASH_PRIVCFGR_PRIV)) ? 1UL : 0UL);
}

/**
  * @brief  Set the flash page configuration for extended hide protection area by bank.
  * @rmtoll
  *  HDPEXTR       HDP1_EXT/HDP2_EXT          LL_FLASH_BANK_SetHDPExtArea
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  ...
  */
__STATIC_INLINE void LL_FLASH_BANK_SetHDPExtArea(FLASH_TypeDef *flashx, uint32_t bank, uint32_t page_nbr)
{
  MODIFY_REG(flashx->HDPEXTR, FLASH_HDPEXTR_HDP1_EXT_Msk << bank, page_nbr << bank);
}

/**
  * @brief  Get the flash page configuration for extended hide protection area by bank.
  * @rmtoll
  *  HDPEXTR       HDP1_EXT/HDP2_EXT          LL_FLASH_BANK_GetHDPExtArea
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  *         @arg @ref LL_FLASH_HDPEXT_BANK_1
  ...
  */
__STATIC_INLINE uint32_t LL_FLASH_BANK_GetHDPExtArea(const FLASH_TypeDef *flashx, const uint32_t bank)
{
  return (READ_BIT(flashx->HDPEXTR, FLASH_HDPEXTR_HDP1_EXT_Msk << bank) >> bank);
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_IWDG_SW, hw_sw_selection);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_IWDG_SW));
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_WWDG_SW, hw_sw_selection);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_WWDG_SW));
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_NRST_STOP, rst_generation);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_NRST_STOP));
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_NRST_STDBY, rst_generation);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_NRST_STDBY));
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_RDP_LEVEL, rdp_level << FLASH_OPTSR_PRG_RDP_LEVEL_Pos);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_RDP_LEVEL) >> FLASH_OPTSR_PRG_RDP_LEVEL_Pos);
}
...
{
  CLEAR_BIT(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_IWDG_STOP);
}
...
{
  SET_BIT(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_IWDG_STOP);
}
...
{
  return ((READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_IWDG_STOP) == (FLASH_OPTSR_PRG_IWDG_STOP)) ? 0UL : 1UL);
}
...
{
  CLEAR_BIT(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_IWDG_STDBY);
}
...
{
  SET_BIT(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_IWDG_STDBY);
}
...
{
  return ((READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_IWDG_STDBY) == (FLASH_OPTSR_PRG_IWDG_STDBY)) ? 0UL : 1UL);
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_BOOT_SEL, boot_sel);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_BOOT_SEL));
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_BOOT0, boot0);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_BOOT0));
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, (FLASH_OPTSR_PRG_BOOT_SEL | FLASH_OPTSR_PRG_BOOT0), boot0);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, (FLASH_OPTSR_PRG_BOOT_SEL | FLASH_OPTSR_PRG_BOOT0)));
}
...
{
  SET_BIT(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_EDATA_EN);
}
...
{
  CLEAR_BIT(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_EDATA_EN);
}
...
{
  return ((READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_EDATA_EN) == (FLASH_OPTSR_PRG_EDATA_EN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_SINGLE_BANK, single_dual_bank);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_SINGLE_BANK));
}
...
{
  MODIFY_REG(flashx->OPTSR_PRG, FLASH_OPTSR_PRG_SWAP_BANK, swap_bank);
}
...
{
  return (READ_BIT(flashx->OPTSR_CUR, FLASH_OPTSR_PRG_SWAP_BANK));
}
...
{
  MODIFY_REG(flashx->OPTSR2_PRG, FLASH_OPTSR2_PRG_SRAM1_RST, erase_sram);
}
...
{
  return (READ_BIT(flashx->OPTSR2_CUR, FLASH_OPTSR2_PRG_SRAM1_RST));
}
...
{
  CLEAR_BIT(flashx->OPTSR2_PRG, FLASH_OPTSR2_PRG_SRAM2_ECC);
}
...
{
  SET_BIT(flashx->OPTSR2_PRG, FLASH_OPTSR2_PRG_SRAM2_ECC);
}
...
{
  return ((READ_BIT(flashx->OPTSR2_CUR, FLASH_OPTSR2_PRG_SRAM2_ECC) == (FLASH_OPTSR2_PRG_SRAM2_ECC)) ? 0UL : 1UL);
}
...
{
  MODIFY_REG(flashx->OPTSR2_PRG, FLASH_OPTSR2_PRG_SRAM2_RST, erase_sram2);
}
...
{
  return (READ_BIT(flashx->OPTSR2_CUR, FLASH_OPTSR2_PRG_SRAM2_RST));
}
...
{
  MODIFY_REG(flashx->BOOTR_PRG, FLASH_BOOTR_PRG_BOOT_LOCK, LL_FLASH_OB_BOOT_LOCKED);
}
...
{
  MODIFY_REG(flashx->BOOTR_PRG, FLASH_BOOTR_PRG_BOOT_LOCK, LL_FLASH_OB_BOOT_NOT_LOCKED);
}
...
{
  return ((READ_BIT(flashx->BOOTR_CUR, FLASH_BOOTR_PRG_BOOT_LOCK) == LL_FLASH_OB_BOOT_LOCKED) ? 1UL : 0UL);
}
/**
...
{
  MODIFY_REG(flashx->BOOTR_PRG, FLASH_BOOTR_PRG_BOOTADD, boot_addr);
}
...
{
  return (READ_BIT(flashx->BOOTR_CUR, FLASH_BOOTR_PRG_BOOTADD));
}
...
{
  SET_BIT(flashx->OTPBLR_PRG, (FLASH_OTPBLR_PRG_LOCKBL & block));
}
...
{
  return (((READ_BIT(flashx->OTPBLR_CUR, FLASH_OTPBLR_PRG_LOCKBL) & block) == block) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(flashx->BL_COM_CFG_PRG, FLASH_BL_COM_CFG_PRG_BL_COM_CFG, bootloader_config);
}
...
{
  return READ_BIT(flashx->BL_COM_CFG_CUR, FLASH_BL_COM_CFG_PRG_BL_COM_CFG);
}

/**
  * @brief  Enable the flash write protection on the selected pages of the selected bank.
  * @rmtoll
  *  WRP1R/WRP2R          WRP1R_WRPSG/WRP2R_WRPSG          LL_FLASH_OB_BANK_EnablePageWRP
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  ...
  */
__STATIC_INLINE void LL_FLASH_OB_BANK_EnablePageWRP(FLASH_TypeDef *flashx, uint32_t bank, uint32_t page)
{
  __IO uint32_t *reg_addr = &flashx->WRP1R_PRG + bank;
  CLEAR_BIT(*reg_addr, (FLASH_WRP1R_PRG_WRPSG1 & page));
}

/**
  * @brief  Disable the flash write protection on the selected pages of the selected bank.
  * @rmtoll
  *  WRP1R/WRP2R          WRP1R_WRPSG/WRP2R_WRPSG          LL_FLASH_OB_BANK_DisablePageWRP
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  *         @arg @ref LL_FLASH_BANK_1
  ...
  *         This parameter can be any combination of @ref LL_FLASH_OB_Write_Protection_Pages possible values.
  */
__STATIC_INLINE void LL_FLASH_OB_BANK_DisablePageWRP(FLASH_TypeDef *flashx, uint32_t bank, uint32_t page)
{
  __IO uint32_t *reg_addr = &flashx->WRP1R_PRG + bank;
  SET_BIT(*reg_addr, (FLASH_WRP1R_PRG_WRPSG1 & page));
}

/**
  * @brief  Get the flash page write protection flags by bank.
  * @rmtoll
  *  WRP1R_PRG/WRP2R_PRG          WRP1R_WRPSG/WRP2R_WRPSG          LL_FLASH_OB_BANK_IsEnabledPageWRP
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  *         @arg @ref LL_FLASH_BANK_1
  ...
  */
__STATIC_INLINE uint32_t LL_FLASH_OB_BANK_IsEnabledPageWRP(const FLASH_TypeDef *flashx,
                                                           const uint32_t bank,
                                                           uint32_t page)
{
  const __IO uint32_t *reg_addr = &flashx->WRP1R_CUR + bank;
  return ((((~(READ_BIT(*reg_addr, FLASH_WRP1R_PRG_WRPSG1))) & page) == page) ? 1UL : 0UL);
}

/**
  * @brief  Set the flash start page for hide protection area by bank.
  * @rmtoll
  *  HDP1R_PRG/HDP2R_PRG          HDP1R_STRT/HDP2R_STRT          LL_FLASH_OB_BANK_SetHDPAreaStartPage
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  *         @arg @ref LL_FLASH_BANK_1
  ...
  *         This parameter can be a value between 0x00U and the maximum number of pages by bank.
  */
__STATIC_INLINE void LL_FLASH_OB_BANK_SetHDPAreaStartPage(FLASH_TypeDef *flashx, uint32_t bank, uint32_t page)
{
  __IO uint32_t *reg_addr = &flashx->HDP1R_PRG + bank;
  MODIFY_REG(*reg_addr, FLASH_HDP1R_PRG_HDP1_STRT, page << FLASH_HDP1R_PRG_HDP1_STRT_Pos);
}

/**
  * @brief  Get the flash start page for hide protection area by bank.
  * @rmtoll
  *  HDP1R_CUR/HDP2R_CUR          HDP1R_STRT/HDP2R_STRT          LL_FLASH_OB_BANK_GetHDPAreaStartPage
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  *         @arg @ref LL_FLASH_BANK_1
  ...
  * @retval Returned value can be a value between 0x00U and the maximum number of pages by bank.
  */
__STATIC_INLINE uint32_t LL_FLASH_OB_BANK_GetHDPAreaStartPage(const FLASH_TypeDef *flashx, const uint32_t bank)
{
  const __IO uint32_t *reg_addr = &flashx->HDP1R_CUR + bank;
  return (READ_BIT(*reg_addr, FLASH_HDP1R_PRG_HDP1_STRT) >> FLASH_HDP1R_PRG_HDP1_STRT_Pos);
}

/**
  * @brief  Set the flash end page for hide protection area by bank.
  * @rmtoll
  *  HDP1R_PRG/HDP2R_PRG          HDP1R_END/HDP2R_END          LL_FLASH_OB_BANK_SetHDPAreaEndPage
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  *         @arg @ref LL_FLASH_BANK_1
  ...
  *         This parameter can be a value between 0x00U and the maximum number of pages by bank.
  */
__STATIC_INLINE void LL_FLASH_OB_BANK_SetHDPAreaEndPage(FLASH_TypeDef *flashx, uint32_t bank, uint32_t page)
{
  __IO uint32_t *reg_addr = &flashx->HDP1R_PRG + bank;
  MODIFY_REG(*reg_addr, FLASH_HDP1R_PRG_HDP1_END, page << FLASH_HDP1R_PRG_HDP1_END_Pos);
}

/**
  * @brief  Get the flash end page for hide protection area by bank.
  * @rmtoll
  *  HDP1R_CUR/HDP2R_CUR          HDP1R_END/HDP2R_END          LL_FLASH_OB_BANK_GetHDPAreaEndPage
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  *         @arg @ref LL_FLASH_BANK_1
  ...
  * @retval Returned value can be a value between 0x00U and the maximum number of pages by bank.
  */
__STATIC_INLINE uint32_t LL_FLASH_OB_BANK_GetHDPAreaEndPage(const FLASH_TypeDef *flashx, const uint32_t bank)
{
  const __IO uint32_t *reg_addr = &flashx->HDP1R_CUR + bank;
  return (READ_BIT(*reg_addr, FLASH_HDP1R_PRG_HDP1_END) >> FLASH_HDP1R_PRG_HDP1_END_Pos);
}

/**
  * @brief  Configure the flash hide protection area by bank.
  * @rmtoll
  *  HDP1R_PRG/HDP2R_PRG        HDP1R_END|HDP1R_STRT/HDP2R_END|HDP2R_STRT      LL_FLASH_OB_BANK_ConfigHDPArea
  * @param  flashx FLASH instance.
  * @param  bank
  *         This parameter can be one of the following values:
  *         @arg @ref LL_FLASH_BANK_1
  ...
  *         This parameter can be a value between 0x00U and the maximum number of pages by bank.
  */
__STATIC_INLINE void LL_FLASH_OB_BANK_ConfigHDPArea(FLASH_TypeDef *flashx, uint32_t bank,
                                                    uint32_t start_page,
                                                    uint32_t end_page)
{
  __IO uint32_t *reg_addr = &flashx->HDP1R_PRG + bank;
  MODIFY_REG(*reg_addr, FLASH_HDP1R_PRG_HDP1_END | FLASH_HDP1R_PRG_HDP1_STRT, \
             (end_page << FLASH_HDP1R_PRG_HDP1_END_Pos) + (start_page << FLASH_HDP1R_PRG_HDP1_STRT_Pos));
}


/**
  * @brief  Get the flash ECC single fail address offset.
  * @rmtoll
  *  ECCCORR           ADDR_ECC           LL_FLASH_GetECCCFailAddressOffset
  * @param  flashx FLASH instance.
  * @retval Returned value : ECC failed address offset.
  */
__STATIC_INLINE uint32_t LL_FLASH_GetECCCFailAddressOffset(const FLASH_TypeDef *flashx)
{
  return (READ_BIT(flashx->ECCCORR, FLASH_ECCCORR_ADDR_ECC) >> FLASH_ECCCORR_ADDR_ECC_Pos);
}

/**
  * @brief  Get the flash corrected ECC single fail data flash flag.
  * @rmtoll
  *  ECCCORR           DATA_ECC           LL_FLASH_IsActiveFlag_DATA_ECCC
  * @param  flashx FLASH instance.
  * @retval State of corrected ECC single fail data flash flag (1: ECC fail in data flash / 0: not in data flash).
  */
__STATIC_INLINE uint32_t LL_FLASH_IsActiveFlag_DATA_ECCC(const FLASH_TypeDef *flashx)
{
  return ((READ_BIT(flashx->ECCCORR, FLASH_ECCCORR_DATA_ECC) == (FLASH_ECCCORR_DATA_ECC)) ? 1UL : 0UL);
}

/**
  * @brief  Get the flash ECC single fail bank flag.
  * @rmtoll
  *  ECCCORR           BK_ECC           LL_FLASH_IsActiveFlag_BK_ECCC
  * @param  flashx FLASH instance.
  * @retval Returned value : ECC failed bank (1: ECC fail in Bank 2 / 0: ECC fail in Bank 1).
  */
__STATIC_INLINE uint32_t LL_FLASH_IsActiveFlag_BK_ECCC(const FLASH_TypeDef *flashx)
{
  return ((READ_BIT(flashx->ECCCORR, FLASH_ECCCORR_BK_ECC) == (FLASH_ECCCORR_BK_ECC)) ? 1UL : 0UL);
}


/**
  * @brief  Get the flash corrected ECC single fail system flash flag.
  * @rmtoll
  *  ECCCORR           SYSF_ECC           LL_FLASH_IsActiveFlag_SYSF_ECCC
  * @param  flashx FLASH instance.
  * @retval State of corrected ECC single fail system flash flag (1: ECC fail in system flash / 0: not in system flash).
  */
__STATIC_INLINE uint32_t LL_FLASH_IsActiveFlag_SYSF_ECCC(const FLASH_TypeDef *flashx)
{
  return ((READ_BIT(flashx->ECCCORR, FLASH_ECCCORR_SYSF_ECC) == (FLASH_ECCCORR_SYSF_ECC)) ? 1UL : 0UL);
}

/**
  * @brief  Get the flash corrected ECC single fail OTP flash flag.
  * @rmtoll
  *  ECCCORR           OTP_ECC           LL_FLASH_IsActiveFlag_OTP_ECCC
  * @param  flashx FLASH instance.
  * @retval State of corrected ECC single fail OTP flash flag (1: ECC fail in OTP flash / 0: not in OTP flash).
  */
__STATIC_INLINE uint32_t LL_FLASH_IsActiveFlag_OTP_ECCC(const FLASH_TypeDef *flashx)
{
  return ((READ_BIT(flashx->ECCCORR, FLASH_ECCCORR_OTP_ECC) == (FLASH_ECCCORR_OTP_ECC)) ? 1UL : 0UL);
}

/**
  * @brief  Read the state of selected ECCC flags.
  * @rmtoll
  *  ECCCORR     DATA_ECC|BK_ECC/SYSF_ECC|OTP_ECC      LL_FLASH_ReadFlag_ECCC
  * @param  flashx FLASH instance.
  * @param  flags
  *         This parameter can one or a combination of the following values:
  *         @arg @ref LL_FLASH_FLAG_DATA_ECC
...
{
  return (READ_BIT(flashx->ECCCORR, flags));
}

/**
  * @brief  Enable the flash end of operation interrupt.
  * @rmtoll
  *  CR          ECCIE        LL_FLASH_EnableIT_ECCC
  * @param  flashx FLASH instance.
  */
__STATIC_INLINE void LL_FLASH_EnableIT_ECCC(FLASH_TypeDef *flashx)
{
  SET_BIT(flashx->ECCCORR, FLASH_ECCCORR_ECCCIE);
}

/**
  * @brief  Disable the flash end of operation interrupt.
  * @rmtoll
  *  CR          ECCIE        LL_FLASH_DisableIT_ECCC
  * @param  flashx FLASH instance.
  */
__STATIC_INLINE void LL_FLASH_DisableIT_ECCC(FLASH_TypeDef *flashx)
{
  CLEAR_BIT(flashx->ECCCORR, FLASH_ECCCORR_ECCCIE);
}

/**
  * @brief  Check if the flash end of operation interrupt is enabled or disabled.
  * @rmtoll
  *  CR          ECCIE        LL_FLASH_IsEnabledIT_ECCC
  * @param  flashx FLASH instance.
  * @retval State of flash EOP interruption (1 enabled / 0 disabled).
  */
__STATIC_INLINE uint32_t LL_FLASH_IsEnabledIT_ECCC(const FLASH_TypeDef *flashx)
{
  return ((READ_BIT(flashx->ECCCORR, FLASH_ECCCORR_ECCCIE) == (FLASH_ECCCORR_ECCCIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(flashx->ECCCORR, FLASH_ECCCORR_ECCC) == (FLASH_ECCCORR_ECCC)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->ECCCORR, FLASH_ECCCORR_ECCC);
}

/**
  * @brief  Get the flash ECC double fail address offset.
  * @rmtoll
  *  ECCDETR           ADDR_ECC           LL_FLASH_GetECCDFailAddressOffset
  * @param  flashx FLASH instance.
  * @retval Returned value : ECC failed address offset.
  */
__STATIC_INLINE uint32_t LL_FLASH_GetECCDFailAddressOffset(const FLASH_TypeDef *flashx)
{
  return (READ_BIT(flashx->ECCDETR, FLASH_ECCDETR_ADDR_ECC) >> FLASH_ECCDETR_ADDR_ECC_Pos);
}

/**
  * @brief  Get the flash ECC double fail data flash flag.
  * @rmtoll
  *  ECCDETR           DATA_ECC           LL_FLASH_IsActiveFlag_DATA_ECCD
  * @param  flashx FLASH instance.
  * @retval State of ECC double fail data flash flag (1: ECC fail in data flash / 0: not in data flash).
  */
__STATIC_INLINE uint32_t LL_FLASH_IsActiveFlag_DATA_ECCD(const FLASH_TypeDef *flashx)
{
  return ((READ_BIT(flashx->ECCDETR, FLASH_ECCDETR_DATA_ECC) == (FLASH_ECCDETR_DATA_ECC)) ? 1UL : 0UL);
}

/**
  * @brief  Get the flash ECC double fail bank flag.
  * @rmtoll
...
{
  return ((READ_BIT(flashx->ECCDETR, FLASH_ECCDETR_BK_ECC) == (FLASH_ECCDETR_BK_ECC)) ? 1UL : 0UL);
}

/**
  * @brief  Get the flash ECC double fail system flash flag.
  * @rmtoll
  *  ECCDETR           SYSF_ECC           LL_FLASH_IsActiveFlag_SYSF_ECCD
  * @param  flashx FLASH instance.
  * @retval State of ECC double fail system flash flag (1: ECC fail in system flash / 0: not in system flash).
  */
__STATIC_INLINE uint32_t LL_FLASH_IsActiveFlag_SYSF_ECCD(const FLASH_TypeDef *flashx)
{
  return ((READ_BIT(flashx->ECCDETR, FLASH_ECCDETR_SYSF_ECC) == (FLASH_ECCDETR_SYSF_ECC)) ? 1UL : 0UL);
}

/**
  * @brief  Get the flash ECC double fail OTP flash flag.
  * @rmtoll
  *  ECCDETR           OTP_ECC           LL_FLASH_IsActiveFlag_OTP_ECCD
  * @param  flashx FLASH instance.
  * @retval State of ECC double fail OTP flash flag (1: ECC fail in OTP flash / 0: not in OTP flash).
  */
__STATIC_INLINE uint32_t LL_FLASH_IsActiveFlag_OTP_ECCD(const FLASH_TypeDef *flashx)
{
  return ((READ_BIT(flashx->ECCDETR, FLASH_ECCDETR_OTP_ECC) == (FLASH_ECCDETR_OTP_ECC)) ? 1UL : 0UL);
}

/**
  * @brief  Read the state of selected ECCD flags.
  * @rmtoll
  *  ECCDETR     DATA_ECC|BK_ECC/SYSF_ECC|OTP_ECC     LL_FLASH_ReadFlag_ECCD
  * @param  flashx FLASH instance.
  * @param  flags
  *         This parameter can one or a combination of the following values:
  *         @arg @ref LL_FLASH_FLAG_DATA_ECC
...
{
  return (READ_BIT(flashx->ECCDETR, flags));
}
...
{
  return ((READ_BIT(flashx->ECCDETR, FLASH_ECCDETR_ECCD) == (FLASH_ECCDETR_ECCD)) ? 1UL : 0UL);
}
...
{
  SET_BIT(flashx->ECCDETR, FLASH_ECCDETR_ECCD);
}

/**
  * @brief  Get the flash ECC double fail data.
  * @rmtoll
  *  ECCDR           DATA_ECC           LL_FLASH_GetECCDFailData
  * @param  flashx FLASH instance.
  * @retval Returned value : ECC failed data.
  */
__STATIC_INLINE uint32_t LL_FLASH_GetECCDFailData(const FLASH_TypeDef *flashx)
{
  return (READ_BIT(flashx->ECCDR, FLASH_ECCDR_DATA_ECC) >> FLASH_ECCDR_DATA_ECC_Pos);
}

/**
  * @brief  Get the flash ECC double fail 16-bit word number.
  * @rmtoll
  *  ECCDR         DATA_ADDR_ECC         LL_FLASH_GetECCDFailWordNumber
  * @param  flashx FLASH instance.
  * @retval Returned value : ECC failed 16-bit word number.
  */
__STATIC_INLINE uint32_t LL_FLASH_GetECCDFailWordNumber(const FLASH_TypeDef *flashx)
{
  return (READ_BIT(flashx->ECCDR, FLASH_ECCDR_DATA_ADDR_ECC) >> FLASH_ECCDR_DATA_ADDR_ECC_Pos);
}
...
{
  MODIFY_REG(flashx->OEMKEYR1_PRG, FLASH_OEMKEYR1_PRG_OEMKEY, oem_key_word);
}
...
{
  MODIFY_REG(flashx->OEMKEYR2_PRG, FLASH_OEMKEYR2_PRG_OEMKEY, oem_key_word);
}
...
{
  MODIFY_REG(flashx->OEMKEYR3_PRG, FLASH_OEMKEYR3_PRG_OEMKEY, oem_key_word);
}
...
{
  MODIFY_REG(flashx->OEMKEYR4_PRG, FLASH_OEMKEYR4_PRG_OEMKEY, oem_key_word);
}
...
{
  MODIFY_REG(flashx->BSKEYR_PRG, FLASH_BSKEYR_PRG_BSKEY, bs_key);
