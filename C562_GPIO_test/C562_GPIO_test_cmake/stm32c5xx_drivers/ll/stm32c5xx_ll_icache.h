...
/**
  ...
  */
#define LL_ICACHE_WRITE_REG(instance, reg, value) WRITE_REG((instance)->reg, (value))
...
/**
  ...
  */
#define LL_ICACHE_READ_REG(instance, reg) READ_REG((instance)->reg)
...
{
  SET_BIT(icachex->CR, ICACHE_CR_EN);
}
...
{
  CLEAR_BIT(icachex->CR, ICACHE_CR_EN);
}
...
{
  return (READ_BIT(icachex->CR, ICACHE_CR_EN));
}
...
{
  MODIFY_REG(icachex->CR, ICACHE_CR_WAYSEL, mode);
}
...
{
  return (READ_BIT(icachex->CR, ICACHE_CR_WAYSEL));
}
...
{
  SET_BIT(icachex->CR, ICACHE_CR_CACHEINV);
}
...
{
  return ((READ_BIT(icachex->CR, monitors) == (monitors)) ? 1UL : 0UL);
}
...
{
  /* Reset */
  SET_BIT(icachex->CR, (monitors << 2U));
  /* Release reset */
  CLEAR_BIT(icachex->CR, (monitors << 2U));
}
...
{
  SET_BIT(icachex->IER, ICACHE_IER_BSYENDIE);
}
...
{
  CLEAR_BIT(icachex->IER, ICACHE_IER_BSYENDIE);
}
...
{
  return ((READ_BIT(icachex->IER, ICACHE_IER_BSYENDIE) == (ICACHE_IER_BSYENDIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(icachex->IER, ICACHE_IER_ERRIE);
}
...
{
  CLEAR_BIT(icachex->IER, ICACHE_IER_ERRIE);
}
...
{
  return ((READ_BIT(icachex->IER, ICACHE_IER_ERRIE) == (ICACHE_IER_ERRIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(icachex->IER, interrupts);
}
...
{
  CLEAR_BIT(icachex->IER, interrupt);
}
...
{
  return ((READ_BIT(icachex->IER, interrupts) == (interrupts)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(icachex->SR, ICACHE_SR_BUSYF) == (ICACHE_SR_BUSYF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(icachex->SR, ICACHE_SR_BSYENDF) == (ICACHE_SR_BSYENDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(icachex->SR, ICACHE_SR_ERRF) == (ICACHE_SR_ERRF)) ? 1UL : 0UL);
}
...
{
  WRITE_REG(icachex->FCR, ICACHE_FCR_CBSYENDF);
}
...
{
  WRITE_REG(icachex->FCR, ICACHE_FCR_CERRF);
}
...
{
  return ((READ_BIT(icachex->SR, interrupt) == (interrupt)) ? 1UL : 0UL);
}
...
{
  SET_BIT(*((__IO uint32_t *)(&(icachex->CRR0) + (1U * region))), ICACHE_CRRx_REN);
}
...
{
  CLEAR_BIT(*((__IO uint32_t *)(&(icachex->CRR0) + (1U * region))), (ICACHE_CRRx_REN));
}
...
{
  return ((READ_BIT(*((__IO const uint32_t *)(&(icachex->CRR0) + (1U * region))), \
...
{
  MODIFY_REG(*((__IO uint32_t *)(&(icachex->CRR0) + (1U * region))), \
...
{
  MODIFY_REG(*((__IO uint32_t *)(&(icachex->CRR0) + (1U * region))), ICACHE_CRRx_REMAPADDR, \
...
{
  WRITE_REG(*((__IO uint32_t *)(&(icachex->CRR0) + (1U * region))),
...
{
  return (READ_REG(*((__IO const uint32_t *)(&(icachex->CRR0) + (1U * region)))));
}
