...
/** @defgroup DMA_LL_EC_FLOW_CONTROL_MODE Flow Control Mode
  * @{
  */
#define LL_DMA_FLOW_CONTROL_DMA    0x00000000U     /*!< Hardware request is driven by a peripheral with a hardware
...
#endif /* SAES */
#if defined(XSPI1)
#define LL_LPDMA1_REQUEST_XSPI1_RX     94U /*!< LPDMA1 HW Request is XSPI1_RX     */
#endif /* XSPI1 */
...
#endif /* SAES */
#if defined(XSPI1)
#define LL_LPDMA2_REQUEST_XSPI1_RX     94U /*!< LPDMA2 HW Request is XSPI1_RX     */
#endif /* XSPI1 */
/**
  * @}
  */
...
{
  MODIFY_REG(channel->CCR, (DMA_CCR_PRIO | DMA_CCR_LSM), configuration);
}
...
{
  MODIFY_REG(channel->CTR1, DMA_CTR1_PAM, configuration);
}
...
{
  MODIFY_REG(channel->CTR2, (DMA_CTR2_TCEM | DMA_CTR2_TRIGPOL | DMA_CTR2_TRIGM | DMA_CTR2_SWREQ | \
...
{
  MODIFY_REG(channel->CTR2, DMA_CTR2_PFREQ, flow_control_mode);
}
...
{
  return (READ_BIT(channel->CTR2, DMA_CTR2_PFREQ));
}
...
{
  MODIFY_REG(channel->CTR2, DMA_CTR2_SWREQ, direction);
}
...
{
  return (READ_BIT(channel->CTR2, DMA_CTR2_SWREQ));
}
...
/**
  ...
  * @endif
  * @if XSPI1
  *         @arg @ref LL_LPDMA1_REQUEST_XSPI1_RX
  * @endif
  ...
  * @endif
  * @if XSPI1
  *         @arg @ref LL_LPDMA2_REQUEST_XSPI1_RX
  * @endif
  */
...
{
  MODIFY_REG(channel->CLLR, (DMA_CLLR_UT1 | DMA_CLLR_UT2 | DMA_CLLR_UB1 | DMA_CLLR_USA | DMA_CLLR_UDA | \
