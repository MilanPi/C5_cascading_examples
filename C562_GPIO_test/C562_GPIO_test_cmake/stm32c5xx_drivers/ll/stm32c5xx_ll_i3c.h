...
/** @defgroup I3C_LL_EC_IT IT Defines
  * @brief    IT defines which can be used with LL_I3C_READ_REG and  LL_I3C_WRITE_REG functions
  * @{
  */
...
/** @defgroup I3C_LL_EC_RX_THRESHOLD Rx threshold
  * @{
  */
#define LL_I3C_RXFIFO_THRESHOLD_1_4   0x00000000U /*!< Rx FIFO threshold is 1 byte in a FIFO depth of 4 bytes */
#define LL_I3C_RXFIFO_THRESHOLD_4_4   I3C_CFGR_RXTHRES /*!< Rx FIFO threshold is 4 bytes in a FIFO depth of 4 bytes */
/**
  * @}
  */
...
/** @defgroup I3C_LL_EC_TX_THRESHOLD Tx threshold
  * @{
  */
#define LL_I3C_TXFIFO_THRESHOLD_1_4   0x00000000U      /*!< Tx FIFO threshold is 1 byte in a FIFO depth of 4 bytes */
#define LL_I3C_TXFIFO_THRESHOLD_4_4   I3C_CFGR_TXTHRES /*!< Tx FIFO threshold is 4 bytes in a FIFO depth of 4 bytes */
/**
  * @}
  */
...
#define LL_I3C_PAYLOAD_2_BYTES  I3C_MAXRLR_IBIP_1                       /*!< 2 additional data bytes after IBI ack */
#define LL_I3C_PAYLOAD_3_BYTES  (I3C_MAXRLR_IBIP_1 | I3C_MAXRLR_IBIP_0) /*!< 3 additional data bytes after IBI ack */
#define LL_I3C_PAYLOAD_4_BYTES  I3C_MAXRLR_IBIP_2                       /*!< 4 additional data bytes after IBI ack */
/**
  * @}
  */
...
/** @defgroup I3C_LL_EC_HANDOFF_GRP_ADDR_NOT Handoof grp assr not
  * @{
  */
...
/**
  ...
  */
#define LL_I3C_WRITE_REG(INSTANCE, REG, VALUE) WRITE_REG((INSTANCE)->REG, (VALUE))
...
/**
  ...
  */
#define LL_I3C_READ_REG(INSTANCE, REG) READ_REG((INSTANCE)->REG)
/**
  * @}
  */
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_EN);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_EN);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_EN) == (I3C_CFGR_EN)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->DEVR0, I3C_DEVR0_RSTVAL) == (I3C_DEVR0_RSTVAL)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_i3c->CFGR, I3C_CFGR_CRINIT, peripheral_mode);
}
...
{
  return (uint32_t)((READ_BIT(p_i3c->CFGR, I3C_CFGR_CRINIT) == (I3C_CFGR_CRINIT)) ? 1UL : 0UL);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_NOARBH);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_NOARBH);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_NOARBH) == (I3C_CFGR_NOARBH)) ? 0UL : 1UL);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_RSTPTRN);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_RSTPTRN);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_RSTPTRN) == (I3C_CFGR_RSTPTRN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_EXITPTRN);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_EXITPTRN);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_EXITPTRN) == (I3C_CFGR_EXITPTRN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_HKSDAEN);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_HKSDAEN);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_HKSDAEN) == (I3C_CFGR_HKSDAEN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_HJACK);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_HJACK);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_HJACK) == (I3C_CFGR_HJACK)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_RXDMAEN);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_RXDMAEN);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_RXDMAEN) == (I3C_CFGR_RXDMAEN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_i3c->CFGR, I3C_CFGR_RXTHRES, rx_fifo_threshold);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->CFGR, I3C_CFGR_RXTHRES));
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_TXDMAEN);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_TXDMAEN);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_TXDMAEN) == (I3C_CFGR_TXDMAEN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_i3c->CFGR, I3C_CFGR_TXTHRES, tx_fifo_threshold);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->CFGR, I3C_CFGR_TXTHRES));
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_SDMAEN);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_SDMAEN);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_SDMAEN) == (I3C_CFGR_SDMAEN)) ? 1UL : 0UL);
}
...
/**
  ...
  * @param  p_i3c I3C Instance.
  * @param  fifo_config This bitfiled can only be programmed when the I3C is disabled (EN = 0).
  * @note   This parameter is computed with the STM32CubeMX Tool.
  */
__STATIC_INLINE void LL_I3C_ConfigCtrlFifo(I3C_TypeDef *p_i3c, uint32_t fifo_config)
{
  MODIFY_REG(p_i3c->CFGR, (I3C_CFGR_TXTHRES | I3C_CFGR_RXTHRES | I3C_CFGR_TMODE | I3C_CFGR_SMODE), fifo_config);
}
...
/**
  ...
  * @note   This parameter is computed with the STM32CubeMX Tool.
  */
__STATIC_INLINE void LL_I3C_ConfigTgtFifo(I3C_TypeDef *p_i3c, uint32_t fifo_config)
{
  MODIFY_REG(p_i3c->CFGR, (I3C_CFGR_TXTHRES | I3C_CFGR_RXTHRES), fifo_config);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_SMODE);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_SMODE);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_SMODE) == (I3C_CFGR_SMODE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_TMODE);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_TMODE);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_TMODE) == (I3C_CFGR_TMODE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_CDMAEN);
}
...
{
  CLEAR_BIT(p_i3c->CFGR, I3C_CFGR_CDMAEN);
}
...
{
  return ((READ_BIT(p_i3c->CFGR, I3C_CFGR_CDMAEN) == (I3C_CFGR_CDMAEN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->DEVR0, I3C_DEVR0_DAVAL);
}
...
{
  CLEAR_BIT(p_i3c->DEVR0, I3C_DEVR0_DAVAL);
}
...
{
  return ((READ_BIT(p_i3c->DEVR0, I3C_DEVR0_DAVAL) == (I3C_DEVR0_DAVAL)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_i3c->DEVR0, I3C_DEVR0_DA, (own_dynamic_address << I3C_DEVR0_DA_Pos));
}
...
{
  return (uint8_t)(READ_BIT(p_i3c->DEVR0, I3C_DEVR0_DA) >> I3C_DEVR0_DA_Pos);
}
...
{
  SET_BIT(p_i3c->DEVR0, I3C_DEVR0_IBIEN);
}
...
{
  CLEAR_BIT(p_i3c->DEVR0, I3C_DEVR0_IBIEN);
}
...
{
  return ((READ_BIT(p_i3c->DEVR0, I3C_DEVR0_IBIEN) == (I3C_DEVR0_IBIEN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->DEVR0, I3C_DEVR0_CREN);
}
...
{
  CLEAR_BIT(p_i3c->DEVR0, I3C_DEVR0_CREN);
}
...
{
  return ((READ_BIT(p_i3c->DEVR0, I3C_DEVR0_CREN) == (I3C_DEVR0_CREN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->DEVR0, I3C_DEVR0_HJEN);
}
...
{
  CLEAR_BIT(p_i3c->DEVR0, I3C_DEVR0_HJEN);
}
...
{
  return ((READ_BIT(p_i3c->DEVR0, I3C_DEVR0_HJEN) == (I3C_DEVR0_HJEN)) ? 1UL : 0UL);
}
...
/**
  ...
  * @param  max_read_lenght This parameter must be a value between Min_Data=0x0 and Max_Data=0xFFFF
  */
__STATIC_INLINE void LL_I3C_SetMaxReadLength(I3C_TypeDef *p_i3c, uint16_t max_read_lenght)
{
  MODIFY_REG(p_i3c->MAXRLR, I3C_MAXRLR_MRL, max_read_lenght);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->MAXRLR, I3C_MAXRLR_MRL));
}
...
/**
  ...
  *         @arg @ref LL_I3C_PAYLOAD_2_BYTES << I3C_MAXRLR_IBIP_Pos
  *         @arg @ref LL_I3C_PAYLOAD_3_BYTES << I3C_MAXRLR_IBIP_Pos
  *         @arg @ref LL_I3C_PAYLOAD_4_BYTES << I3C_MAXRLR_IBIP_Pos
  */
__STATIC_INLINE void LL_I3C_ConfigNbIBIAddData(I3C_TypeDef *p_i3c, uint32_t nb_ibi_add_data)
{
  MODIFY_REG(p_i3c->MAXRLR, I3C_MAXRLR_IBIP, nb_ibi_add_data);
}
...
{
  SET_BIT(p_i3c->MAXRLR, nb_ibi_add_data);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->MAXRLR, I3C_MAXRLR_IBIP));
}
...
/**
  ...
  * @param  p_i3c I3C Instance.
  * @param  max_write_lenght_byte This parameter must be a value between Min_Data=0x0 and Max_Data=0xFFFF
  * @note   Those bits can be updated by HW upon reception of GETMWL CCC.
  * @rmtoll
  *  MAXWLR       MWL           LL_I3C_SetMaxWriteLength
  */
__STATIC_INLINE void LL_I3C_SetMaxWriteLength(I3C_TypeDef *p_i3c, uint16_t max_write_lenght_byte)
{
  MODIFY_REG(p_i3c->MAXWLR, I3C_MAXWLR_MWL, max_write_lenght_byte);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->MAXWLR, I3C_MAXWLR_MWL));
}
...
{
  WRITE_REG(p_i3c->TIMINGR0, clock_wave_form);
}
...
{
  return (uint32_t)(READ_REG(p_i3c->TIMINGR0));
}
...
{
  MODIFY_REG(p_i3c->TIMINGR0, I3C_TIMINGR0_SCLL_PP, (period_clock_low_pp << I3C_TIMINGR0_SCLL_PP_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR0, I3C_TIMINGR0_SCLL_PP) >> I3C_TIMINGR0_SCLL_PP_Pos);
}
...
{
  MODIFY_REG(p_i3c->TIMINGR0, I3C_TIMINGR0_SCLH_I3C, (period_clock_high_i3c << I3C_TIMINGR0_SCLH_I3C_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR0, I3C_TIMINGR0_SCLH_I3C) >> I3C_TIMINGR0_SCLH_I3C_Pos);
}
...
{
  MODIFY_REG(p_i3c->TIMINGR0, I3C_TIMINGR0_SCLL_OD, (period_clock_low_od << I3C_TIMINGR0_SCLL_OD_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR0, I3C_TIMINGR0_SCLL_OD) >> I3C_TIMINGR0_SCLL_OD_Pos);
}
...
{
  MODIFY_REG(p_i3c->TIMINGR0, I3C_TIMINGR0_SCLH_I2C, period_clock_high_i2c << I3C_TIMINGR0_SCLH_I2C_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR0, I3C_TIMINGR0_SCLH_I2C) >> I3C_TIMINGR0_SCLH_I2C_Pos);
}
...
{
  MODIFY_REG(p_i3c->TIMINGR1, I3C_TIMINGR1_SDA_HD, data_hold_time);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR1, I3C_TIMINGR1_SDA_HD));
}
...
{
  MODIFY_REG(p_i3c->TIMINGR1, I3C_TIMINGR1_AVAL, (aval_timing << I3C_TIMINGR1_AVAL_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR1, I3C_TIMINGR1_AVAL) >> I3C_TIMINGR1_AVAL_Pos);
}
...
{
  MODIFY_REG(p_i3c->TIMINGR1, I3C_TIMINGR1_FREE, (free_timing << I3C_TIMINGR1_FREE_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR1, I3C_TIMINGR1_FREE) >> I3C_TIMINGR1_FREE_Pos);
}
...
{
  MODIFY_REG(p_i3c->TIMINGR1, I3C_TIMINGR1_ASNCR, controller_activity_state);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR1, I3C_TIMINGR1_ASNCR));
}


/**
  * @brief  Configure the controller SDA hold time, Bus Free, Activity state, Idle state.
  * @rmtoll TIMINGR1     SDA_HD        LL_I3C_SetBusCharacteristic\n
...
{
  WRITE_REG(p_i3c->TIMINGR1, ctrl_bus_characteristic);
}
...
{
  return (uint32_t)(READ_REG(p_i3c->TIMINGR1));
}
...
{
  MODIFY_REG(p_i3c->TIMINGR1, I3C_TIMINGR1_AVAL, (tgt_bus_characteristic & I3C_TIMINGR1_AVAL));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR1, I3C_TIMINGR1_AVAL));
}

/**
  * @brief  Configure the Stall time.
  * @rmtoll TIMINGR2     TIMINGR2      LL_I3C_ConfigStallTime
  * @param  p_i3c I3C Instance.
  * @param  stall_config This parameter must be a value between Min_Data=0 and Max_Data=0x0000FFFF.
  * @note   This bit can only be programmed when the I3C is disabled (EN = 0).
  * @note   This parameter is computed with the STM32CubeMX Tool.
  */
__STATIC_INLINE void LL_I3C_ConfigStallTime(I3C_TypeDef *p_i3c, uint32_t stall_config)
{
  WRITE_REG(p_i3c->TIMINGR2, stall_config);
}
...
{
  MODIFY_REG(p_i3c->TIMINGR2, I3C_TIMINGR2_STALL, (ctrl_stall_time << I3C_TIMINGR2_STALL_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALL));
}
...
{
  SET_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLL);
}
...
{
  CLEAR_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLL);
}
...
{
  return ((READ_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLL) == (I3C_TIMINGR2_STALLL)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLS);
}
...
{
  CLEAR_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLS);
}
...
{
  return ((READ_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLS) == (I3C_TIMINGR2_STALLS)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLR);
}
...
{
  CLEAR_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLR);
}
...
{
  return ((READ_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLR) == (I3C_TIMINGR2_STALLR)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLA);
}
...
{
  CLEAR_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLA);
}
...
{
  return ((READ_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLA) == (I3C_TIMINGR2_STALLA)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLC);
}
...
{
  CLEAR_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLC);
}
...
{
  return ((READ_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLC) == (I3C_TIMINGR2_STALLC)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLD);
}
...
{
  CLEAR_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLD);
}
...
{
  return ((READ_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLD) == (I3C_TIMINGR2_STALLD)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLT);
}
...
{
  CLEAR_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLT);
}
...
{
  return ((READ_BIT(p_i3c->TIMINGR2, I3C_TIMINGR2_STALLT) == (I3C_TIMINGR2_STALLT)) ? 1UL : 0UL);
}

/**
  * @brief   Set control capability, IBI payload support and max speed limitation in BCR register
. * @rmtoll BCR     BCR      LL_I3C_ConfigPayloadEntDAA
  * @param  p_i3c I3C Instance.
  * @param  payload control capability, IBI payload support and max speed limitation
  * @note   This bit can only be programmed when the I3C is disabled (EN = 0).
  * @note   This parameter is computed with the STM32CubeMX Tool.
  */
__STATIC_INLINE void LL_I3C_ConfigPayloadEntDAA(I3C_TypeDef *p_i3c, uint32_t payload)
{
  WRITE_REG(p_i3c->BCR, payload);
}
...
{
  MODIFY_REG(p_i3c->BCR, I3C_BCR_BCR6, device_capability_on_bus);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->BCR, I3C_BCR_BCR6));
}
...
{
  MODIFY_REG(p_i3c->BCR, I3C_BCR_BCR2, device_ibi_payload);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->BCR, I3C_BCR_BCR2));
}
...
{
  MODIFY_REG(p_i3c->BCR, I3C_BCR_BCR0, data_speed_limitation);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->BCR, I3C_BCR_BCR0));
}
...
{
  MODIFY_REG(p_i3c->DCR, I3C_DCR_DCR, device_characteristics);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->DCR, I3C_DCR_DCR));
}
...
{
  MODIFY_REG(p_i3c->GETCAPR, I3C_GETCAPR_CAPPEND, pending_read_mdb);
}

/**
  * @brief  Enable IBI MDB support for pending read notification.
  * @rmtoll GETCAPR     CAPPEND          LL_I3C_EnablePendingReadMDB
  * @param  p_i3c I3C Instance.
  * @note   Those bits can be programmed when the I3C is disabled (EN = 0).
  * @rmtoll
...
{
  SET_BIT(p_i3c->GETCAPR, I3C_GETCAPR_CAPPEND);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->GETCAPR, I3C_GETCAPR_CAPPEND));
}
...
{
  MODIFY_REG(p_i3c->CRCAPR, I3C_CRCAPR_CAPGRP, grp_addr_handoff_support);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->CRCAPR, I3C_CRCAPR_CAPGRP));
}
...
{
  MODIFY_REG(p_i3c->CRCAPR, I3C_CRCAPR_CAPDHOFF, controller_handoff_delayed);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->CRCAPR, I3C_CRCAPR_CAPDHOFF));
}

/**
  * @brief  Enable the Delayed controller Handoff bit in MSTCAP2.
  * @rmtoll CRCAPR      CAPDHOFF      LL_I3C_EnableHandOffDelay
  * @param  p_i3c I3C Instance.
  * @note   Those bits can be programmed when the I3C is disabled (EN = 0).
  * @rmtoll
...
{
  SET_BIT(p_i3c->CRCAPR, I3C_CRCAPR_CAPDHOFF);
}
...
{
  CLEAR_BIT(p_i3c->CRCAPR, I3C_CRCAPR_CAPDHOFF);
}

/**
  * @brief  Indicates if he Delayed controller Handoff bit in MSTCAP2 is enabled.
...
{
  return ((READ_BIT(p_i3c->CRCAPR, I3C_CRCAPR_CAPDHOFF) == I3C_CRCAPR_CAPDHOFF) ? 1UL : 0UL);
}

/**
  * @brief  Configure the controller fifo.
  * @rmtoll
  *  GETMXDSR     GETMXDSR    LL_I3C_SetConfigGETMXDS
  * @param  p_i3c I3C Instance.
  * @param  get_tmxds_config This bitfiled can only be programmed when the I3C is disabled (EN = 0).
  * @note   This parameter is computed with the STM32CubeMX Tool.
  */
__STATIC_INLINE void LL_I3C_SetConfigGETMXDS(I3C_TypeDef *p_i3c, uint32_t get_tmxds_config)
{
  WRITE_REG(p_i3c->GETMXDSR, get_tmxds_config);
}
...
{
  MODIFY_REG(p_i3c->GETMXDSR, I3C_GETMXDSR_HOFFAS, handoff_activity_state);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->GETMXDSR, I3C_GETMXDSR_HOFFAS));
}
...
{
  MODIFY_REG(p_i3c->GETMXDSR, I3C_GETMXDSR_FMT, max_data_speed_format);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->GETMXDSR, I3C_GETMXDSR_FMT));
}
...
{
  MODIFY_REG(p_i3c->GETMXDSR, I3C_GETMXDSR_RDTURN, (middle_byte_turn_around << I3C_GETMXDSR_RDTURN_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->GETMXDSR, I3C_GETMXDSR_RDTURN));
}
...
{
  MODIFY_REG(p_i3c->GETMXDSR, I3C_GETMXDSR_TSCO, data_turn_around_time);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->GETMXDSR, I3C_GETMXDSR_TSCO));
}
...
{
  MODIFY_REG(p_i3c->EPIDR, I3C_EPIDR_MIPIID, (mipi_instance_id << I3C_EPIDR_MIPIID_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->EPIDR, I3C_EPIDR_MIPIID) >> I3C_EPIDR_MIPIID_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->EPIDR, I3C_EPIDR_IDTSEL) >> I3C_EPIDR_IDTSEL_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->EPIDR, I3C_EPIDR_MIPIMID) >> I3C_EPIDR_MIPIMID_Pos);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_RXFLUSH);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_TXFLUSH);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_SFLUSH);
}
...
{
  MODIFY_REG(p_i3c->CFGR, I3C_CFGR_FCFDIS, eof_frame_config);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->CFGR, I3C_CFGR_FCFDIS));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->DEVR0, I3C_DEVR0_AS));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->DEVR0, I3C_DEVR0_RSTACT));
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_CFLUSH);
}
...
{
  SET_BIT(p_i3c->CFGR, I3C_CFGR_TSFSET);
}
...
{
  WRITE_REG(p_i3c->CR, ((tgt_addr << I3C_CR_ADD_Pos) | xfer_size | direction | msg_type | end_mode) \
...
{
  WRITE_REG(p_i3c->CR, ((ccc_value << I3C_CR_CCC_Pos) | add_byte_size | end_mode | LL_I3C_CONTROLLER_MTYPE_CCC) \
...
{
  WRITE_REG(p_i3c->CR, (msg_type | ibi_size_byte) & (I3C_CR_DCNT | I3C_CR_MTYPE));
}
...
{
  return (uint8_t)(READ_BIT(p_i3c->RDR, I3C_RDR_RDB0));
}
...
{
  return (uint32_t)(READ_REG(p_i3c->RDWR));
}
...
{
  WRITE_REG(p_i3c->IBIDR, own_ibi_payload);
}
...
{
  return (uint32_t)(READ_REG(p_i3c->IBIDR));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->RMR, I3C_RMR_IBIRDCNT));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->RMR, I3C_RMR_RADD) >> I3C_RMR_RADD_Pos);
}
...
{
  MODIFY_REG(p_i3c->TGTTDR, (I3C_TGTTDR_PRELOAD | I3C_TGTTDR_TGTTDCNT), (I3C_TGTTDR_PRELOAD | tx_data_count));
}
...
{
  return ((READ_BIT(p_i3c->TGTTDR, I3C_TGTTDR_PRELOAD) == (I3C_TGTTDR_PRELOAD)) ? 1UL : 0UL);
}
...
{
  return (uint16_t)(READ_BIT(p_i3c->TGTTDR, I3C_TGTTDR_TGTTDCNT));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->SR, I3C_SR_XDCNT));
}
...
{
  return ((READ_BIT(p_i3c->SR, I3C_SR_ABT) == (I3C_SR_ABT)) ? 1UL : 0UL);
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->SR, I3C_SR_DIR));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->SR, I3C_SR_MID));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->SER, I3C_SER_CODERR));
}
...
{
  return (uint32_t)(READ_BIT(p_i3c->RMR, I3C_RMR_RCODE) >> I3C_RMR_RCODE_Pos);
}
...
{
  MODIFY_REG(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_DA, (dynamic_addr << I3C_DEVRX_DA_Pos));
}
...
{
  return (uint32_t)((READ_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_DA)) >> I3C_DEVRX_DA_Pos);
}
...
{
  SET_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_IBIACK);
}
...
{
  CLEAR_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_IBIACK);
}
...
{
  return ((READ_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_IBIACK) == I3C_DEVRX_IBIACK) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_CRACK);
}
...
{
  CLEAR_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_CRACK);
}
...
{
  return ((READ_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_CRACK) == I3C_DEVRX_CRACK) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_IBIDEN);
}
...
{
  CLEAR_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_IBIDEN);
}
...
{
  return ((READ_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_IBIDEN) == I3C_DEVRX_IBIDEN) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_SUSP);
}
...
{
  CLEAR_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_SUSP);
}
...
{
  return ((READ_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_SUSP) == I3C_DEVRX_SUSP) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->DEVRX[target_id - 1U], I3C_DEVRX_DIS) != I3C_DEVRX_DIS) ? 1UL : 0UL);
}
...
__STATIC_INLINE void LL_I3C_ConfigDeviceCapabilities(I3C_TypeDef *p_i3c,
                                                     ...
                                                     uint32_t CRAck)
{
  MODIFY_REG(p_i3c->DEVRX[target_id - 1U], \
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_CFEF) == (I3C_EVR_CFEF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_TXFEF) == (I3C_EVR_TXFEF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_CFNFF) == (I3C_EVR_CFNFF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_SFNEF) == (I3C_EVR_SFNEF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_TXFNFF) == (I3C_EVR_TXFNFF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_RXFNEF) == (I3C_EVR_RXFNEF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_RXLASTF) == (I3C_EVR_RXLASTF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_TXLASTF) == (I3C_EVR_TXLASTF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_FCF) == (I3C_EVR_FCF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_RXTGTENDF) == (I3C_EVR_RXTGTENDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_ERRF) == (I3C_EVR_ERRF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_IBIF) == (I3C_EVR_IBIF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_IBIENDF) == (I3C_EVR_IBIENDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_CRF) == (I3C_EVR_CRF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_CRUPDF) == (I3C_EVR_CRUPDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_HJF) == (I3C_EVR_HJF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_WKPF) == (I3C_EVR_WKPF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_GETF) == (I3C_EVR_GETF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_STAF) == (I3C_EVR_STAF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_DAUPDF) == (I3C_EVR_DAUPDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_MWLUPDF) == (I3C_EVR_MWLUPDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_MRLUPDF) == (I3C_EVR_MRLUPDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_RSTF) == (I3C_EVR_RSTF)) ? 1UL : 0UL);
}

/**
  * @brief  Indicates the status of active sState flag (target mode).
  *         RESET: clear default value.
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_ASUPDF) == (I3C_EVR_ASUPDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_INTUPDF) == (I3C_EVR_INTUPDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_DEFF) == (I3C_EVR_DEFF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->EVR, I3C_EVR_GRPF) == (I3C_EVR_GRPF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->SER, I3C_SER_PERR) == (I3C_SER_PERR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->SER, I3C_SER_STALL) == (I3C_SER_STALL)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->SER, I3C_SER_DOVR) == (I3C_SER_DOVR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->SER, I3C_SER_COVR) == (I3C_SER_COVR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->SER, I3C_SER_ANACK) == (I3C_SER_ANACK)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->SER, I3C_SER_DNACK) == (I3C_SER_DNACK)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->SER, I3C_SER_DERR) == (I3C_SER_DERR)) ? 1UL : 0UL);
}
...
{
  CLEAR_BIT(p_i3c->IER, mask);
}

/**
  * @brief  Check whether the specified I3C interrupts sources are enabled or not.
  * @rmtoll
  *  IER  CFNFIE     LL_I3C_GetITSource  \n
  *  IER  SFNEIE     LL_I3C_GetITSource  \n
  *  IER  TXFNFIE    LL_I3C_GetITSource  \n
  *  IER  RXFNEIE    LL_I3C_GetITSource  \n
  *  IER  FCIE       LL_I3C_GetITSource  \n
  *  IER  RXTGTENDIE LL_I3C_GetITSource  \n
  *  IER  ERRIE      LL_I3C_GetITSource  \n
  *  IER  IBIIE      LL_I3C_GetITSource  \n
  *  IER  IBIENDIE   LL_I3C_GetITSource  \n
  *  IER  CRIE       LL_I3C_GetITSource  \n
  *  IER  CRUPDIE    LL_I3C_GetITSource  \n
  *  IER  HJIE       LL_I3C_GetITSource  \n
  *  IER  WKPIE      LL_I3C_GetITSource  \n
  *  IER  GETIE      LL_I3C_GetITSource  \n
  *  IER  STAIE      LL_I3C_GetITSource  \n
  *  IER  DAUPDIE    LL_I3C_GetITSource  \n
  *  IER  MWLUPDIE   LL_I3C_GetITSource  \n
  *  IER  MRLUPDIE   LL_I3C_GetITSource  \n
  *  IER  RSTIE      LL_I3C_GetITSource  \n
  *  IER  ASUPDIE    LL_I3C_GetITSource  \n
  *  IER  INTUPDIE   LL_I3C_GetITSource  \n
  *  IER  DEFIE      LL_I3C_GetITSource  \n
  *  IER  GRPIE      LL_I3C_GetITSource
  * @param  p_i3c I3C instance.
...
{
  return ((READ_BIT(p_i3c->IER, mask) == (mask)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_CFNFIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_CFNFIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_CFNFIE) == (I3C_IER_CFNFIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_SFNEIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_SFNEIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_SFNEIE) == (I3C_IER_SFNEIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_TXFNFIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_TXFNFIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_TXFNFIE) == (I3C_IER_TXFNFIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_RXFNEIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_RXFNEIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_RXFNEIE) == (I3C_IER_RXFNEIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_FCIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_FCIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_FCIE) == (I3C_IER_FCIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_RXTGTENDIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_RXTGTENDIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_RXTGTENDIE) == (I3C_IER_RXTGTENDIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_ERRIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_ERRIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_ERRIE) == (I3C_IER_ERRIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_IBIIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_IBIIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_IBIIE) == (I3C_IER_IBIIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_IBIENDIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_IBIENDIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_IBIENDIE) == (I3C_IER_IBIENDIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_CRIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_CRIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_CRIE) == (I3C_IER_CRIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_CRUPDIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_CRUPDIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_CRUPDIE) == (I3C_IER_CRUPDIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_HJIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_HJIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_HJIE) == (I3C_IER_HJIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_WKPIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_WKPIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_WKPIE) == (I3C_IER_WKPIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_GETIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_GETIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_GETIE) == (I3C_IER_GETIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_STAIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_STAIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_STAIE) == (I3C_IER_STAIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_DAUPDIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_DAUPDIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_DAUPDIE) == (I3C_IER_DAUPDIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_MWLUPDIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_MWLUPDIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_MWLUPDIE) == (I3C_IER_MWLUPDIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_MRLUPDIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_MRLUPDIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_MRLUPDIE) == (I3C_IER_MRLUPDIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_RSTIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_RSTIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_RSTIE) == (I3C_IER_RSTIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_ASUPDIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_ASUPDIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_ASUPDIE) == (I3C_IER_ASUPDIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_INTUPDIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_INTUPDIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_INTUPDIE) == (I3C_IER_INTUPDIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_DEFIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_DEFIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_DEFIE) == (I3C_IER_DEFIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i3c->IER, I3C_IER_GRPIE);
}
...
{
  CLEAR_BIT(p_i3c->IER, I3C_IER_GRPIE);
}
...
{
  return ((READ_BIT(p_i3c->IER, I3C_IER_GRPIE) == (I3C_IER_GRPIE)) ? 1UL : 0UL);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CFCF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CRXTGTENDF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CERRF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CIBIF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CIBIENDF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CCRF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CCRUPDF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CHJF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CWKPF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CGETF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CSTAF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CDAUPDF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CMWLUPDF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CMRLUPDF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CRSTF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CASUPDF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CINTUPDF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CDEFF);
}
...
{
  WRITE_REG(p_i3c->CEVR, I3C_CEVR_CGRPF);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_CFNFMIS) == (I3C_MISR_CFNFMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_SFNEMIS) == (I3C_MISR_SFNEMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_TXFNFMIS) == (I3C_MISR_TXFNFMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_RXFNEMIS) == (I3C_MISR_RXFNEMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_FCMIS) == (I3C_MISR_FCMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_RXTGTENDMIS) == (I3C_MISR_RXTGTENDMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_ERRMIS) == (I3C_MISR_ERRMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_IBIMIS) == (I3C_MISR_IBIMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_IBIENDMIS) == (I3C_MISR_IBIENDMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_CRMIS) == (I3C_MISR_CRMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_CRUPDMIS) == (I3C_MISR_CRUPDMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_HJMIS) == (I3C_MISR_HJMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_WKPMIS) == (I3C_MISR_WKPMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_GETMIS) == (I3C_MISR_GETMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_STAMIS) == (I3C_MISR_STAMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_DAUPDMIS) == (I3C_MISR_DAUPDMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_MWLUPDMIS) == (I3C_MISR_MWLUPDMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_MRLUPDMIS) == (I3C_MISR_MRLUPDMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_RSTMIS) == (I3C_MISR_RSTMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_ASUPDMIS) == (I3C_MISR_ASUPDMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_INTUPDMIS) == (I3C_MISR_INTUPDMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_DEFMIS) == (I3C_MISR_DEFMIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i3c->MISR, I3C_MISR_GRPMIS) == (I3C_MISR_GRPMIS)) ? 1UL : 0UL);
}
