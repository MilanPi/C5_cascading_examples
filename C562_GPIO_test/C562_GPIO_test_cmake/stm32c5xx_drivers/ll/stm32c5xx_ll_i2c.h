...
/**
  ...
  */
#define LL_I2C_WRITE_REG(instance, reg, value) WRITE_REG((instance)->reg, (value))
...
/**
  ...
  */
#define LL_I2C_READ_REG(instance, reg) READ_REG((instance)->reg)
/**
  * @}
  */
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_PE) == (I2C_CR1_PE)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_i2c->CR1, I2C_CR1_ANFOFF | I2C_CR1_DNF, analog_filter | (digital_filter << I2C_CR1_DNF_Pos));
}
...
{
  MODIFY_REG(p_i2c->CR1, I2C_CR1_DNF, digital_filter << I2C_CR1_DNF_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->CR1, I2C_CR1_DNF) >> I2C_CR1_DNF_Pos);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_ANFOFF);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_ANFOFF);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_ANFOFF) != (I2C_CR1_ANFOFF)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_TXDMAEN);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_TXDMAEN);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_TXDMAEN) == (I2C_CR1_TXDMAEN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_RXDMAEN);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_RXDMAEN);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_RXDMAEN) == (I2C_CR1_RXDMAEN)) ? 1UL : 0UL);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_NOSTRETCH);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_NOSTRETCH);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_NOSTRETCH) != (I2C_CR1_NOSTRETCH)) ? 1UL : 0UL);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_SBC);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_SBC) == (I2C_CR1_SBC)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_WUPEN);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_WUPEN);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_WUPEN) == (I2C_CR1_WUPEN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_GCEN);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_GCEN);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_GCEN) == (I2C_CR1_GCEN)) ? 1UL : 0UL);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_FMP);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_FMP) == (I2C_CR1_FMP)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_ADDRACLR);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_ADDRACLR);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_ADDRACLR) == (I2C_CR1_ADDRACLR)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_STOPFACLR);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_STOPFACLR);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_STOPFACLR) == (I2C_CR1_STOPFACLR)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_i2c->CR2, I2C_CR2_ADD10, addressing_mode);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->CR2, I2C_CR2_ADD10));
}
...
{
  MODIFY_REG(p_i2c->OAR1, I2C_OAR1_OA1 | I2C_OAR1_OA1MODE, own_address1 | own_addr_size);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->OAR1, I2C_OAR1_OA1));
}
...
{
  SET_BIT(p_i2c->OAR1, I2C_OAR1_OA1EN);
}
...
{
  CLEAR_BIT(p_i2c->OAR1, I2C_OAR1_OA1EN);
}
...
{
  CLEAR_BIT(p_i2c->OAR1, I2C_OAR1_OA1EN | I2C_OAR1_OA1MODE);
}
...
{
  return ((READ_BIT(p_i2c->OAR1, I2C_OAR1_OA1EN) == (I2C_OAR1_OA1EN)) ? 1UL : 0UL);
}


/**
  * @brief  config the Own Address1 and enable it.
  * @rmtoll
...
{
  MODIFY_REG(p_i2c->OAR2, I2C_OAR2_OA2 | I2C_OAR2_OA2MSK, own_address2 | own_addr_mask);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->OAR2, I2C_OAR2_OA2) & 0xFFFFFFFEUL);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->OAR2, I2C_OAR2_OA2MSK));
}
...
{
  SET_BIT(p_i2c->OAR2, I2C_OAR2_OA2EN);
}
...
{
  CLEAR_BIT(p_i2c->OAR2, I2C_OAR2_OA2EN);
}
...
{
  return ((READ_BIT(p_i2c->OAR2, I2C_OAR2_OA2EN) == (I2C_OAR2_OA2EN)) ? 1UL : 0UL);
}
...
{
  WRITE_REG(p_i2c->TIMINGR, timing & (I2C_TIMINGR_SCLL | I2C_TIMINGR_SCLH \
...
{
  return (uint32_t)(READ_REG(p_i2c->TIMINGR));
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->TIMINGR, I2C_TIMINGR_PRESC) >> I2C_TIMINGR_PRESC_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->TIMINGR, I2C_TIMINGR_SCLL) >> I2C_TIMINGR_SCLL_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->TIMINGR, I2C_TIMINGR_SCLH) >> I2C_TIMINGR_SCLH_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->TIMINGR, I2C_TIMINGR_SDADEL) >> I2C_TIMINGR_SDADEL_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->TIMINGR, I2C_TIMINGR_SCLDEL) >> I2C_TIMINGR_SCLDEL_Pos);
}
...
{
  MODIFY_REG(p_i2c->CR1, I2C_CR1_SMBHEN | I2C_CR1_SMBDEN, peripheral_mode);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->CR1, I2C_CR1_SMBHEN | I2C_CR1_SMBDEN));
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_ALERTEN);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_ALERTEN);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_ALERTEN) == (I2C_CR1_ALERTEN)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_PECEN);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_PECEN);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_PECEN) == (I2C_CR1_PECEN)) ? 1UL : 0UL);
}
...
__STATIC_INLINE void LL_I2C_ConfigSMBusTimeout(I2C_TypeDef *p_i2c, uint32_t timeout_a, uint32_t timeout_a_mode,
                                               uint32_t timeout_b)
{
  MODIFY_REG(p_i2c->TIMEOUTR, I2C_TIMEOUTR_TIMEOUTA | I2C_TIMEOUTR_TIDLE | I2C_TIMEOUTR_TIMEOUTB,
...
{
  WRITE_REG(p_i2c->TIMEOUTR, timeout_a);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->TIMEOUTR, I2C_TIMEOUTR_TIMEOUTA));
}
...
{
  WRITE_REG(p_i2c->TIMEOUTR, timeout_a_mode);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->TIMEOUTR, I2C_TIMEOUTR_TIDLE));
}
...
{
  WRITE_REG(p_i2c->TIMEOUTR, timeout_b << I2C_TIMEOUTR_TIMEOUTB_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->TIMEOUTR, I2C_TIMEOUTR_TIMEOUTB) >> I2C_TIMEOUTR_TIMEOUTB_Pos);
}
...
{
  SET_BIT(p_i2c->TIMEOUTR, clock_timeout);
}
...
{
  CLEAR_BIT(p_i2c->TIMEOUTR, clock_timeout);
}
...
{
  return ((READ_BIT(p_i2c->TIMEOUTR, (I2C_TIMEOUTR_TIMOUTEN | I2C_TIMEOUTR_TEXTEN)) == \
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_TXIE);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_TXIE);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_TXIE) == (I2C_CR1_TXIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_RXIE);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_RXIE);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_RXIE) == (I2C_CR1_RXIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_ADDRIE);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_ADDRIE);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_ADDRIE) == (I2C_CR1_ADDRIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_NACKIE);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_NACKIE);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_NACKIE) == (I2C_CR1_NACKIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_STOPIE);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_STOPIE);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_STOPIE) == (I2C_CR1_STOPIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_TCIE);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_TCIE);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_TCIE) == (I2C_CR1_TCIE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR1, I2C_CR1_ERRIE);
}
...
{
  CLEAR_BIT(p_i2c->CR1, I2C_CR1_ERRIE);
}
...
{
  return ((READ_BIT(p_i2c->CR1, I2C_CR1_ERRIE) == (I2C_CR1_ERRIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->CR1, mask) == (mask)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, mask) == (mask)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_TXE) == (I2C_ISR_TXE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_TXIS) == (I2C_ISR_TXIS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_RXNE) == (I2C_ISR_RXNE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_ADDR) == (I2C_ISR_ADDR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_NACKF) == (I2C_ISR_NACKF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_STOPF) == (I2C_ISR_STOPF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_TC) == (I2C_ISR_TC)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_TCR) == (I2C_ISR_TCR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_BERR) == (I2C_ISR_BERR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_ARLO) == (I2C_ISR_ARLO)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_OVR) == (I2C_ISR_OVR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_PECERR) == (I2C_ISR_PECERR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_TIMEOUT) == (I2C_ISR_TIMEOUT)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_ALERT) == (I2C_ISR_ALERT)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_i2c->ISR, I2C_ISR_BUSY) == (I2C_ISR_BUSY)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->ICR, I2C_ICR_ADDRCF);
}
...
{
  SET_BIT(p_i2c->ICR, I2C_ICR_NACKCF);
}
...
{
  SET_BIT(p_i2c->ICR, I2C_ICR_STOPCF);
}
...
{
  WRITE_REG(p_i2c->ISR, I2C_ISR_TXE);
}
...
{
  SET_BIT(p_i2c->ICR, I2C_ICR_BERRCF);
}
...
{
  SET_BIT(p_i2c->ICR, I2C_ICR_ARLOCF);
}
...
{
  SET_BIT(p_i2c->ICR, I2C_ICR_OVRCF);
}
...
{
  SET_BIT(p_i2c->ICR, I2C_ICR_PECCF);
}
...
{
  SET_BIT(p_i2c->ICR, I2C_ICR_TIMOUTCF);
}
...
{
  SET_BIT(p_i2c->ICR, I2C_ICR_ALERTCF);
}
...
{
  SET_BIT(p_i2c->CR2, I2C_CR2_AUTOEND);
}
...
{
  CLEAR_BIT(p_i2c->CR2, I2C_CR2_AUTOEND);
}
...
{
  return ((READ_BIT(p_i2c->CR2, I2C_CR2_AUTOEND) == (I2C_CR2_AUTOEND)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_i2c->CR2, I2C_CR2_RELOAD);
}
...
{
  CLEAR_BIT(p_i2c->CR2, I2C_CR2_RELOAD);
}
...
{
  return ((READ_BIT(p_i2c->CR2, I2C_CR2_RELOAD) == (I2C_CR2_RELOAD)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_i2c->CR2, I2C_CR2_NBYTES, xfer_size << I2C_CR2_NBYTES_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->CR2, I2C_CR2_NBYTES) >> I2C_CR2_NBYTES_Pos);
}
...
{
  MODIFY_REG(p_i2c->CR2, I2C_CR2_NACK, type_acknowledge);
}
...
{
  SET_BIT(p_i2c->CR2, I2C_CR2_NACK);
}
...
{
  CLEAR_BIT(p_i2c->CR2, I2C_CR2_NACK);
}
...
{
  SET_BIT(p_i2c->CR2, I2C_CR2_START);
}
...
{
  SET_BIT(p_i2c->CR2, I2C_CR2_STOP);
}
...
{
  CLEAR_BIT(p_i2c->CR2, I2C_CR2_HEAD10R);
}
...
{
  SET_BIT(p_i2c->CR2, I2C_CR2_HEAD10R);
}
...
{
  return ((READ_BIT(p_i2c->CR2, I2C_CR2_HEAD10R) != (I2C_CR2_HEAD10R)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_i2c->CR2, I2C_CR2_RD_WRN, xfer_request);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->CR2, I2C_CR2_RD_WRN));
}
...
{
  MODIFY_REG(p_i2c->CR2, I2C_CR2_SADD, slave_addr);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->CR2, I2C_CR2_SADD));
}
...
{
  MODIFY_REG(p_i2c->CR2, I2C_CR2_SADD | I2C_CR2_ADD10 |
...
{
  return (uint32_t)(READ_BIT(p_i2c->ISR, I2C_ISR_DIR));
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->ISR, I2C_ISR_ADDCODE) >> I2C_ISR_ADDCODE_Pos << 1);
}
...
{
  SET_BIT(p_i2c->CR2, I2C_CR2_PECBYTE);
}
...
{
  return ((READ_BIT(p_i2c->CR2, I2C_CR2_PECBYTE) == (I2C_CR2_PECBYTE)) ? 1UL : 0UL);
}
...
{
  return (uint32_t)(READ_BIT(p_i2c->PECR, I2C_PECR_PEC));
}
...
{
  return (uint8_t)(READ_REG(p_i2c->RXDR));
}
