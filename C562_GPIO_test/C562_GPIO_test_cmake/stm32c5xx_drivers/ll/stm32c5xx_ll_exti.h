...
{
  ATOMIC_SET_BIT(EXTI->IMR2, exti_line);
}
...
{
  ATOMIC_CLEAR_BIT(EXTI->IMR2, exti_line);
}
...
{
  return ((READ_BIT(EXTI->IMR2, exti_line) == (exti_line)) ? 1U : 0U);
}
...
{
  ATOMIC_SET_BIT(EXTI->EMR2, exti_line);
}
...
{
  ATOMIC_CLEAR_BIT(EXTI->EMR2, exti_line);
}
...
{
  return ((READ_BIT(EXTI->EMR2, exti_line) == (exti_line)) ? 1U : 0U);
}
...
{
  ATOMIC_SET_BIT(EXTI->RTSR2, exti_line);
}
...
{
  ATOMIC_CLEAR_BIT(EXTI->RTSR2, exti_line);
}
...
{
  return ((READ_BIT(EXTI->RTSR2, exti_line) == (exti_line)) ? 1U : 0U);
}
...
{
  ATOMIC_SET_BIT(EXTI->FTSR2, exti_line);
}
...
{
  ATOMIC_CLEAR_BIT(EXTI->FTSR2, exti_line);
}
...
{
  return ((READ_BIT(EXTI->FTSR2, exti_line) == (exti_line)) ? 1U : 0U);
}
...
{
  ATOMIC_SET_BIT(EXTI->SWIER2, exti_line);
}
...
{
  return ((READ_BIT(EXTI->RPR2, exti_line) == (exti_line)) ? 1UL : 0UL);
}
...
{
  return (uint32_t)(READ_BIT(EXTI->RPR2, exti_line));
}
...
{
  return ((READ_BIT(EXTI->FPR2, exti_line) == (exti_line)) ? 1UL : 0UL);
}
...
{
  return (uint32_t)(READ_BIT(EXTI->FPR2, exti_line));
}
...
__STATIC_INLINE void LL_EXTI_SetEXTISource(uint32_t port, uint32_t line)
{
  ...
  ATOMIC_MODIFYB_REG(*(volatile uint8_t *)reg_addr, 0xFU, port);
}
...
/**
  * @brief  Enable EXTI Line Privilege attribute for Lines in range 32 to 63
  * @rmtoll
  *  PRIVCFGR2    PRIVx         LL_EXTI_EnablePrivilege_32_63
  * @param  exti_line This parameter can be one of the following values:
  *         @arg @ref LL_EXTI_LINE_32
  *         @arg @ref LL_EXTI_LINE_33
  *         @arg @ref LL_EXTI_LINE_34
  ...
  * @note   (*)Please check each device line mapping for EXTI Line availability
  */
__STATIC_INLINE void LL_EXTI_EnablePrivilege_32_63(uint32_t exti_line)
{
  ATOMIC_SET_BIT(EXTI->PRIVCFGR2, exti_line);
}
...
/**
  * @brief  Disable EXTI Line Privilege attribute for Lines in range 32 to 63
  * @rmtoll
  *  PRIVCFGR2    PRIVx         LL_EXTI_DisablePrivilege_32_63
  * @param  exti_line This parameter can be one of the following values:
  *         @arg @ref LL_EXTI_LINE_32
  *         @arg @ref LL_EXTI_LINE_33
  *         @arg @ref LL_EXTI_LINE_34
  ...
  * @note   (*)Please check each device line mapping for EXTI Line availability
  */
__STATIC_INLINE void LL_EXTI_DisablePrivilege_32_63(uint32_t exti_line)
{
  ATOMIC_CLEAR_BIT(EXTI->PRIVCFGR2, exti_line);
}
...
/**
  * @brief  Indicate if EXTI Line Privilege attribute is enabled for Lines in range 32 to 63
  * @rmtoll
  *  PRIVCFGR2    PRIVx         LL_EXTI_IsEnabledPrivilege_32_63
  * @param  exti_line This parameter can be one of the following values:
  *         @arg @ref LL_EXTI_LINE_32
  *         @arg @ref LL_EXTI_LINE_33
  *         @arg @ref LL_EXTI_LINE_34
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_EXTI_IsEnabledPrivilege_32_63(uint32_t exti_line)
{
  return ((READ_BIT(EXTI->PRIVCFGR2, exti_line) == (exti_line)) ? 1UL : 0UL);
}
