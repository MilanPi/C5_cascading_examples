...
#define LL_PKA_FLAG_INCRERRF  PKA_SR_INCRERRF                               /*!<  Increment error fla               */
#define LL_PKA_FLAG_DATAOKF   PKA_SR_DATAOKF                                /*!<  Data OK flag                      */
#define LL_PKA_FLAG_RNGOKF    PKA_SR_RNGOKF                                 /*!<  Data OK flag                      */
...
#define LL_PKA_FLAG_ALL       (PKA_SR_CMF | PKA_SR_ADDRERRF \
                               | PKA_SR_RAMERRF | PKA_SR_PROCENDF \
                               | PKA_SR_OPERRF)                             /*!< All flags                          */
#define LL_PKA_FLAG_ERROR_ALL (PKA_SR_CMF | PKA_SR_ADDRERRF  \
                               | PKA_SR_RAMERRF | PKA_SR_OPERRF)            /*!< All error flags                    */
/**
  * @}
  */
...
{
  SET_BIT(pkax->CLRFR, PKA_CLRFR_CMFC);
}
/**
