/**
  ...
  * @author  MDG-GPM application team
...
static const uint32_t LL_ADC_CHANNEL_LUT[] =
{
  ...
  (LL_ADC_CHANNEL_8_SMP   | LL_ADC_CHANNEL_8_BITFIELD),     /*!< ADC channel ADCx_IN9  */
  (LL_ADC_CHANNEL_9_SMP   | LL_ADC_CHANNEL_9_BITFIELD),     /*!< ADC channel ADCx_IN8  */
...
#define LL_ADC_VREFINT_CAL_ADDR         ((const uint16_t*) (0x08FFF810UL)) /* Internal voltage reference, address of
                                        ...
                                        Vref+ = LL_ADC_VREFINT_CAL_VREF (tolerance: +-10 mV). */
...
#define LL_ADC_TEMPSENSOR_CAL1_ADDR     ((const uint16_t*) (0x08FFF814UL)) /* Internal temperature sensor, address of
                                        ...
                                        Vref+ = LL_ADC_TEMPSENSOR_CAL_VREFANALOG (tolerance: +-10 mV). */
...
#define LL_ADC_TEMPSENSOR_CAL_VREFANALOG (3000UL)                    /* Analog voltage reference (Vref+) value
...
#if defined(ADC_MULTIMODE_SUPPORT)
#define LL_ADC_DMA_REG_REGULAR_DATA_MULTI LL_ADC_DMA_REG_MM_REGULAR_PACK_DATA /* Legacy definition */
#endif /* ADC_MULTIMODE_SUPPORT */
/**
  * @}
  */
...
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11 (LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: external interrupt line 11 event */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH1    (ADC_CFGR1_EXTSEL_0 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: TIM1 channel 1 event (capture compare) */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH2    (ADC_CFGR1_EXTSEL_1 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
...
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO   (ADC_CFGR1_EXTSEL_3 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: TIM3 TRGO event */
#define LL_ADC_REG_TRIG_EXT_TIM4_TRGO   (ADC_CFGR1_EXTSEL_3 | ADC_CFGR1_EXTSEL_0 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: TIM4 TRGO event */
#endif /* STM32C591xx, STM32C593xx, STM32C5A3xx */
#define LL_ADC_REG_TRIG_EXT_TIM5_CH4    (ADC_CFGR1_EXTSEL_3 | ADC_CFGR1_EXTSEL_1 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: TIM5 channel 4 event (capture compare) */
#define LL_ADC_REG_TRIG_EXT_TIM5_TRGO   (ADC_CFGR1_EXTSEL_3 | ADC_CFGR1_EXTSEL_1 | ADC_CFGR1_EXTSEL_0 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
...
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO   (ADC_CFGR1_EXTSEL_3 | ADC_CFGR1_EXTSEL_2 | ADC_CFGR1_EXTSEL_0 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: TIM8 TRGO event */
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO2  (ADC_CFGR1_EXTSEL_3 | ADC_CFGR1_EXTSEL_2 | ADC_CFGR1_EXTSEL_1 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: TIM8 TRGO2 event */
#define LL_ADC_REG_TRIG_EXT_TIM15_TRGO  (ADC_CFGR1_EXTSEL_3 | ADC_CFGR1_EXTSEL_2 \
                                         | ADC_CFGR1_EXTSEL_1 | ADC_CFGR1_EXTSEL_0 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: TIM15 TRGO event */
#define LL_ADC_REG_TRIG_EXT_LPTIM1_CH1  (ADC_CFGR1_EXTSEL_4 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: LPTIM1 channel 1 event */
#if defined(STM32C591xx) || defined(STM32C593xx) || defined(STM32C5A3xx)
#define LL_ADC_REG_TRIG_EXT_TIM3_CH4    (ADC_CFGR1_EXTSEL_4 | ADC_CFGR1_EXTSEL_0 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: TIM3 channel 4 event */
#define LL_ADC_REG_TRIG_EXT_TIM4_CH4    (ADC_CFGR1_EXTSEL_4 | ADC_CFGR1_EXTSEL_1 \
                                         | LL_ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion
                                        trigger from periph: TIM4 channel 4 event */
#endif /* STM32C591xx, STM32C593xx, STM32C5A3xx */
/**
  * @}
  */
...
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15 (LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: external interrupt line 15 event */
#define LL_ADC_INJ_TRIG_EXT_TIM1_CH4    (ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM1 channel 4 event (capture compare) */
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO   (ADC_JSQR_JEXTSEL_1 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM1 TRGO event */
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO2  (ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM1 TRGO2 event */
#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1    (ADC_JSQR_JEXTSEL_2 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM2 channel 1 event (capture compare) */
#define LL_ADC_INJ_TRIG_EXT_TIM2_TRGO   (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM2 TRGO event */
#if defined(STM32C591xx) || defined(STM32C593xx) || defined(STM32C5A3xx)
#define LL_ADC_INJ_TRIG_EXT_TIM3_TRGO   (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM3 TRGO event */
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO   (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 \
                                         | ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM4 TRGO event */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH3    (ADC_JSQR_JEXTSEL_3 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM3 channel 3 event */
#endif /* STM32C591xx, STM32C593xx, STM32C5A3xx */
#define LL_ADC_INJ_TRIG_EXT_TIM5_CH1    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM5 channel 1 event (capture compare) */
#define LL_ADC_INJ_TRIG_EXT_TIM5_CH2    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 \
                                         | ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM5 channel 2 event (capture compare) */
#define LL_ADC_INJ_TRIG_EXT_TIM5_CH3    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM5 channel 3 event (capture compare) */
#define LL_ADC_INJ_TRIG_EXT_TIM5_TRGO   (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 \
                                         | ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM15 TRGO event */
#define LL_ADC_INJ_TRIG_EXT_TIM7_TRGO   (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 \
                                         | ADC_JSQR_JEXTSEL_1 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM7 TRGO event */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 \
                                         | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM8 channel 4 event (capture compare) */
#define LL_ADC_INJ_TRIG_EXT_TIM8_TRGO   (ADC_JSQR_JEXTSEL_4 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM8 TRGO event */
#define LL_ADC_INJ_TRIG_EXT_TIM8_TRGO2  (ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM8 TRGO2 event */
#define LL_ADC_INJ_TRIG_EXT_TIM12_TRGO  (ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_1 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM12 TRGO event */
#define LL_ADC_INJ_TRIG_EXT_TIM15_TRGO  (ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_1 \
                                         | ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM15 TRGO event */
#define LL_ADC_INJ_TRIG_EXT_LPTIM1_CH1  (ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_2 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: LPTIM1 channel 1 event */
#if defined(STM32C591xx) || defined(STM32C593xx) || defined(STM32C5A3xx)
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH1    (ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_2 \
                                         | ADC_JSQR_JEXTSEL_0 \
                                         | LL_ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion
                                        trigger from periph: TIM3 channel 1 event (capture compare) */
#endif /* STM32C591xx, STM32C593xx, STM32C5A3xx */
/**
  * @}
  */
...
#define LL_ADC_SAMPLINGTIME_4CYCLES_5   (ADC_SMPR2_SMP10_0)    /*!< Sampling time 4.5 ADC clock cycles */
...
#define LL_ADC_SAMPLINGTIME_12CYCLES_5  (ADC_SMPR2_SMP10_1 \
                                         | ADC_SMPR2_SMP10_0)  /*!< Sampling time 12.5 ADC clock cycles */
...
#define LL_ADC_SAMPLINGTIME_47CYCLES_5  (ADC_SMPR2_SMP10_2 \
                                         | ADC_SMPR2_SMP10_0)  /*!< Sampling time 47.5 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_138CYCLES_5 (ADC_SMPR2_SMP10_2 \
                                         | ADC_SMPR2_SMP10_1)  /*!< Sampling time 138.5 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_288CYCLES_5 (ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_1 \
                                         | ADC_SMPR2_SMP10_0) /*!< Sampling time 288.5 ADC clock cycles */
/**
  * @}
  */
...
#define LL_ADC_MULTI_TWOSMP_DELAY_2CYCLES (ADCC_CCR_DELAY_0) /*!< ADC multimode delay between
                                        two sampling phases: 2 ADC clock cycles for all resolutions */
#define LL_ADC_MULTI_TWOSMP_DELAY_3CYCLES (ADCC_CCR_DELAY_1) /*!< ADC multimode delay between
                                        two sampling phases: 3 ADC clock cycles for all resolutions */
#define LL_ADC_MULTI_TWOSMP_DELAY_4CYCLES (ADCC_CCR_DELAY_1 | ADCC_CCR_DELAY_0) /*!< ADC multimode delay between
                                        two sampling phases: 4 ADC clock cycles for all resolutions */
#define LL_ADC_MULTI_TWOSMP_DELAY_5CYCLES (ADCC_CCR_DELAY_2) /*!< ADC multimode delay between
                                        two sampling phases: 5 ADC clock cycles for all resolutions */
#define LL_ADC_MULTI_TWOSMP_DELAY_6CYCLES (ADCC_CCR_DELAY_2 | ADCC_CCR_DELAY_0) /*!< ADC multimode delay between
                                        two sampling phases: 6 ADC clock cycles for all resolutions */
#define LL_ADC_MULTI_TWOSMP_DELAY_7CYCLES (ADCC_CCR_DELAY_2 | ADCC_CCR_DELAY_1) /*!< ADC multimode delay between
...
#define LL_ADC_MULTI_TWOSMP_DELAY_8CYCLES (ADCC_CCR_DELAY_2 | ADCC_CCR_DELAY_1 \
                                           | ADCC_CCR_DELAY_0) /*!< ADC multimode delay between
                                        two sampling phases: 8 ADC clock cycles for all resolutions */
#define LL_ADC_MULTI_TWOSMP_DELAY_9CYCLES (ADCC_CCR_DELAY_3) /*!< ADC multimode delay between
                                        two sampling phases: 9 ADC clock cycles for all resolutions */
#define LL_ADC_MULTI_TWOSMP_DELAY_10CYCLES (ADCC_CCR_DELAY_3 | ADCC_CCR_DELAY_0) /*!< ADC multimode delay between
                                        two sampling phases: 10 ADC clock cycles for all resolutions */
#define LL_ADC_MULTI_TWOSMP_DELAY_11CYCLES (ADCC_CCR_DELAY_3 | ADCC_CCR_DELAY_1) /*!< ADC multimode delay between
...
#define LL_ADC_MULTI_TWOSMP_DELAY_13CYCLES (ADCC_CCR_DELAY_3 | ADCC_CCR_DELAY_2) /*!< ADC multimode delay between
                                        two sampling phases: 13 ADC clock cycles for all resolutions */
#define LL_ADC_MULTI_TWOSMP_DELAY_14CYCLES (ADCC_CCR_DELAY_3 | ADCC_CCR_DELAY_2 \
                                            | ADCC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling
                                        phases: 14 ADC clock cycles for resolutions 14, 12, 10 bit */
#define LL_ADC_MULTI_TWOSMP_DELAY_15CYCLES (ADCC_CCR_DELAY_3 | ADCC_CCR_DELAY_2 \
                                            | ADCC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling
                                        phases: 15 ADC clock cycles for resolutions 14, 12, 10 bit */
#define LL_ADC_MULTI_TWOSMP_DELAY_16CYCLES (ADCC_CCR_DELAY_3 | ADCC_CCR_DELAY_2 | ADCC_CCR_DELAY_1 \
                                            | ADCC_CCR_DELAY_0) /*!< ADC multimode delay between
                                        two sampling phases: 16 ADC clock cycles for resolutions 14, 12 bit*/
#define LL_ADC_MULTI_TWOSMP_DELAY_13CYCLES_8_BITS  (ADCC_CCR_DELAY_3 | ADCC_CCR_DELAY_2 | ADCC_CCR_DELAY_1 \
                                                    | ADCC_CCR_DELAY_0) /*!< ADC multimode delay between
                                        two sampling phases: 13 ADC clock cycles for resolution 8 bit */
#define LL_ADC_MULTI_TWOSMP_DELAY_15CYCLES_10_BITS (ADCC_CCR_DELAY_3 | ADCC_CCR_DELAY_2 | ADCC_CCR_DELAY_1 \
                                                    | ADCC_CCR_DELAY_0) /*!< ADC multimode delay between
...
/**
  ...
  * @note   To be used with function LL_ADC_SetOffset().
  *         Example, with a ADC resolution of 8 bits, to set the value of
  *         analog watchdog threshold high (on 8 bits):
  *           LL_ADC_SetOffset
  *            (< ADCx param >,
...
/**
  ...
  * @note   To be used with function LL_ADC_SetCalibrationOffsetFactor().
...
((((int32_t)(data)) * (int32_t)64L) \
 / (int32_t)(1UL << (2U * ((3U + ((adc_res_target) >> ADC_CFGR1_RES_Pos)) - ((adc_res_current) >> ADC_CFGR1_RES_Pos)))))
                                                ...
                                                uint32_t resolution)
{
  ...
  else
  {
    ...
    data_res = LL_ADC_CONVERT_DATA_RESOLUTION(tempsensor_conv_data, resolution, LL_ADC_RESOLUTION_12B);

    /* Scale ADC conversion data to reference voltage corresponding to temperature sensor calibration parameters */
    data_res = ((data_res * vref_analog_voltage) / LL_ADC_TEMPSENSOR_CAL_VREFANALOG);
...
{
  SET_BIT(p_adc_common->CCR, path_internal & LL_ADC_COMMON_PATH_INTERNAL_MASK);
}
...
{
  CLEAR_BIT(p_adc_common->CCR, path_internal & LL_ADC_COMMON_PATH_INTERNAL_MASK);
}
...
{
  return (uint32_t)(READ_BIT(p_adc_common->CCR, LL_ADC_COMMON_PATH_INTERNAL_MASK));
}
...
__STATIC_INLINE void LL_ADC_SetCalibrationFactor(ADC_TypeDef *p_adc, uint32_t input_mode, uint32_t calibration_factor)
{
  ...
  MODIFY_REG(p_adc->CALFACT, ADC_CALFACT_CALFACT, calibration_factor);
}
...
__STATIC_INLINE uint32_t LL_ADC_GetCalibrationFactor(const ADC_TypeDef *p_adc, uint32_t input_mode)
{
  ...
  return (uint32_t)(READ_BIT(p_adc->CALFACT, ADC_CALFACT_CALFACT));
}
...
{
  MODIFY_REG(p_adc->CFGR1, ADC_CFGR1_RES, resolution);
}
...
{
  return (uint32_t)(READ_BIT(p_adc->CFGR1, ADC_CFGR1_RES));
}
...
/**
  ...
  *         on either groups regular or injected.
  * @rmtoll
  *  CFGR1    AUTDLY         LL_ADC_SetLPModeAutoWait
  * @param  p_adc Pointer to ADC instance
...
__STATIC_INLINE uint32_t LL_ADC_GetGainCompensation(const ADC_TypeDef *p_adc)
{
  return ((READ_BIT(p_adc->GCOMP, ADC_GCOMP_GCOMP) == ADC_GCOMP_GCOMP) \
          ? READ_BIT(p_adc->GCOMP, ADC_GCOMP_GCOMPCOEFF) : 4096UL);
}
...
/**
  ...
  * @endif
  *         @arg @ref LL_ADC_REG_TRIG_EXT_TIM5_CH4
  * @if TIM4
...
{
  __IO uint32_t channel_preselection = READ_REG(p_adc->PCSEL);
  WRITE_REG(p_adc->PCSEL,
...
/**
  ...
  *
  * @note   User helper macro @ref LL_ADC_DECIMAL_NB_TO_CHANNEL().
  */
...
/**
  ...
  *         @arg @ref LL_ADC_INJ_TRIG_EXT_TIM5_CH1
  *         @arg @ref LL_ADC_INJ_TRIG_EXT_TIM5_CH2
  *         @arg @ref LL_ADC_INJ_TRIG_EXT_TIM5_CH3
  * @if TIM3
...
/**
  ...
  *         @arg @ref LL_ADC_SAMPLINGTIME_138CYCLES_5
  *         @arg @ref LL_ADC_SAMPLINGTIME_288CYCLES_5
  */
...
/**
  ...
  *         on either groups regular or injected.
  * @rmtoll
  *  AWD2CR   AWD2CH         LL_ADC_SetAnalogWDChannelAdd \n
  *  AWD3CR   AWD3CH         LL_ADC_SetAnalogWDChannelAdd
  * @param  p_adc Pointer to ADC instance
  * @param  awd_y AWD instance. This parameter can be one of the following values:
  *         @arg @ref LL_ADC_AWD_2
  *         @arg @ref LL_ADC_AWD_3
...
__STATIC_INLINE void LL_ADC_SetAnalogWDChannelAdd(ADC_TypeDef *p_adc, uint32_t awd_y, uint32_t channel)
{
  ...
  else
  {
    ...
    SET_BIT(*preg, awd_group_channel_monitored);
  }
}
...
/**
  ...
  *         on either groups regular or injected.
  * @rmtoll
  *  AWD2CR   AWD2CH         LL_ADC_SetAnalogWDChannelRem \n
  *  AWD3CR   AWD3CH         LL_ADC_SetAnalogWDChannelRem
  * @param  p_adc Pointer to ADC instance
  * @param  awd_y AWD instance. This parameter can be one of the following values:
  *         @arg @ref LL_ADC_AWD_2
  *         @arg @ref LL_ADC_AWD_3
...
__STATIC_INLINE void LL_ADC_SetAnalogWDChannelRem(ADC_TypeDef *p_adc, uint32_t awd_y, uint32_t channel)
{
  ...
  else
  {
    ...
    CLEAR_BIT(*preg, awd_group_channel_monitored);
  }
}
...
__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDScopeChannel(const ADC_TypeDef *p_adc, uint32_t awd_y)
{
  ...
  {
    if ((awd_channel_monitored & ADC_AWD2CR_AWD2CH) == 0UL)
    {
      awd_channel_monitored = LL_ADC_CHANNEL_NONE;
    }
    else if ((awd_channel_monitored & ADC_AWD2CR_AWD2CH) == ADC_AWD2CR_AWD2CH)
    {
      /* Case all channels */
      awd_channel_monitored = LL_ADC_CHANNEL_ALL;
    }
    else
    {
      ...
      awd_channel_monitored = POSITION_VAL(awd_channel_monitored);
    }
  }
...
/**
  ...
  *  AWD2CR   AWD2CH         LL_ADC_IsAnalogWDChannelMonitored \n
  *  AWD3CR   AWD3CH         LL_ADC_IsAnalogWDChannelMonitored
  * @param  p_adc Pointer to ADC instance
  * @param  awd_y AWD instance. This parameter can be one of the following values:
  *         @arg @ref LL_ADC_AWD_1
  *         @arg @ref LL_ADC_AWD_2
...
__STATIC_INLINE uint32_t LL_ADC_IsAnalogWDChannelMonitored(ADC_TypeDef *p_adc, uint32_t awd_y, uint32_t channel)
{
  ...
  awd_channel_monitored = READ_BIT(*preg, awd_y);
  ...
  else
  {
    ...
    {
      is_monitored = ((awd_channel_monitored & ADC_AWD2CR_AWD2CH) == ADC_AWD2CR_AWD2CH) ? 1UL : 0UL;
    }
    else
    {
                                                  ...
                                                  int32_t awd_threshold_value)
{
  ...
  MODIFY_REG(*preg, ADC_AWD1LTR_LTR, ((uint32_t)awd_threshold_value & ADC_AWD1LTR_LTR));
}
                                                     ...
                                                     uint32_t awd_y, uint32_t awd_thresholds_high_low)
{
  ...
  threshold_raw = READ_BIT(*preg, ADC_AWD1LTR_LTR);
                                                     ...
                                                     uint32_t awd_threshold_low_value)
{
  ...
  MODIFY_REG(*preg,  ADC_AWD1LTR_LTR, awd_threshold_low_value);
  MODIFY_REG(*preg2, ADC_AWD1HTR_HTR, awd_threshold_high_value);
}
...
/**
  ...
  * @rmtoll
  *  AWD1HTR  AWDFILT        LL_ADC_SetAWDFilteringConfiguration
  * @param  p_adc Pointer to ADC instance
  * @param  awd_y AWD instance. This parameter can be one of the following values:
  *         @arg @ref LL_ADC_AWD_1
...
__STATIC_INLINE void LL_ADC_SetAnalogWDFiltering(ADC_TypeDef *p_adc, uint32_t awd_y, uint32_t awd_filtering)
{
  /* Prevent unused argument(s) compilation warning */
  (void)(awd_y);
  MODIFY_REG(p_adc->AWD1HTR, ADC_AWD1HTR_AWDFILT, awd_filtering);
}
...
__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDFiltering(const ADC_TypeDef *p_adc, uint32_t awd_y)
{
  /* Prevent unused argument(s) compilation warning */
  (void)(awd_y);
  return (uint32_t)(READ_BIT(p_adc->AWD1HTR,  ADC_AWD1HTR_AWDFILT));
}
...
__STATIC_INLINE uint32_t LL_ADC_GetOffsetChannel(const ADC_TypeDef *p_adc, uint32_t offset_y)
{
  ...
  return (uint32_t) LL_ADC_DECIMAL_NB_TO_CHANNEL(READ_BIT(*preg, ADC_OFCFGR_OFFSET_CH) >> ADC_OFCFGR_OFFSET_CH_Pos);
}
...
__STATIC_INLINE uint32_t LL_ADC_GetOffsetLevel(const ADC_TypeDef *p_adc, uint32_t offset_y)
{
  ...
  return (uint32_t) READ_BIT(*preg, ADC_OFR_OFFSET);
}
...
__STATIC_INLINE void LL_ADC_SetOffsetSign(ADC_TypeDef *p_adc, uint32_t offset_y, uint32_t offset_sign)
{
  ...
  MODIFY_REG(*preg, ADC_OFCFGR_POSOFF, offset_sign);
}
...
__STATIC_INLINE uint32_t LL_ADC_GetOffsetSign(const ADC_TypeDef *p_adc, uint32_t offset_y)
{
  ...
  return (uint32_t) READ_BIT(*preg, ADC_OFCFGR_POSOFF);
}
...
{
  __IO uint32_t *preg = LL_ADC_PTR_REG_OFFSET(p_adc->OFCFGR[0], offset_y);
  MODIFY_REG(*preg, ADC_OFCFGR_SSAT, offset_signed_saturation);
}
...
{
  const __IO uint32_t *preg = LL_ADC_PTR_REG_OFFSET(p_adc->OFCFGR[0], offset_y);
  return (uint32_t) READ_BIT(*preg, ADC_OFCFGR_SSAT);
}
...
{
  __IO uint32_t *preg = LL_ADC_PTR_REG_OFFSET(p_adc->OFCFGR[0], offset_y);
  MODIFY_REG(*preg, ADC_OFCFGR_USAT, offset_unsigned_saturation);
}
...
{
  const __IO uint32_t *preg = LL_ADC_PTR_REG_OFFSET(p_adc->OFCFGR[0], offset_y);
  return (uint32_t) READ_BIT(*preg, ADC_OFCFGR_USAT);
}
...
{
  MODIFY_REG(p_adc_common->CCR, ADCC_CCR_DUAL, Multimode);
}
...
{
  return (uint32_t)(READ_BIT(p_adc_common->CCR, ADCC_CCR_DUAL));
}
...
{
  MODIFY_REG(p_adc_common->CCR, ADCC_CCR_DAMDF, MultiDMATransfer);
}
...
{
  return (uint32_t)(READ_BIT(p_adc_common->CCR, ADCC_CCR_DAMDF));
}
...
{
  MODIFY_REG(p_adc_common->CCR, ADCC_CCR_DELAY, MultiTwoSamplingDelay);
}
...
{
  return (uint32_t)(READ_BIT(p_adc_common->CCR, ADCC_CCR_DELAY));
}
#endif /* ADC_MULTIMODE_SUPPORT */
...
__STATIC_INLINE int32_t LL_ADC_INJ_ReadConversionData(const ADC_TypeDef *p_adc, uint32_t rank)
{
  ...
  return (int32_t)((uint32_t)READ_BIT(*preg, ADC_JDR_JDATA));
}
...
__STATIC_INLINE uint32_t LL_ADC_INJ_ReadConversionData32(const ADC_TypeDef *p_adc, uint32_t rank)
{
  ...
  return (uint32_t)READ_BIT(*preg, ADC_JDR_JDATA);
}
...
__STATIC_INLINE uint16_t LL_ADC_INJ_ReadConversionData12(const ADC_TypeDef *p_adc, uint32_t rank)
{
  ...
  return (uint16_t)READ_BIT(*preg, ADC_JDR_JDATA);
}
...
__STATIC_INLINE uint8_t LL_ADC_INJ_ReadConversionData8(const ADC_TypeDef *p_adc, uint32_t rank)
{
  ...
  return (uint8_t)READ_BIT(*preg, ADC_JDR_JDATA);
}
