...
/** @defgroup USART_LL_EC_PHASE Clock Phase
  * @{
  */
#define LL_USART_PHASE_1_EDGE             0x00000000U                     /*!< The first clock transition is the first data capture edge */
#define LL_USART_PHASE_2_EDGE             USART_CR2_CPHA                  /*!< The second clock transition is the first data capture edge */
/**
  * @}
  */
...
#define LL_USART_AUTO_BAUD_DETECT_ON_FALLING_EDGE  USART_CR2_ABRMODE_0                         /*!< Falling edge to falling edge measurement. Received frame must start with a single bit = 1 -> Frame = Start10xxxxxx */
#define LL_USART_AUTO_BAUD_DETECT_ON_0X7F_FRAME    USART_CR2_ABRMODE_1                         /*!< 0x7F frame detection */
#define LL_USART_AUTO_BAUD_DETECT_ON_0X55_FRAME    (USART_CR2_ABRMODE_1 | USART_CR2_ABRMODE_0) /*!< 0x55 frame detection */
/**
  * @}
  */
...
/**
  ...
  */
#define LL_USART_WRITE_REG(instance, reg, value) WRITE_REG((instance)->reg, (value))
...
/**
  ...
  */
#define LL_USART_READ_REG(instance, reg) READ_REG((instance)->reg)
/**
  * @}
  */
...
{
  SET_BIT(p_usart->CR1, USART_CR1_UE);
}
...
{
  CLEAR_BIT(p_usart->CR1, USART_CR1_UE);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_UE) == (USART_CR1_UE)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_usart->CR1, USART_CR1_FIFOEN);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_FIFOEN) == (USART_CR1_FIFOEN)) ? 1UL : 0UL);
}
...
{
  ATOMIC_MODIFY_REG(p_usart->CR3, USART_CR3_TXFTCFG, threshold << USART_CR3_TXFTCFG_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR3, USART_CR3_TXFTCFG) >> USART_CR3_TXFTCFG_Pos);
}
...
{
  ATOMIC_MODIFY_REG(p_usart->CR3, USART_CR3_RXFTCFG, threshold << USART_CR3_RXFTCFG_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR3, USART_CR3_RXFTCFG) >> USART_CR3_RXFTCFG_Pos);
}
...
{
  ATOMIC_MODIFY_REG(p_usart->CR3, USART_CR3_TXFTCFG | USART_CR3_RXFTCFG, (tx_threshold << USART_CR3_TXFTCFG_Pos) |
                    (rx_threshold << USART_CR3_RXFTCFG_Pos));
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_UESM);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_UESM);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_UESM) == (USART_CR1_UESM)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR1, (USART_CR1_M0 | USART_CR1_M1 | USART_CR1_PCE | USART_CR1_PS | USART_CR1_TE
                            | USART_CR1_RE | USART_CR1_OVER8), cr1_config);

  MODIFY_REG(p_usart->CR2, (USART_CR2_STOP_0 | USART_CR2_STOP_1 | USART_CR2_CPOL | USART_CR2_LBCL | USART_CR2_CPHA),
             cr2_config);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_RE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_RE);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR1, USART_CR1_RE) == (USART_CR1_RE));
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_TE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_TE);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR1, USART_CR1_TE) == (USART_CR1_TE));
}
...
{
  ATOMIC_MODIFY_REG(p_usart->CR1, USART_CR1_RE | USART_CR1_TE, transfer_direction);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR1, USART_CR1_RE | USART_CR1_TE));
}
...
{
  MODIFY_REG(p_usart->CR1, USART_CR1_PS | USART_CR1_PCE, parity);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR1, USART_CR1_PS | USART_CR1_PCE));
}
...
{
  MODIFY_REG(p_usart->CR1, USART_CR1_WAKE, method);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR1, USART_CR1_WAKE));
}
...
{
  MODIFY_REG(p_usart->CR1, USART_CR1_M, data_width);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR1, USART_CR1_M));
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_MME);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_MME);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_MME) == (USART_CR1_MME)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR1, USART_CR1_OVER8, over_sampling);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR1, USART_CR1_OVER8));
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_LBCL, last_bit_clock_pulse);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_LBCL));
}
...
/**
  ...
  *         @arg @ref LL_USART_PHASE_1_EDGE
  *         @arg @ref LL_USART_PHASE_2_EDGE
  * @note   Macro IS_USART_INSTANCE(p_usart) can be used to check whether or not
  *         Synchronous mode is supported by the p_usart instance.
  */
__STATIC_INLINE void LL_USART_SetClockPhase(USART_TypeDef *p_usart, uint32_t clock_phase)
{
  MODIFY_REG(p_usart->CR2, USART_CR2_CPHA, clock_phase);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_CPHA));
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_CPOL, clock_polarity);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_CPOL));
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_CPHA | USART_CR2_CPOL | USART_CR2_LBCL, phase | polarity | lbcp_output);
}
...
{
  MODIFY_REG(p_usart->PRESC, USART_PRESC_PRESCALER, (uint16_t)prescaler_value);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->PRESC, USART_PRESC_PRESCALER));
}
...
{
  SET_BIT(p_usart->CR2, USART_CR2_CLKEN);
}
...
{
  CLEAR_BIT(p_usart->CR2, USART_CR2_CLKEN);
}
...
{
  return ((READ_BIT(p_usart->CR2, USART_CR2_CLKEN) == (USART_CR2_CLKEN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_STOP, stop_bits);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_STOP));
}
...
__STATIC_INLINE void LL_USART_ConfigCharacter(USART_TypeDef *p_usart, uint32_t data_width, uint32_t parity,
                                              uint32_t stop_bits)
{
  MODIFY_REG(p_usart->CR1, USART_CR1_PS | USART_CR1_PCE | USART_CR1_M, parity | data_width);
  MODIFY_REG(p_usart->CR2, USART_CR2_STOP, stop_bits);
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_SWAP, swap_config);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_SWAP));
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_RXINV, pin_inv_method);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_RXINV));
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_TXINV, pin_inv_method);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_TXINV));
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_DATAINV, data_logic);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_DATAINV));
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_MSBFIRST, bit_order);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_MSBFIRST));
}
...
{
  SET_BIT(p_usart->CR2, USART_CR2_ABREN);
}
...
{
  CLEAR_BIT(p_usart->CR2, USART_CR2_ABREN);
}
...
{
  return ((READ_BIT(p_usart->CR2, USART_CR2_ABREN) == (USART_CR2_ABREN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_ABRMODE, auto_baud_rate_mode);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_ABRMODE));
}
...
{
  SET_BIT(p_usart->CR2, USART_CR2_RTOEN);
}
...
{
  CLEAR_BIT(p_usart->CR2, USART_CR2_RTOEN);
}
...
{
  return ((READ_BIT(p_usart->CR2, USART_CR2_RTOEN) == (USART_CR2_RTOEN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_ADD, (node_address << USART_CR2_ADD_Pos));
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_ADDM7, address_len);
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_ADD | USART_CR2_ADDM7,
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_ADD) >> USART_CR2_ADD_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_ADDM7));
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_RTSE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_RTSE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_CTSE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_CTSE);
}
...
{
  MODIFY_REG(p_usart->CR3, USART_CR3_RTSE | USART_CR3_CTSE, hardware_flow_control);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR3, USART_CR3_RTSE | USART_CR3_CTSE));
}
...
{
  SET_BIT(p_usart->CR3, USART_CR3_ONEBIT);
}
...
{
  CLEAR_BIT(p_usart->CR3, USART_CR3_ONEBIT);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_ONEBIT) == (USART_CR3_ONEBIT)) ? 1UL : 0UL);
}
...
{
  CLEAR_BIT(p_usart->CR3, USART_CR3_OVRDIS);
}
...
{
  SET_BIT(p_usart->CR3, USART_CR3_OVRDIS);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_OVRDIS) != USART_CR3_OVRDIS) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR3, USART_CR3_WUS, Type);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR3, USART_CR3_WUS));
}
...
{
  MODIFY_REG(p_usart->RTOR, USART_RTOR_RTO, timeout);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->RTOR, USART_RTOR_RTO));
}
...
{
  MODIFY_REG(p_usart->RTOR, USART_RTOR_BLEN, block_length << USART_RTOR_BLEN_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->RTOR, USART_RTOR_BLEN) >> USART_RTOR_BLEN_Pos);
}
...
{
  SET_BIT(p_usart->CR3, USART_CR3_IREN);
}
...
{
  CLEAR_BIT(p_usart->CR3, USART_CR3_IREN);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_IREN) == (USART_CR3_IREN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR3, USART_CR3_IRLP, power_mode);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR3, USART_CR3_IRLP));
}
...
{
  MODIFY_REG(p_usart->GTPR, USART_GTPR_PSC, (uint16_t)prescaler_value);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->GTPR, USART_GTPR_PSC));
}
...
{
  SET_BIT(p_usart->CR3, USART_CR3_NACK);
}
...
{
  CLEAR_BIT(p_usart->CR3, USART_CR3_NACK);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_NACK) == (USART_CR3_NACK)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_usart->CR3, USART_CR3_SCEN);
}
...
{
  CLEAR_BIT(p_usart->CR3, USART_CR3_SCEN);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_SCEN) == (USART_CR3_SCEN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR3, USART_CR3_SCARCNT, auto_retry_count << USART_CR3_SCARCNT_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR3, USART_CR3_SCARCNT) >> USART_CR3_SCARCNT_Pos);
}
...
{
  MODIFY_REG(p_usart->GTPR, USART_GTPR_GT, (uint16_t)(guard_time << USART_GTPR_GT_Pos));
}
...
{
  return (uint32_t)(READ_BIT(p_usart->GTPR, USART_GTPR_GT) >> USART_GTPR_GT_Pos);
}
...
{
  SET_BIT(p_usart->CR3, USART_CR3_HDSEL);
}
...
{
  CLEAR_BIT(p_usart->CR3, USART_CR3_HDSEL);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_HDSEL) == (USART_CR3_HDSEL)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_usart->CR2, USART_CR2_SLVEN);
}
...
{
  CLEAR_BIT(p_usart->CR2, USART_CR2_SLVEN);
}
...
{
  return ((READ_BIT(p_usart->CR2, USART_CR2_SLVEN) == (USART_CR2_SLVEN)) ? 1UL : 0UL);
}
...
{
  CLEAR_BIT(p_usart->CR2, USART_CR2_DIS_NSS);
}
...
{
  SET_BIT(p_usart->CR2, USART_CR2_DIS_NSS);
}
...
{
  return ((READ_BIT(p_usart->CR2, USART_CR2_DIS_NSS) != (USART_CR2_DIS_NSS)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR2, USART_CR2_LBDL, lin_break_detect_length);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR2, USART_CR2_LBDL));
}
...
{
  SET_BIT(p_usart->CR2, USART_CR2_LINEN);
}
...
{
  CLEAR_BIT(p_usart->CR2, USART_CR2_LINEN);
}
...
{
  return ((READ_BIT(p_usart->CR2, USART_CR2_LINEN) == (USART_CR2_LINEN)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR1, USART_CR1_DEDT, time << USART_CR1_DEDT_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR1, USART_CR1_DEDT) >> USART_CR1_DEDT_Pos);
}
...
{
  MODIFY_REG(p_usart->CR1, USART_CR1_DEAT, time << USART_CR1_DEAT_Pos);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR1, USART_CR1_DEAT) >> USART_CR1_DEAT_Pos);
}
...
{
  MODIFY_REG(p_usart->CR1, USART_CR1_DEAT | USART_CR1_DEDT,
...
{
  SET_BIT(p_usart->CR3, USART_CR3_DEM);
}
...
{
  CLEAR_BIT(p_usart->CR3, USART_CR3_DEM);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_DEM) == (USART_CR3_DEM)) ? 1UL : 0UL);
}
...
{
  MODIFY_REG(p_usart->CR3, USART_CR3_DEP, polarity);
}
...
{
  return (uint32_t)(READ_BIT(p_usart->CR3, USART_CR3_DEP));
}
...
__STATIC_INLINE void LL_USART_ConfigAsyncMode(USART_TypeDef *p_usart)
{
  ...
  */
  CLEAR_BIT(p_usart->CR2, (USART_CR2_LINEN | USART_CR2_CLKEN));
  CLEAR_BIT(p_usart->CR3, (USART_CR3_SCEN | USART_CR3_IREN | USART_CR3_HDSEL));
}
...
__STATIC_INLINE void LL_USART_ConfigSyncMasterMode(USART_TypeDef *p_usart)
{
  ...
  - SCEN, IREN and HDSEL bits in the USART_CR3 register.
  */
  CLEAR_BIT(p_usart->CR2, (USART_CR2_LINEN | USART_CR2_SLVEN));
  CLEAR_BIT(p_usart->CR3, (USART_CR3_SCEN | USART_CR3_IREN | USART_CR3_HDSEL));
...
__STATIC_INLINE void LL_USART_ConfigLINMode(USART_TypeDef *p_usart)
{
  ...
  */
  CLEAR_BIT(p_usart->CR2, (USART_CR2_CLKEN | USART_CR2_STOP));
  CLEAR_BIT(p_usart->CR3, (USART_CR3_IREN | USART_CR3_SCEN | USART_CR3_HDSEL));
...
__STATIC_INLINE void LL_USART_ConfigHalfDuplexMode(USART_TypeDef *p_usart)
{
  ...
  */
  CLEAR_BIT(p_usart->CR2, (USART_CR2_LINEN | USART_CR2_CLKEN));
  CLEAR_BIT(p_usart->CR3, (USART_CR3_SCEN | USART_CR3_IREN));
...
__STATIC_INLINE void LL_USART_ConfigSmartcardMode(USART_TypeDef *p_usart)
{
  ...
  */
  CLEAR_BIT(p_usart->CR2, (USART_CR2_LINEN));
  CLEAR_BIT(p_usart->CR3, (USART_CR3_IREN | USART_CR3_HDSEL));
  /* Configure Stop bits to 1.5 bits */
  /* Synchronous mode is activated by default */
  SET_BIT(p_usart->CR2, (USART_CR2_STOP_0 | USART_CR2_STOP_1 | USART_CR2_CLKEN));
...
__STATIC_INLINE void LL_USART_ConfigIrdaMode(USART_TypeDef *p_usart)
{
  ...
  */
  CLEAR_BIT(p_usart->CR2, (USART_CR2_LINEN | USART_CR2_CLKEN | USART_CR2_STOP));
  CLEAR_BIT(p_usart->CR3, (USART_CR3_SCEN | USART_CR3_HDSEL));
...
__STATIC_INLINE void LL_USART_ConfigMultiProcessMode(USART_TypeDef *p_usart)
{
  ...
  */
  CLEAR_BIT(p_usart->CR2, (USART_CR2_LINEN | USART_CR2_CLKEN));
  CLEAR_BIT(p_usart->CR3, (USART_CR3_SCEN | USART_CR3_HDSEL | USART_CR3_IREN));
}
...
{
  return ((READ_BIT(p_usart->ISR, mask) == (mask)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_PE) == (USART_ISR_PE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_FE) == (USART_ISR_FE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_NE) == (USART_ISR_NE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_ORE) == (USART_ISR_ORE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_IDLE) == (USART_ISR_IDLE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_RXNE_RXFNE) == (USART_ISR_RXNE_RXFNE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_TC) == (USART_ISR_TC)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_TXE_TXFNF) == (USART_ISR_TXE_TXFNF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_LBDF) == (USART_ISR_LBDF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_CTSIF) == (USART_ISR_CTSIF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_CTS) == (USART_ISR_CTS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_RTOF) == (USART_ISR_RTOF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_EOBF) == (USART_ISR_EOBF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_UDR) == (USART_ISR_UDR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_ABRE) == (USART_ISR_ABRE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_ABRF) == (USART_ISR_ABRF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_BUSY) == (USART_ISR_BUSY)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_CMF) == (USART_ISR_CMF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_SBKF) == (USART_ISR_SBKF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_RWU) == (USART_ISR_RWU)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_WUF) == (USART_ISR_WUF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_TEACK) == (USART_ISR_TEACK)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_REACK) == (USART_ISR_REACK)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_TXFE) == (USART_ISR_TXFE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_RXFF) == (USART_ISR_RXFF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_TCBGT) == (USART_ISR_TCBGT)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_TXFT) == (USART_ISR_TXFT)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->ISR, USART_ISR_RXFT) == (USART_ISR_RXFT)) ? 1UL : 0UL);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_FECF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_NECF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_ORECF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_IDLECF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_TXFECF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_TCCF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_TCBGTCF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_LBDCF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_CTSCF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_RTOCF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_EOBCF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_UDRCF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_CMCF);
}
...
{
  WRITE_REG(p_usart->ICR, USART_ICR_WUCF);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, mask);
}
/**
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_IDLEIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_RXNEIE_RXFNEIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_TCIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_TXEIE_TXFNFIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_PEIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_CMIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_RTOIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_EOBIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_TXFEIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR1, USART_CR1_RXFFIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR2, mask);
}
...
{
  SET_BIT(p_usart->CR2, USART_CR2_LBDIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, mask);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_EIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_CTSIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_WUFIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_TXFTIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_TCBGTIE);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_RXFTIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, mask);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_IDLEIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_RXNEIE_RXFNEIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_TCIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_TXEIE_TXFNFIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_PEIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_CMIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_RTOIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_EOBIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_TXFEIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR1, USART_CR1_RXFFIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR2, mask);
}
...
{
  CLEAR_BIT(p_usart->CR2, USART_CR2_LBDIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, mask);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_EIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_CTSIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_WUFIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_TXFTIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_TCBGTIE);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_RXFTIE);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_IDLEIE) == (USART_CR1_IDLEIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_RXNEIE_RXFNEIE) == (USART_CR1_RXNEIE_RXFNEIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_TCIE) == (USART_CR1_TCIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_TXEIE_TXFNFIE) == (USART_CR1_TXEIE_TXFNFIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_CMIE) == (USART_CR1_CMIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_RTOIE) == (USART_CR1_RTOIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_EOBIE) == (USART_CR1_EOBIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_TXFEIE) == (USART_CR1_TXFEIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR1, USART_CR1_RXFFIE) == (USART_CR1_RXFFIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR2, USART_CR2_LBDIE) == (USART_CR2_LBDIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_EIE) == (USART_CR3_EIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_CTSIE) == (USART_CR3_CTSIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_WUFIE) == (USART_CR3_WUFIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_TXFTIE) == (USART_CR3_TXFTIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_TCBGTIE) == (USART_CR3_TCBGTIE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_RXFTIE) == (USART_CR3_RXFTIE)) ? 1UL : 0UL);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_DMAR);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_DMAR);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_DMAR) == (USART_CR3_DMAR)) ? 1UL : 0UL);
}
...
{
  ATOMIC_SET_BIT(p_usart->CR3, USART_CR3_DMAT);
}
...
{
  ATOMIC_CLEAR_BIT(p_usart->CR3, USART_CR3_DMAT);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_DMAT) == (USART_CR3_DMAT)) ? 1UL : 0UL);
}
...
{
  SET_BIT(p_usart->CR3, USART_CR3_DDRE);
}
...
{
  CLEAR_BIT(p_usart->CR3, USART_CR3_DDRE);
}
...
{
  return ((READ_BIT(p_usart->CR3, USART_CR3_DDRE) == (USART_CR3_DDRE)) ? 1UL : 0UL);
}
...
{
  return (uint8_t)(READ_BIT(p_usart->RDR, USART_RDR_RDR) & 0xFFU);
}
...
{
  return (uint16_t)(READ_BIT(p_usart->RDR, USART_RDR_RDR));
}
...
/**
  ...
  */
__STATIC_INLINE void LL_USART_SetRequest(USART_TypeDef *p_usart, uint16_t request)
{
  SET_BIT(p_usart->RQR, request);
}
...
{
  SET_BIT(p_usart->RQR, (uint16_t)USART_RQR_ABRRQ);
}
...
{
  SET_BIT(p_usart->RQR, (uint16_t)USART_RQR_SBKRQ);
}
...
{
  SET_BIT(p_usart->RQR, (uint16_t)USART_RQR_MMRQ);
}
...
{
  SET_BIT(p_usart->RQR, (uint16_t)USART_RQR_RXFRQ);
}
...
{
  SET_BIT(p_usart->RQR, (uint16_t)USART_RQR_TXFRQ);
}
