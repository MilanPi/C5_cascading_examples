...
## In case the configurable EXTI line is used as an event input:
  - Instantiate an EXTI handle and associate it to an configurable EXTI line.
  - Configure the configurable EXTI line identified by the given handle.
  - Register a user defined callback for an configurable EXTI line identified by the handle, or else use the
  default callback functions.
  - Enable configurable EXTI line for Interrupt, Event or both modes.
  - Pending events for configurable EXTI line can be retrieved and cleared.
  - EXTI modes can be disabled.

## In case the direct EXTI line is used as an event input:
  - Instantiate an EXTI handle and associate it to an direct EXTI line.
  - Enable direct EXTI line for Interrupt, Event or both modes.
  - EXTI modes can be disabled.
