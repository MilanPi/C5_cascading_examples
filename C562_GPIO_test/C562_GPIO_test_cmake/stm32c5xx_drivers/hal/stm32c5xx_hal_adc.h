...
typedef enum
{
  ...
  HAL_ADC_REG_TRIG_TIM5_CH4             = LL_ADC_REG_TRIG_EXT_TIM5_CH4,             /*!< ADC group regular conversion
                                        trigger from periph: TIM5 channel 4 event (capture compare). */
  HAL_ADC_REG_TRIG_TIM5_TRGO            = LL_ADC_REG_TRIG_EXT_TIM5_TRGO,            /*!< ADC group regular conversion
                                        trigger from periph: TIM5 TRGO event */
...
typedef enum
{
...
#endif /* STM32C591xx, STM32C593xx, STM32C5A3xx */
  HAL_ADC_INJ_TRIG_TIM5_CH1             = LL_ADC_INJ_TRIG_EXT_TIM5_CH1,        /*!< ADC group injected conversion
                                        trigger from external peripheral: TIM5 channel 1 event (capture compare). */
  HAL_ADC_INJ_TRIG_TIM5_CH2             = LL_ADC_INJ_TRIG_EXT_TIM5_CH2,        /*!< ADC group injected conversion
                                        trigger from external peripheral: TIM5 channel 2 event (capture compare). */
  HAL_ADC_INJ_TRIG_TIM5_CH3             = LL_ADC_INJ_TRIG_EXT_TIM5_CH3,        /*!< ADC group injected conversion
                                        trigger from external peripheral: TIM5 channel 3 event (capture compare). */
  HAL_ADC_INJ_TRIG_TIM5_TRGO            = LL_ADC_INJ_TRIG_EXT_TIM5_TRGO,       /*!< ADC group injected conversion
                                        trigger from external peripheral: TIM5 TRGO event */
  HAL_ADC_INJ_TRIG_TIM7_TRGO            = LL_ADC_INJ_TRIG_EXT_TIM7_TRGO,       /*!< ADC group injected conversion
  ...
  HAL_ADC_INJ_TRIG_TIM12_TRGO           = LL_ADC_INJ_TRIG_EXT_TIM12_TRGO,      /*!< ADC group injected conversion
  ...
  HAL_ADC_INJ_TRIG_LPTIM1_CH1           = LL_ADC_INJ_TRIG_EXT_LPTIM1_CH1,      /*!< ADC group injected conversion
...
typedef enum
{
  HAL_ADC_SAMPLING_TIME_2CYCLES_5       = LL_ADC_SAMPLINGTIME_2CYCLES_5,   /*!< Sampling time 2.5 ADC clock cycles */
  HAL_ADC_SAMPLING_TIME_4CYCLES_5       = LL_ADC_SAMPLINGTIME_4CYCLES_5,   /*!< Sampling time 4.5 ADC clock cycles */
  HAL_ADC_SAMPLING_TIME_7CYCLES_5       = LL_ADC_SAMPLINGTIME_7CYCLES_5,   /*!< Sampling time 7.5 ADC clock cycles */
  HAL_ADC_SAMPLING_TIME_12CYCLES_5      = LL_ADC_SAMPLINGTIME_12CYCLES_5,  /*!< Sampling time 12.5 ADC clock cycles */
  HAL_ADC_SAMPLING_TIME_24CYCLES_5      = LL_ADC_SAMPLINGTIME_24CYCLES_5,  /*!< Sampling time 24.5 ADC clock cycles */
  HAL_ADC_SAMPLING_TIME_47CYCLES_5      = LL_ADC_SAMPLINGTIME_47CYCLES_5,  /*!< Sampling time 47.5 ADC clock cycles */
  HAL_ADC_SAMPLING_TIME_138CYCLES_5     = LL_ADC_SAMPLINGTIME_138CYCLES_5, /*!< Sampling time 138.5 ADC clock cycles */
  HAL_ADC_SAMPLING_TIME_288CYCLES_5     = LL_ADC_SAMPLINGTIME_288CYCLES_5  /*!< Sampling time 288.5 ADC clock cycles */
...
typedef enum
{
  ...
  HAL_ADC_MM_INTERL_DELAY_7CYCLES       = LL_ADC_MULTI_TWOSMP_DELAY_7CYCLES,  /*!< ADC multimode (mode interleaved only)
                                        delay between two sampling phases: 7 ADC clock cycles for resolutions
                                        12, 10, 8 bit */
