...
- Enable the CRC peripheral clock:
  ...
  - Or by setting the USE_HAL_CRC_CLK_ENABLE_MODEL define to HAL_CLK_ENABLE_PERIPH_ONLY within
    the stm32c5xx_hal_conf.h file, in this case the CRC clock will be enabled within the HAL_CRC_Init()
    API
...
USE_HAL_CHECK_PARAM          | from stm32c5xx_hal_conf.h | 0                          | Parameters runtime check
USE_HAL_CRC_MODULE           | from stm32c5xx_hal_conf.h | 1                          | Enable the HAL CRC module
USE_HAL_CRC_CLK_ENABLE_MODEL | from stm32c5xx_hal_conf.h | HAL_CLK_ENABLE_PERIPH_ONLY | Enable the HAL_CRC_CLK
USE_HAL_CRC_USER_DATA        | from stm32c5xx_hal_conf.h | 0                          | Allows to use user data
  */
...
/**
  ...
  * @retval HAL_CRC_INDATA_REVERSE_BYTE_BYWORD      The bit reversal is done byte by word
...
/**
  ...
  * @retval HAL_INVALID_PARAM Invalid param return when the provided output reverse mode is invalid
