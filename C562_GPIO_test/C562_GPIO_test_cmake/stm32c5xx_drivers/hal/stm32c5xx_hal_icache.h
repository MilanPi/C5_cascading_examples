...
/**
  * @brief HAL ICACHE instances definition.
  */
typedef enum
{
  HAL_ICACHE = (uint32_t)ICACHE         /*!< Instance ICACHE */
} hal_icache_t;
...
/**
  * @brief HAL ICACHE remap regions definitions.
  */
typedef enum
{
...
/**
  * @brief HAL ICACHE remap region sizes definitions.
  */
typedef enum
{
...
/**
  * @brief HAL ICACHE states definitions.
  */
typedef enum
{
...
typedef struct
{
  /*! Configures the Base address of Region to be remapped */
  uint32_t base_address;
  /*! Configures the Remap address of Region to be remapped */
...
typedef  void (*hal_icache_cb_t)(hal_icache_handle_t *hicache); /*!< Pointer to a ICACHE callback functions */
...
/* Exported constants ---------------------------------------------------------*/
/** @defgroup ICACHE_Exported_Constants Exported Constants
  * @{
  */
...
#define HAL_ICACHE_IT_ALL         HAL_ICACHE_IT_ERROR    /*!< All interrupts */
/**
  * @}
  */
...
/* Exported functions --------------------------------------------------------*/
/** @defgroup ICACHE_Exported_Functions Exported Functions
  * @{
  */
