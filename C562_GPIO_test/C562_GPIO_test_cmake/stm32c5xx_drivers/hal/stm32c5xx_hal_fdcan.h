...
#define HAL_FDCAN_IT_GROUP_RX_FIFO0       (FDCAN_ILS_RXFIFO0) /*!< Rx FIFO0 group           */
#define HAL_FDCAN_IT_GROUP_RX_FIFO1       (FDCAN_ILS_RXFIFO1) /*!< Rx FIFO1 group           */
#define HAL_FDCAN_IT_GROUP_STATUS_MSG     (FDCAN_ILS_SMSG)    /*!< Status message group     */
#define HAL_FDCAN_IT_GROUP_TX_FIFO_ERROR  (FDCAN_ILS_TFERR)   /*!< Tx FIFO error group      */
#define HAL_FDCAN_IT_GROUP_MISC           (FDCAN_ILS_MISC)    /*!< Miscellaneous group      */
#define HAL_FDCAN_IT_GROUP_BIT_LINE_ERROR (FDCAN_ILS_BERR)    /*!< Bit and line error group */
#define HAL_FDCAN_IT_GROUP_PROTOCOL_ERROR (FDCAN_ILS_PERR)    /*!< Protocol error group     */
...
/** @defgroup FDCAN_Interrupt_Group_Rx_FIFO0 FDCAN Interrupt Group Rx FIFO0
  * @ingroup FDCAN_Interrupt_Sources
  * @{
  */
...
/** @defgroup FDCAN_Interrupt_Group_Rx_FIFO1 FDCAN Interrupt Group Rx FIFO1
  * @ingroup FDCAN_Interrupt_Sources
  * @{
  */
...
/** @defgroup FDCAN_Interrupt_Group_Status_Message FDCAN Interrupt Group status message
  * @ingroup FDCAN_Interrupt_Sources
  * @{
  */
...
/** @defgroup FDCAN_Interrupt_Group_Tx_FIFO_Error FDCAN Interrupt Group Tx FIFO error
  * @ingroup FDCAN_Interrupt_Sources
  * @{
  */
...
/** @defgroup FDCAN_Interrupt_Group_MISC FDCAN Interrupt Group MISC
  * @ingroup FDCAN_Interrupt_Sources
  * @{
  */
...
/** @defgroup FDCAN_Interrupt_Group_Bit_Line_Error FDCAN Interrupt Group bit and line error
  * @ingroup FDCAN_Interrupt_Sources
  * @{
  */
...
/** @defgroup FDCAN_Interrupt_Group_Protocol_Error FDCAN Interrupt Group protocol error
  * @ingroup FDCAN_Interrupt_Sources
  * @{
  */
