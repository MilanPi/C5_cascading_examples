...
/* Shift to apply to a value (period or pulse) to obtain the equivalent value when dithering is enabled */
#define HAL_TIM_DITHERING_SHIFT  (4U)

/* Number of TIM channels (number of fields in the @ref hal_tim_channel_t) */
#define HAL_TIM_CHANNELS  (11U)

#if defined(USE_HAL_TIM_DMA) && (USE_HAL_TIM_DMA == 1)
/* Number of DMA requests (number of fields in the @ref hal_tim_dma_index_t) */
...
/* Macro to compute the pulse with a dithered value */
...
/** @defgroup  TIM_Error_Code Error Code definition reflecting the processes asynchronous errors
  * @{
  */
...
/**
  * @brief HAL TIM Group Channel 5 and Channel 1, 2 or 3.
  */
...
/**
  * @brief  HAL TIM Break Input Source
  */
/** BKIN input from AF controller */
#define HAL_TIM_BREAK_INPUT_GPIO         (LL_TIM_BKIN_SOURCE_GPIO)

/** Internal signal: COMP1 output */
#define HAL_TIM_BREAK_INPUT_COMP1        (LL_TIM_BKIN_SOURCE_COMP1)

#if defined(COMP2)
/** Internal signal: COMP2 output */
#define HAL_TIM_BREAK_INPUT_COMP2        (LL_TIM_BKIN_SOURCE_COMP2)
#endif /* COMP2 */

/** Internal signal: TIM1 break 1 input */
#define HAL_TIM_BREAK_INPUT_TIM1_BKIN1   (LL_TIM_BKIN_SOURCE_TIM1_BKIN1)

/** Internal signal: TIM8 break 1 input */
#define HAL_TIM_BREAK_INPUT_TIM8_BKIN1   (LL_TIM_BKIN_SOURCE_TIM8_BKIN1)

/** Internal signal: TIM15 break 1 input */
#define HAL_TIM_BREAK_INPUT_TIM15_BKIN1  (LL_TIM_BKIN_SOURCE_TIM15_BKIN1)

#if defined(TIM16)
/** Internal signal: TIM16 break 1 input */
#define HAL_TIM_BREAK_INPUT_TIM16_BKIN1  (LL_TIM_BKIN_SOURCE_TIM16_BKIN1)

/** Internal signal: TIM17 break 1 input */
#define HAL_TIM_BREAK_INPUT_TIM17_BKIN1  (LL_TIM_BKIN_SOURCE_TIM17_BKIN1)
#endif /* TIM16 */


/** Internal signal: TIM1 break 2 input */
#define HAL_TIM_BREAK2_INPUT_TIM1_BKIN2  (LL_TIM_BKIN2_SOURCE_TIM1_BKIN2)

/** Internal signal: TIM8 break 2 input */
#define HAL_TIM_BREAK2_INPUT_TIM8_BKIN2  (LL_TIM_BKIN2_SOURCE_TIM8_BKIN2)
...
typedef enum
{
  HAL_TIM1  = (uint32_t)TIM1,

  HAL_TIM2  = (uint32_t)TIM2,

#if defined(TIM3)
  HAL_TIM3  = (uint32_t)TIM3,

  HAL_TIM4  = (uint32_t)TIM4,
#endif /* TIM3 */

#if defined(TIM5)
  HAL_TIM5  = (uint32_t)TIM5,
#endif /* TIM5 */

  HAL_TIM6  = (uint32_t)TIM6,

  HAL_TIM7  = (uint32_t)TIM7,

  HAL_TIM8  = (uint32_t)TIM8,

  HAL_TIM12 = (uint32_t)TIM12,

  HAL_TIM15 = (uint32_t)TIM15,

#if defined(TIM16)
  HAL_TIM16 = (uint32_t)TIM16,

  HAL_TIM17 = (uint32_t)TIM17,
#endif /* TIM16 */
...
/**
  * @brief TIM Clock Division
  */
typedef enum
{
  /** Clock division: tDTS=tTIM_KER_CK                 */
  HAL_TIM_CLK_DIVISION_DIV1 = LL_TIM_CLOCKDIVISION_DIV1,

  /** Clock division: tDTS=2*tTIM_KER_CK               */
  HAL_TIM_CLK_DIVISION_DIV2 = LL_TIM_CLOCKDIVISION_DIV2,

  /** Clock division: tDTS=4*tTIM_KER_CK               */
  HAL_TIM_CLK_DIVISION_DIV4 = LL_TIM_CLOCKDIVISION_DIV4,

  /** Clock division: tDTS=8*tTIM_KER_CK               */
  HAL_TIM_CLK_DIVISION_DIV8 = LL_TIM_CLOCKDIVISION_DIV8,

} hal_tim_clk_division_t;


/**
  * @brief TIM Clock Division 2
  */
typedef enum
{
  /** Clock division 2: tDTS2=tDTS                                */
  HAL_TIM_CLK_DIVISION2_DIV1 = LL_TIM_CLOCKDIVISION2_DIV1,

  /** Clock division 2: tDTS2=4*tDTS                              */
  HAL_TIM_CLK_DIVISION2_DIV4 = LL_TIM_CLOCKDIVISION2_DIV4,

  /** Clock division 2: tDTS2=16*tDTS                             */
  HAL_TIM_CLK_DIVISION2_DIV16 = LL_TIM_CLOCKDIVISION2_DIV16,

  /** Clock division 2: tDTS2=64*tDTS                             */
  HAL_TIM_CLK_DIVISION2_DIV64 = LL_TIM_CLOCKDIVISION2_DIV64,

  /** Clock division 2: tDTS2=256*tDTS                            */
  HAL_TIM_CLK_DIVISION2_DIV256 = LL_TIM_CLOCKDIVISION2_DIV256,

  /** Clock division 2: tDTS2=1024*tDTS                           */
  HAL_TIM_CLK_DIVISION2_DIV1024 = LL_TIM_CLOCKDIVISION2_DIV1024,

  /** Clock division 2: tDTS2=4096*tDTS                           */
  HAL_TIM_CLK_DIVISION2_DIV4096 = LL_TIM_CLOCKDIVISION2_DIV4096,

  /** Clock division 2: tDTS2=16384*tDTS                          */
  HAL_TIM_CLK_DIVISION2_DIV16384 = LL_TIM_CLOCKDIVISION2_DIV16384,

  /** Clock division 2: tDTS2=65536*tDTS                          */
  HAL_TIM_CLK_DIVISION2_DIV65536 = LL_TIM_CLOCKDIVISION2_DIV65536,

  /** Clock division 2: tDTS2=262144*tDTS                         */
  HAL_TIM_CLK_DIVISION2_DIV262144 = LL_TIM_CLOCKDIVISION2_DIV262144,

} hal_tim_clk_division2_t;
...
typedef enum
{
  ...
  HAL_TIM_OC_CHANNEL_FAST_MODE_DISABLED = 0U,

  /** Output Compare fast mode is enabled   */
  HAL_TIM_OC_CHANNEL_FAST_MODE_ENABLED  = 1U,
...
/**
  * @brief HAL TIM Input Channel XOR Gate Input Signal Inversion
  */
typedef enum
{
  /** ICx is non-inverted on XOR gate input                                */
  HAL_TIM_IC_XOR_GATE_IN_NON_INVERTED  = LL_TIM_IC_XOR_GATE_IN_NON_INVERTED,

  /** ICx is inverted on XOR gate input                                    */
  HAL_TIM_IC_XOR_GATE_IN_INVERTED = LL_TIM_IC_XOR_GATE_IN_INVERTED,

} hal_tim_ic_xor_gate_input_inversion_t;
...
/**
  * @brief HAL TIM Input Channel Signal status
  */
typedef enum
{
  /** Input signal is low    */
  HAL_TIM_IC_SIGNAL_LOW  = LL_TIM_IC_SIGNAL_LOW,

  /** Input signal is high   */
  HAL_TIM_IC_SIGNAL_HIGH = LL_TIM_IC_SIGNAL_HIGH,

} hal_tim_ic_signal_status_t;
...
typedef enum
{
  ...
  /** TIM1 external trigger is connected to COMP1 output               */
  HAL_TIM_EXT_TRIG_TIM1_COMP1 = LL_TIM_TIM1_ETRSOURCE_COMP1,
  ...
  /** TIM1 external trigger is connected to ADC1 AWD1                  */
  HAL_TIM_EXT_TRIG_TIM1_ADC1_AWD1 = LL_TIM_TIM1_ETRSOURCE_ADC1_AWD1,

  /** TIM1 external trigger is connected to ADC1 AWD2                  */
  HAL_TIM_EXT_TRIG_TIM1_ADC1_AWD2 = LL_TIM_TIM1_ETRSOURCE_ADC1_AWD2,

  /** TIM1 external trigger is connected to ADC1 AWD3                  */
  HAL_TIM_EXT_TRIG_TIM1_ADC1_AWD3 = LL_TIM_TIM1_ETRSOURCE_ADC1_AWD3,


  /** TIM2 external trigger is connected to I/O                        */
  HAL_TIM_EXT_TRIG_TIM2_GPIO  = LL_TIM_TIM2_ETRSOURCE_GPIO,

  /** TIM2 external trigger is connected to COMP1 output               */
  HAL_TIM_EXT_TRIG_TIM2_COMP1 = LL_TIM_TIM2_ETRSOURCE_COMP1,

#if defined(COMP2)
  /** TIM2 external trigger is connected to COMP2 output               */
  HAL_TIM_EXT_TRIG_TIM2_COMP2 = LL_TIM_TIM2_ETRSOURCE_COMP2,
#endif /* COMP2 */

  /** TIM2 external trigger is connected to ADC1 AWD1                  */
  HAL_TIM_EXT_TRIG_TIM2_ADC1_AWD1 = LL_TIM_TIM2_ETRSOURCE_ADC1_AWD1,

  /** TIM2 external trigger is connected to ADC1 AWD2                  */
  HAL_TIM_EXT_TRIG_TIM2_ADC1_AWD2 = LL_TIM_TIM2_ETRSOURCE_ADC1_AWD2,

  /** TIM2 external trigger is connected to ADC1 AWD3                  */
  HAL_TIM_EXT_TRIG_TIM2_ADC1_AWD3 = LL_TIM_TIM2_ETRSOURCE_ADC1_AWD3,

  /** TIM2 external trigger is connected to LSE                        */
  HAL_TIM_EXT_TRIG_TIM2_LSE = LL_TIM_TIM2_ETRSOURCE_LSE,

  /** TIM2 external trigger is connected to MCO1                       */
  HAL_TIM_EXT_TRIG_TIM2_MCO1 = LL_TIM_TIM2_ETRSOURCE_MCO1,

#if defined(TIM3)
  /** TIM2 external trigger is connected to TIM3 ETR                   */
  HAL_TIM_EXT_TRIG_TIM2_TIM3_ETR = LL_TIM_TIM2_ETRSOURCE_TIM3_ETR,

  /** TIM2 external trigger is connected to TIM4 ETR                   */
  HAL_TIM_EXT_TRIG_TIM2_TIM4_ETR = LL_TIM_TIM2_ETRSOURCE_TIM4_ETR,
#endif /* TIM3 */

#if defined(TIM5)
  /** TIM2 external trigger is connected to TIM5 ETR                   */
  HAL_TIM_EXT_TRIG_TIM2_TIM5_ETR = LL_TIM_TIM2_ETRSOURCE_TIM5_ETR,
#endif /* TIM5 */

#if defined(ETH)
  /** TIM2 external trigger is connected to ETH PPS                    */
  HAL_TIM_EXT_TRIG_TIM2_ETH_PPS = LL_TIM_TIM2_ETRSOURCE_ETH_PPS,
#endif /* ETH */


#if defined(TIM3)
  /** TIM3 external trigger is connected to I/O                        */
  HAL_TIM_EXT_TRIG_TIM3_GPIO  = LL_TIM_TIM3_ETRSOURCE_GPIO,

  /** TIM3 external trigger is connected to COMP1 output               */
  HAL_TIM_EXT_TRIG_TIM3_COMP1 = LL_TIM_TIM3_ETRSOURCE_COMP1,

  /** TIM3 external trigger is connected to TIM2 ETR                   */
  HAL_TIM_EXT_TRIG_TIM3_TIM2_ETR = LL_TIM_TIM3_ETRSOURCE_TIM2_ETR,

  /** TIM3 external trigger is connected to TIM4 ETR                   */
  HAL_TIM_EXT_TRIG_TIM3_TIM4_ETR = LL_TIM_TIM3_ETRSOURCE_TIM4_ETR,

  /** TIM3 external trigger is connected to TIM5 ETR                   */
  HAL_TIM_EXT_TRIG_TIM3_TIM5_ETR = LL_TIM_TIM3_ETRSOURCE_TIM5_ETR,

  /** TIM3 external trigger is connected to ETH PPS                    */
  HAL_TIM_EXT_TRIG_TIM3_ETH_PPS = LL_TIM_TIM3_ETRSOURCE_ETH_PPS,


  /** TIM4 external trigger is connected to I/O                        */
  HAL_TIM_EXT_TRIG_TIM4_GPIO  = LL_TIM_TIM4_ETRSOURCE_GPIO,

  /** TIM4 external trigger is connected to COMP1 output               */
  HAL_TIM_EXT_TRIG_TIM4_COMP1 = LL_TIM_TIM4_ETRSOURCE_COMP1,

  /** TIM4 external trigger is connected to ADC3 AWD1                  */
  HAL_TIM_EXT_TRIG_TIM4_ADC3_AWD1 = LL_TIM_TIM4_ETRSOURCE_ADC3_AWD1,

  /** TIM4 external trigger is connected to ADC3 AWD2                  */
  HAL_TIM_EXT_TRIG_TIM4_ADC3_AWD2 = LL_TIM_TIM4_ETRSOURCE_ADC3_AWD2,

  /** TIM4 external trigger is connected to ADC3 AWD3                  */
  HAL_TIM_EXT_TRIG_TIM4_ADC3_AWD3 = LL_TIM_TIM4_ETRSOURCE_ADC3_AWD3,

  /** TIM4 external trigger is connected to TIM2 ETR                   */
  HAL_TIM_EXT_TRIG_TIM4_TIM2_ETR = LL_TIM_TIM4_ETRSOURCE_TIM2_ETR,

  /** TIM4 external trigger is connected to TIM3 ETR                   */
  HAL_TIM_EXT_TRIG_TIM4_TIM3_ETR = LL_TIM_TIM4_ETRSOURCE_TIM3_ETR,

  /** TIM4 external trigger is connected to TIM5 ETR                   */
  HAL_TIM_EXT_TRIG_TIM4_TIM5_ETR = LL_TIM_TIM4_ETRSOURCE_TIM5_ETR,
#endif /* TIM3 */


#if defined(TIM5)
  /** TIM5 external trigger is connected to I/O                        */
  HAL_TIM_EXT_TRIG_TIM5_GPIO  = LL_TIM_TIM5_ETRSOURCE_GPIO,

  /** TIM5 external trigger is connected to COMP1 output               */
  HAL_TIM_EXT_TRIG_TIM5_COMP1 = LL_TIM_TIM5_ETRSOURCE_COMP1,

  /** TIM5 external trigger is connected to TIM2 ETR                   */
  HAL_TIM_EXT_TRIG_TIM5_TIM2_ETR = LL_TIM_TIM5_ETRSOURCE_TIM2_ETR,

#if defined(TIM3)
  /** TIM5 external trigger is connected to TIM3 ETR                   */
  HAL_TIM_EXT_TRIG_TIM5_TIM3_ETR = LL_TIM_TIM5_ETRSOURCE_TIM3_ETR,

  /** TIM5 external trigger is connected to TIM4 ETR                   */
  HAL_TIM_EXT_TRIG_TIM5_TIM4_ETR = LL_TIM_TIM5_ETRSOURCE_TIM4_ETR,
#endif /* TIM3 */
#endif /* TIM5 */


  /** TIM8 external trigger is connected to I/O                        */
  HAL_TIM_EXT_TRIG_TIM8_GPIO  = LL_TIM_TIM8_ETRSOURCE_GPIO,

  /** TIM8 external trigger is connected to COMP1 output               */
  HAL_TIM_EXT_TRIG_TIM8_COMP1 = LL_TIM_TIM8_ETRSOURCE_COMP1,

#if defined(COMP2)
  /** TIM8 external trigger is connected to COMP2 output               */
  HAL_TIM_EXT_TRIG_TIM8_COMP2 = LL_TIM_TIM8_ETRSOURCE_COMP2,
#endif /* COMP2 */

#if defined(ADC1) && defined(ADC2)
  /** TIM8 external trigger is connected to ADC2 AWD1                  */
  HAL_TIM_EXT_TRIG_TIM8_ADC2_AWD1 = LL_TIM_TIM8_ETRSOURCE_ADC2_AWD1,

  /** TIM8 external trigger is connected to ADC2 AWD2                  */
  HAL_TIM_EXT_TRIG_TIM8_ADC2_AWD2 = LL_TIM_TIM8_ETRSOURCE_ADC2_AWD2,

  /** TIM8 external trigger is connected to ADC2 AWD3                  */
  HAL_TIM_EXT_TRIG_TIM8_ADC2_AWD3 = LL_TIM_TIM8_ETRSOURCE_ADC2_AWD3,

#elif defined(ADC1)
  /** TIM8 external trigger is connected to ADC1 AWD1                  */
  HAL_TIM_EXT_TRIG_TIM8_ADC1_AWD1 = LL_TIM_TIM8_ETRSOURCE_ADC1_AWD1,

  /** TIM8 external trigger is connected to ADC1 AWD2                  */
  HAL_TIM_EXT_TRIG_TIM8_ADC1_AWD2 = LL_TIM_TIM8_ETRSOURCE_ADC1_AWD2,

  /** TIM8 external trigger is connected to ADC1 AWD3                  */
  HAL_TIM_EXT_TRIG_TIM8_ADC1_AWD3 = LL_TIM_TIM8_ETRSOURCE_ADC1_AWD3,
#endif /* ADC1 && ADC2 */

#if defined(ADC3)
  /** TIM8 external trigger is connected to ADC3 AWD1                  */
  HAL_TIM_EXT_TRIG_TIM8_ADC3_AWD1 = LL_TIM_TIM8_ETRSOURCE_ADC3_AWD1,

  /** TIM8 external trigger is connected to ADC3 AWD2                  */
  HAL_TIM_EXT_TRIG_TIM8_ADC3_AWD2 = LL_TIM_TIM8_ETRSOURCE_ADC3_AWD2,

  /** TIM8 external trigger is connected to ADC3 AWD3                  */
  HAL_TIM_EXT_TRIG_TIM8_ADC3_AWD3 = LL_TIM_TIM8_ETRSOURCE_ADC3_AWD3,
#endif /* ADC3 */
...
typedef enum
{
  ...
  HAL_TIM_INPUT_TIM1_TI1_GPIO = LL_TIM_TIM1_TI1_RMP_GPIO,

  /** TIM1 TI1 is connected to COMP1 output                           */
  HAL_TIM_INPUT_TIM1_TI1_COMP1 = LL_TIM_TIM1_TI1_RMP_COMP1,

#if defined(COMP2)
  /** TIM1 TI1 is connected to COMP2 output                           */
  HAL_TIM_INPUT_TIM1_TI1_COMP2 = LL_TIM_TIM1_TI1_RMP_COMP2,
#endif /* COMP2 */

  /** TIM1 TI2 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM1_TI2_GPIO = LL_TIM_TIM1_TI2_RMP_GPIO,

  /** TIM1 TI3 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM1_TI3_GPIO = LL_TIM_TIM1_TI3_RMP_GPIO,

  /** TIM1 TI4 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM1_TI4_GPIO = LL_TIM_TIM1_TI4_RMP_GPIO,

  /* TIM2 */
  /** TIM2 TI1 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM2_TI1_GPIO = LL_TIM_TIM2_TI1_RMP_GPIO,

  /** TIM2 TI1 is connected to COMP1 output                           */
  HAL_TIM_INPUT_TIM2_TI1_COMP1 = LL_TIM_TIM2_TI1_RMP_COMP1,

#if defined(COMP2)
  /** TIM2 TI1 is connected to COMP2 output                           */
  HAL_TIM_INPUT_TIM2_TI1_COMP2 = LL_TIM_TIM2_TI1_RMP_COMP2,

#elif defined(ETH)
  /** TIM2 TI1 is connected to ETH PPS                                */
  HAL_TIM_INPUT_TIM2_TI1_ETH_PPS = LL_TIM_TIM2_TI1_RMP_ETH_PPS,
#endif /* COMP2 */

  /** TIM2 TI1 is connected to LSI                                    */
  HAL_TIM_INPUT_TIM2_TI1_LSI = LL_TIM_TIM2_TI1_RMP_TIM1_LSI,

  /** TIM2 TI1 is connected to LSE                                    */
  HAL_TIM_INPUT_TIM2_TI1_LSE = LL_TIM_TIM2_TI1_RMP_TIM1_LSE,

  /** TIM2 TI1 is connected to RTC Wakeup                             */
  HAL_TIM_INPUT_TIM2_TI1_RTC_WKUP = LL_TIM_TIM2_TI1_RMP_RTC_WKUP,

#if defined(TIM5)
  /** TIM2 TI1 is connected to TIM5 CH1                               */
  HAL_TIM_INPUT_TIM2_TI1_TIM5_CH1 = LL_TIM_TIM2_TI1_RMP_TIM5_CH1,
#endif /* TIM5 */

  /** TIM2 TI1 is connected to FDCAN1 RX EoF event                    */
  HAL_TIM_INPUT_TIM2_TI1_FDCAN1_RXEOF = LL_TIM_TIM2_TI1_RMP_FDCAN1_RXEOF,

  /** TIM2 TI2 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM2_TI2_GPIO = LL_TIM_TIM2_TI2_RMP_GPIO,

  /** TIM2 TI2 is connected to HSE 1MHZ                               */
  HAL_TIM_INPUT_TIM2_TI2_HSE_1MHZ = LL_TIM_TIM2_TI2_RMP_HSE_1MHZ,

  /** TIM2 TI2 is connected to MCO1                                   */
  HAL_TIM_INPUT_TIM2_TI2_MCO1 = LL_TIM_TIM2_TI2_RMP_MCO1,

  /** TIM2 TI2 is connected to MCO2                                   */
  HAL_TIM_INPUT_TIM2_TI2_MCO2 = LL_TIM_TIM2_TI2_RMP_MCO2,

  /** TIM2 TI2 is connected to FCDAN1 TX EoF event                    */
  HAL_TIM_INPUT_TIM2_TI2_FDCAN1_TXEOF = LL_TIM_TIM2_TI2_RMP_FDCAN1_TXEOF,

  /** TIM2 TI3 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM2_TI3_GPIO = LL_TIM_TIM2_TI3_RMP_GPIO,

#if defined(FDCAN2)
  /** TIM2 TI3 is connected to FDCAN2 RX EoF event                    */
  HAL_TIM_INPUT_TIM2_TI3_FDCAN2_RXEOF = LL_TIM_TIM2_TI3_RMP_FDCAN2_RXEOF,
#endif /* FDCAN2 */

  /** TIM2 TI4 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM2_TI4_GPIO = LL_TIM_TIM2_TI4_RMP_GPIO,

  /** TIM2 TI4 is connected to COMP1 output                           */
  HAL_TIM_INPUT_TIM2_TI4_COMP1 = LL_TIM_TIM2_TI4_RMP_COMP1,

#if defined(COMP2)
  /** TIM2 TI4 is connected to COMP2 output                           */
  HAL_TIM_INPUT_TIM2_TI4_COMP2 = LL_TIM_TIM2_TI4_RMP_COMP2,
#endif /* COMP2 */

#if defined(FDCAN2)
  /** TIM2 TI4 is connected to FDCAN2 TX EoF event                    */
  HAL_TIM_INPUT_TIM2_TI4_FDCAN2_TXEOF = LL_TIM_TIM2_TI4_RMP_FDCAN2_TXEOF,
#endif /* FDCAN2 */

#if defined(TIM3)
  /* TIM3 */
  /** TIM3 TI1 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM3_TI1_GPIO = LL_TIM_TIM3_TI1_RMP_GPIO,

  /** TIM3 TI1 is connected to COMP1 output                           */
  HAL_TIM_INPUT_TIM3_TI1_COMP1 = LL_TIM_TIM3_TI1_RMP_COMP1,

  /** TIM3 TI1 is connected to ETH PPS                                */
  HAL_TIM_INPUT_TIM3_TI1_ETH_PPS = LL_TIM_TIM3_TI1_RMP_ETH_PPS,

  /** TIM3 TI1 is connected to FDCAN2 RX EoF event                    */
  HAL_TIM_INPUT_TIM3_TI1_FDCAN2_RXEOF = LL_TIM_TIM3_TI1_RMP_FDCAN2_RXEOF,

  /** TIM3 TI2 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM3_TI2_GPIO = LL_TIM_TIM3_TI2_RMP_GPIO,

  /** TIM3 TI2 is connected to FDCAN2 TX EoF event                    */
  HAL_TIM_INPUT_TIM3_TI2_FDCAN2_TXEOF = LL_TIM_TIM3_TI2_RMP_FDCAN2_TXEOF,

  /** TIM3 TI3 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM3_TI3_GPIO = LL_TIM_TIM3_TI3_RMP_GPIO,

  /** TIM3 TI4 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM3_TI4_GPIO = LL_TIM_TIM3_TI4_RMP_GPIO,

  /** TIM4 */
  /** TIM4 TI1 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM4_TI1_GPIO = LL_TIM_TIM4_TI1_RMP_GPIO,

  /** TIM4 TI1 is connected to COMP1 output                           */
  HAL_TIM_INPUT_TIM4_TI1_COMP1 = LL_TIM_TIM4_TI1_RMP_COMP1,

  /** TIM4 TI2 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM4_TI2_GPIO = LL_TIM_TIM4_TI2_RMP_GPIO,

  /** TIM4 TI3 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM4_TI3_GPIO = LL_TIM_TIM4_TI3_RMP_GPIO,

  /** TIM4 TI4 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM4_TI4_GPIO = LL_TIM_TIM4_TI4_RMP_GPIO,
#endif /* TIM3 */

#if defined(TIM5)
  /* TIM5 */
  /** TIM5 TI1 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM5_TI1_GPIO = LL_TIM_TIM5_TI1_RMP_GPIO,

  /** TIM5 TI1 is connected to COMP1 output                           */
  HAL_TIM_INPUT_TIM5_TI1_COMP1 = LL_TIM_TIM5_TI1_RMP_COMP1,

  /** TIM5 TI2 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM5_TI2_GPIO = LL_TIM_TIM5_TI2_RMP_GPIO,

  /** TIM5 TI3 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM5_TI3_GPIO = LL_TIM_TIM5_TI3_RMP_GPIO,

  /** TIM5 TI4 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM5_TI4_GPIO = LL_TIM_TIM5_TI4_RMP_GPIO,
#endif /* TIM5 */

  /* TIM8 */
  /** TIM8 TI1 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM8_TI1_GPIO = LL_TIM_TIM8_TI1_RMP_GPIO,

  /** TIM8 TI1 is connected to COMP1 output                           */
  HAL_TIM_INPUT_TIM8_TI1_COMP1 = LL_TIM_TIM8_TI1_RMP_COMP1,

#if defined(COMP2)
  /** TIM8 TI1 is connected to COMP2 output                           */
  HAL_TIM_INPUT_TIM8_TI1_COMP2 = LL_TIM_TIM8_TI1_RMP_COMP2,
#endif /* COMP2 */

  /** TIM8 TI2 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM8_TI2_GPIO = LL_TIM_TIM8_TI2_RMP_GPIO,

  /** TIM8 TI3 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM8_TI3_GPIO = LL_TIM_TIM8_TI3_RMP_GPIO,

  /** TIM8 TI4 is connected to GPIO                                   */
  HAL_TIM_INPUT_TIM8_TI4_GPIO = LL_TIM_TIM8_TI4_RMP_GPIO,

  /* TIM12 */
  /** TIM12 TI1 is connected to GPIO                                  */
  HAL_TIM_INPUT_TIM12_TI1_GPIO = LL_TIM_TIM12_TI1_RMP_GPIO,

  /** TIM12 TI1 is connected to COMP1 output                          */
  HAL_TIM_INPUT_TIM12_TI1_COMP1 = LL_TIM_TIM12_TI1_RMP_COMP1,

#if defined(COMP2)
  /** TIM12 TI1 is connected to COMP2 output                          */
  HAL_TIM_INPUT_TIM12_TI1_COMP2 = LL_TIM_TIM12_TI1_RMP_COMP2,
#endif /* COMP2 */

  /** TIM12 TI1 is connected to MCO1                                  */
  HAL_TIM_INPUT_TIM12_TI1_MCO1 = LL_TIM_TIM12_TI1_RMP_MCO1,

  /** TIM12 TI1 is connected to MCO2                                  */
  HAL_TIM_INPUT_TIM12_TI1_MCO2 = LL_TIM_TIM12_TI1_RMP_MCO2,

  /** TIM12 TI1 is connected to HSE 1MHZ                              */
  HAL_TIM_INPUT_TIM12_TI1_HSE_1MHZ = LL_TIM_TIM12_TI1_RMP_HSE_1MHZ,

  /** TIM12 TI1 is connected to I3C1 IBI ACK                          */
  HAL_TIM_INPUT_TIM12_TI1_I3C1_IBIACK = LL_TIM_TIM12_TI1_RMP_I3C1_IBIACK,

  /** TIM12 TI2 is connected to GPIO                                  */
  HAL_TIM_INPUT_TIM12_TI2_GPIO = LL_TIM_TIM12_TI2_RMP_GPIO,

  /* TIM15 */
  /** TIM15 TI1 is connected to GPIO                                  */
  HAL_TIM_INPUT_TIM15_TI1_GPIO = LL_TIM_TIM15_TI1_RMP_GPIO,

  /** TIM15 TI1 is connected to COMP1 output                          */
  HAL_TIM_INPUT_TIM15_TI1_COMP1 = LL_TIM_TIM15_TI1_RMP_COMP1,

#if defined(COMP2)
  /** TIM15 TI1 is connected to COMP2 output                          */
  HAL_TIM_INPUT_TIM15_TI1_COMP2 = LL_TIM_TIM15_TI1_RMP_COMP2,
#endif /* COMP2 */

  /** TIM15 TI1 is connected to LSE                                   */
  HAL_TIM_INPUT_TIM15_TI1_LSE = LL_TIM_TIM15_TI1_RMP_LSE,

#if defined(FDCAN2)
  /** TIM15 TI1 is connected to FDCAN2 RX EoF event                   */
  HAL_TIM_INPUT_TIM15_TI1_FDCAN2_RXEOF = LL_TIM_TIM15_TI1_RMP_FDCAN2_RXEOF,
#endif /* FDCAN2 */

  /** TIM15 TI2 is connected to GPIO                                  */
  HAL_TIM_INPUT_TIM15_TI2_GPIO = LL_TIM_TIM15_TI2_RMP_GPIO,

#if defined(FDCAN2)
  /** TIM15 TI2 is connected to FDCAN2 TX EoF event                   */
  HAL_TIM_INPUT_TIM15_TI2_FDCAN2_TXEOF = LL_TIM_TIM15_TI2_RMP_FDCAN2_TXEOF,
#endif /* FDCAN2 */

#if defined(TIM16)
  /* TIM16 */
  /** TIM16 TI1 is connected to GPIO                                  */
  HAL_TIM_INPUT_TIM16_TI1_GPIO = LL_TIM_TIM16_TI1_RMP_GPIO,

  /** TIM16 TI1 is connected to COMP1 output                          */
  HAL_TIM_INPUT_TIM16_TI1_COMP1 = LL_TIM_TIM16_TI1_RMP_COMP1,

  /** TIM16 TI1 is connected to LSI                                   */
  HAL_TIM_INPUT_TIM16_TI1_LSI = LL_TIM_TIM16_TI1_RMP_LSI,

  /** TIM16 TI1 is connected to LSE                                   */
  HAL_TIM_INPUT_TIM16_TI1_LSE = LL_TIM_TIM16_TI1_RMP_LSE,

  /** TIM16 TI1 is connected to RTC Wakeup                            */
  HAL_TIM_INPUT_TIM16_TI1_RTC_WKUP = LL_TIM_TIM16_TI1_RMP_RTC_WKUP,

  /** TIM16 TI1 is connected to MCO1                                  */
  HAL_TIM_INPUT_TIM16_TI1_MCO1 = LL_TIM_TIM16_TI1_RMP_MCO1,

  /** TIM16 TI1 is connected to MCO2                                  */
  HAL_TIM_INPUT_TIM16_TI1_MCO2 = LL_TIM_TIM16_TI1_RMP_MCO2,

  /* TIM17 */
  /** TIM17 TI1 is connected to GPIO                                  */
  HAL_TIM_INPUT_TIM17_TI1_GPIO = LL_TIM_TIM17_TI1_RMP_GPIO,

  /** TIM17 TI1 is connected to COMP1 output                          */
  HAL_TIM_INPUT_TIM17_TI1_COMP1 = LL_TIM_TIM17_TI1_RMP_COMP1,

  /** TIM17 TI1 is connected to HSE 1MHZ                              */
  HAL_TIM_INPUT_TIM17_TI1_HSE_1MHZ = LL_TIM_TIM17_TI1_RMP_HSE_1MHZ,

  /** TIM17 TI1 is connected to MCO1                                  */
  HAL_TIM_INPUT_TIM17_TI1_MCO1 = LL_TIM_TIM17_TI1_RMP_MCO1,

  /** TIM17 TI1 is connected to MCO2                                  */
  HAL_TIM_INPUT_TIM17_TI1_MCO2 = LL_TIM_TIM17_TI1_RMP_MCO2,

  /** TIM17 TI1 is connected to I3C1 IBI ACK                          */
  HAL_TIM_INPUT_TIM17_TI1_I3C1_IBIACK = LL_TIM_TIM17_TI1_RMP_I3C1_IBIACK,
#endif /* TIM17 */
...
typedef enum
{
  ...
  HAL_TIM_TRGO_ENCODER_CLK = LL_TIM_TRGO_ENCODERCLK,
...
/**
  * @brief HAL TIM Output Compare Clear (ocrefclr) Source
  */
typedef enum
{
  /** OCREF clear input is connected to ETRF input            */
  HAL_TIM_OCREFCLEAR_ETR = LL_TIM_OCREF_CLR_INT_ETR,

  /** OCREF clear input is connected to COMP1 output          */
  HAL_TIM_OCREFCLEAR_COMP1 = LL_TIM_OCREF_CLR_INT_COMP1,

#if defined(COMP2)
  /** OCREF clear input is connected to COMP2 output          */
  HAL_TIM_OCREFCLEAR_COMP2 = LL_TIM_OCREF_CLR_INT_COMP2,
#endif /* COMP2 */
...
typedef struct
{
  ...
  /** Specifies the period value to be loaded into the active
      ...
      For counter with a 16 bits resolution, this parameter can be a number
      between Min_Data = 0x0001 and Max_Data = 0xFFFF (or 0xFFFEF if dithering
      is activated). In non-dithering mode only bits 15:0 hold the value of the
      period. In dithering mode, the integer part of the period is in bits 19:4
      and bits 3:0 hold the dithering part. \n
      For counter with a 32 bits resolution, this parameter can be a number
  ...
  /** Specifies the clock division for instances that support it */
  hal_tim_clk_division_t clock_division;

  /** Specifies the clock division 2 for instances that support it */
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/** @defgroup TIM_Exported_Functions Timer Exported Functions
  * @{
  */
...
/** @defgroup TIM_Exported_Functions_Group4 Timer Output Channel functions
  ...
  *               are enabled. \n
  *               It is up to the application to read/clear the compare match
  *               flag if needed.
  *             - interrupt mode \n
...
/** @defgroup TIM_Exported_Functions_Group12 Timer Break functions
  ...
  *            feature that is present on certain timers \n(timer peripherals
  *            that feature complementary outputs.)
  *
