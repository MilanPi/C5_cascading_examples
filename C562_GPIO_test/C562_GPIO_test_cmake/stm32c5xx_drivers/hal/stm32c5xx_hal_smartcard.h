...
{
  /*! Instance USART1 */
  HAL_SMARTCARD1 = (uint32_t)USART1,
  /*! Instance USART2 */
  HAL_SMARTCARD2 = (uint32_t)USART2,
  /*! Instance USART3 */
  HAL_SMARTCARD3 = (uint32_t)USART3,
} hal_smartcard_t;
...
{
  /*!< Polarity Low */
  HAL_SMARTCARD_CLOCK_POLARITY_LOW       = LL_USART_POLARITY_LOW,
  /*!< Polarity Low */
  HAL_SMARTCARD_CLOCK_POLARITY_HIGH      = LL_USART_POLARITY_HIGH
...
typedef enum
{
  ...
  HAL_SMARTCARD_CLOCK_PHASE_1_EDGE        = LL_USART_PHASE_1_EDGE,
  /*!< The second clock transition is the first data capture edge */
  HAL_SMARTCARD_CLOCK_PHASE_2_EDGE        = LL_USART_PHASE_2_EDGE
...
struct hal_smartcard_handle_s
{
  ...
  hal_smarcard_tx_cplt_guard_time_indication_t   tx_cplt_indication;
...
typedef struct
{
  uint32_t                           baud_rate;            /*!< Configures the SMARTCARD communication baud rate. The
                                                                ...
                                                                formula:
                                                                baud rate register = usart_ker_ckpres /BaudRate
  ...
  hal_smartcard_bit_order_t          first_bit;            /*!< Specifies whether MSB is sent first on USART line.*/
  ...
  hal_smartcard_clock_output_t       clock_output;         /*!< Specifies whether CLK signal is output or not */
...
hal_smarcard_tx_cplt_guard_time_indication_t HAL_SMARTCARD_GetTxCpltIndication(const hal_smartcard_handle_t
                                                                               *hsmartcard);
