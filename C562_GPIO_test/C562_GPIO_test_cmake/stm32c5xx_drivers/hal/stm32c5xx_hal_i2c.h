...
typedef enum
{
  ...
  HAL_I2C_XFER_LAST_FRAME_NO_STOP   = ((uint32_t) LL_I2C_MODE_SOFTEND),  /*!< Frame no stop */
...
typedef enum
{
  HAL_I2C_ADDRESSING_7BIT  = LL_I2C_ADDRESSING_MODE_7BIT, /*!< 7 bits addressing */
  HAL_I2C_ADDRESSING_10BIT = LL_I2C_ADDRESSING_MODE_10BIT /*!< 10 bits addressing */
...
typedef struct
{
  uint32_t timing;          /*!< I2C_TIMINGR_register value calculated by referring to I2C initialization section
                                 in Reference Manual. This timing is directly calculated by CubeSTUDIO.
                                 Bit 24 to 27 are reserved.
                                 A calculation helper is also available in the package, please look at
                                 stm32_utils_i2c.c/.h */
...
typedef enum
{
  HAL_I2C_MODE_NONE       = 0U, /*!< No I2C communication on going       */
...
typedef enum
{
  HAL_I2C1 = (uint32_t)I2C1, /*!< Peripheral instance I2C1 */
#if defined(I2C2)
  HAL_I2C2 = (uint32_t)I2C2, /*!< Peripheral instance I2C2 */
#endif /* I2C2 */
} hal_i2c_t;
