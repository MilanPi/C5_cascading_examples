...
/* Exported constants ------------------------------------------------------------------------------------------------*/
/** @defgroup CRS_Exported_Constants CRS Exported Constants
  * @{
  */
...
#define HAL_CRS_ERROR_SYNC_ERROR    (1U << 0U)      /*!< Frequency error too big (internal frequency too low) */
#define HAL_CRS_ERROR_SYNC_MISSED   (1U << 1U)      /*!< Synchronization pulse missed or frequency error too big
                                                         (internal frequency too high) */
#define HAL_CRS_ERROR_TRIMMING      (1U << 2U)      /*!< Automatic trimming over- or under-flows the trimming value */
...
typedef enum
{
  HAL_CRS_AUTO_TRIMMING_DISABLE = LL_CRS_AUTO_TRIMMING_DISABLE,  /*!< Auto trimming disable (default) */
  HAL_CRS_AUTO_TRIMMING_ENABLE  = LL_CRS_AUTO_TRIMMING_ENABLE    /*!< Auto trimming enable */
...
typedef enum
{
  HAL_CRS1 = (uint32_t)CRS        /*!< Instance CRS */
} hal_crs_t;
/**
  * @}
  */
...
typedef  void (*hal_crs_cb_t)(hal_crs_handle_t *hcrs); /*!< Pointer to a CRS callback functions */
