...
{
#if defined(SPI1)
  HAL_SPI1 = (uint32_t)SPI1,      /*!< SPI1 instance  */
#endif /* SPI1 */
#if defined(SPI2)
  HAL_SPI2 = (uint32_t)SPI2,      /*!< SPI2 instance  */
#endif /* SPI2 */
#if defined(SPI3)
  HAL_SPI3 = (uint32_t)SPI3,      /*!< SPI3 instance  */
#endif /* SPI3 */
} hal_spi_t;
...
typedef enum
{
  ...
  HAL_SPI_UNDERRUN_BEHAV_LAST_RECEIVED     = LL_SPI_UNDERRUN_CONFIG_LAST_RECEIVED,       /*!< Slave repeats lastly
