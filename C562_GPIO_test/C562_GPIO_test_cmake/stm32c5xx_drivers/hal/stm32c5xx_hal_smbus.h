...
typedef enum
{
  HAL_SMBUS1 = (uint32_t)I2C1,                                           /*!< Peripheral instance I2C1 */
#if defined(I2C2)
  HAL_SMBUS2 = (uint32_t)I2C2,                                           /*!< Peripheral instance I2C2 */
#endif /* I2C2 */
} hal_smbus_t;
...
typedef enum
{
  ...
  HAL_SMBUS_STATE_IDLE         = (1UL << 30U), /*!< Initialized and a global config applied                      */
  ...
  HAL_SMBUS_STATE_ABORT        = (1UL << 24U), /*!< Abort user request ongoing                                   */
} hal_smbus_state_t;
...
typedef struct
{
  uint32_t         timing;          /*!< SMBUS_TIMINGR_register value calculated by referring to SMBUS initialization
                                     section in Reference Manual. This timing is directly calculated by CubeSTUDIO.
