...
typedef enum
{
  HAL_RNG = (uint32_t)RNG /*!< RNG instance */
} hal_rng_t;
...
typedef enum
{
  ...
  HAL_RNG_STATE_ACTIVE = (1UL << 29U), /*!< RNG generation random number is ongoing */
...
typedef void (*hal_rng_cb_t)(hal_rng_handle_t *hrng); /*!< Pointer to a RNG callback functions */
