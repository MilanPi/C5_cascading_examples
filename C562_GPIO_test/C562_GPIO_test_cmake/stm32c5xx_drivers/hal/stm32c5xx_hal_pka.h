...
/** @defgroup PKA_Error_Code_definition PKA Error Code definition
  * @{
  */
#define HAL_PKA_ERROR_NONE      0x00U               /*!< PKA code error none */
...
typedef enum
{
  HAL_PKA1 = (uint32_t)PKA  /*!< HAL PKA instance */
} hal_pka_t;
...
typedef enum
{
  PKA_ECC_POINT_NOT_ON_CURVE = 0U, /*!< The ECC point is not on curve */
  PKA_ECC_POINT_ON_CURVE     = 1U  /*!< The ECC point is on curve     */
} hal_pka_ecc_point_status_t;

/**
  * @brief PKA ECC scalar multiplication configuration structure definition
  */
typedef struct
{
  uint32_t      prime_order_size_byte; /*!< Number of element in p_prime_order array                                */
  uint32_t      scalar_mul_size_byte;  /*!< Number of element in p_scalar_mul array                                 */
  uint32_t      modulus_size_byte;     /*!< Number of element in p_modulus, p_coeff_a, p_pt_x and p_pt_y arrays     */
...
typedef struct
{
  uint32_t      modulus_size_byte;   /*!< Number of element in p_coeff_a, p_coeff_b, p_modulus, p_pt_x and p_pt_y
                                          arrays                                                                 */
  uint32_t      coeff_sign;          /*!< Curve coefficient a sign                                               */
  const uint8_t *p_montgomery_param; /*!< pointer to montgomery param(Array of modulus_size_byte)                */
...
typedef struct
{
  uint32_t      size_byte;       /*!< Number of element in p_operand_a array                  */
...
typedef struct
{
  uint32_t      private_key_size_byte; /*!< Number of element in p_private_key array                            */
  uint32_t      hash_size_byte;        /*!< Number of element in p_hash array                                   */
...
typedef struct
{
  uint32_t      public_key_size_byte; /*!< Number of element in p_public_key array                             */
  uint32_t      sign_size_byte;       /*!< Number of element in p_sign array                                   */
...
typedef struct
{
  uint32_t      prime_order_size_byte; /*!< Number of element in prime order array                                    */
...
/**
  * @brief PKA elliptic curves over prime fields signature configuration structure definition
  */
typedef struct
{
  uint32_t      prime_order_size_byte; /*!< Number of element in p_prime_order array                               */
  uint32_t      modulus_size_byte;     /*!< Number of element in p_modulus array                                   */
  uint32_t      coeff_sign;            /*!< Curve coefficient a sign                                               */
  const uint8_t *p_coeff;              /*!< Pointer to curve coefficient |a| (Array of modulus_size_byte elements) */
...
/**
  * @brief PKA elliptic curves over prime fields output structure definition
  */
typedef struct
{
...
} hal_pka_ecdsa_signature_result_ext_config_t, hal_pka_ecc_mul_result_t, hal_pka_ecc_projective_to_affine_result_t,
...
typedef struct
{
  uint32_t      exponent_size_byte; /*!< Number of element in p_exponent array                      */
  uint32_t      operand_size_byte;  /*!< Number of element in p_operand and pMod arrays             */
...
typedef struct
{
  uint32_t      exponent_size_byte;  /*!< Number of element in p_exponent and p_montgomery_param arrays            */
  uint32_t      operand_size_byte;   /*!< Number of element in p_operand and p_modulus arrays                      */
  const uint8_t *p_exponent;         /*!< Pointer to Exponent (Array of exponent_size_byte elements)               */
  const uint8_t *p_operand;          /*!< Pointer to Operand (Array of operand_size_byte elements)                 */
  const uint8_t *p_modulus;          /*!< Pointer to modulus (Array of operand_size_byte elements)                 */
...
typedef struct
{
  uint32_t      size_byte;  /*!< Number of element in p_operand array             */
...
typedef struct
{
  uint32_t      size_byte;    /*!< Number of element in p_operand_1 and p_operand_2 arrays */
...
typedef struct
{
  uint32_t      size_byte;  /*!< Number of element in p_operand and p_modulus arrays      */
  const uint8_t *p_operand; /*!< Pointer to Operand (Array of size_byte elements)         */
...
typedef struct
{
  uint32_t      operand_size_byte; /*!< Number of element in p_operand array                             */
  uint32_t      modulus_size_byte; /*!< Number of element in p_modulus array                             */
  const uint8_t *p_operand;        /*!< Pointer to Operand (Array of operand_size_byte elements)         */
...
uint32_t HAL_PKA_ECDSA_GetResultSignature(hal_pka_handle_t *hpka,
                                          hal_pka_ecdsa_signature_result_t *p_result,
