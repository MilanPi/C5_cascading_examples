...
typedef enum
{
  HAL_COMP_POWER_MODE_HIGH_SPEED        = LL_COMP_POWERMODE_HIGHSPEED,    /*!< Comparator power mode to high speed */
  HAL_COMP_POWER_MODE_MEDIUM_SPEED      = LL_COMP_POWERMODE_MEDIUMSPEED,  /*!< Comparator power mode to medium speed */
  HAL_COMP_POWER_MODE_ULTRA_LOW_POWER   = LL_COMP_POWERMODE_ULTRALOWPOWER /*!< Comparator power mode to ultra-low
                                        power */
...
typedef enum
{
  ...
  HAL_COMP_INPUT_PLUS_DAC1_CH1          = LL_COMP_INPUT_MINUS_DAC1_CH1, /*!< Comparator input plus connected to
                                        DAC1 channel 1 */
...
/**
  ...
  *        - with @ref HAL_COMP_Start_IT(): generates a system wake-up event and a CPU interruption
  */
typedef enum
{
