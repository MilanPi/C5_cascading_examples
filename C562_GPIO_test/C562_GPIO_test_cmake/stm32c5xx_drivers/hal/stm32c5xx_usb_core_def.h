/**
  ...
  * @brief   Header file of USB CORE Driver module.
  ******************************************************************************
  * @attention
  *
...
/* Private constants ---------------------------------------------------------*/
#ifndef USB_CORE_CURRENT_MODE_MAX_DELAY_MS
#define USB_CORE_CURRENT_MODE_MAX_DELAY_MS                                 200U
#endif /* define USB_CORE_CURRENT_MODE_MAX_DELAY_MS */

#define USB_CORE_MIN(a, b)                             (((a) < (b)) ? (a) : (b))
#define USB_CORE_MAX(a, b)                             (((a) > (b)) ? (a) : (b))

#define USB_CORE_IN_EP_DIR_MSK                0x80U    /*!< IN Endpoint Direction Mask */

/**
  * @brief  USB CORE high speed Test Modes definition
  */
#define USB_CORE_HSET_J                      0x01U    /*!< TEST J            */
#define USB_CORE_HSET_K                      0x02U    /*!< TEST K            */
#define USB_CORE_HSET_SE0_NAK                0x03U    /*!< TEST SE0 NAK      */
#define USB_CORE_HSET_PACKET                 0x04U    /*!< TEST PACKET       */
#define USB_CORE_HSET_FORCE_EN               0x05U    /*!< TEST FORCE ENABLE */
...
typedef enum
{
  ...
  USB_CORE_DEVICE_SPEED_HS = 0x02U,              /*!< USB CORE DEVICE SPEED HIDH  */
  USB_CORE_DEVICE_SPEED_ERROR = 0xFFU,           /*!< USB CORE DEVICE SPEED EROOR */
...
typedef struct
{
  ...
  usb_core_config_satus_t dma_state;
  usb_core_config_satus_t sof_state;
  usb_core_config_satus_t bcd_state;
  usb_core_config_satus_t vbus_sense_state;
  usb_core_config_satus_t iso_db_state;
  usb_core_config_satus_t bulk_db_state;
