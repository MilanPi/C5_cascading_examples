...
{
  /*! Instance USART1 */
  HAL_USART1 = (uint32_t)USART1,
  /*! Instance USART2 */
  HAL_USART2 = (uint32_t)USART2,
  /*! Instance USART3 */
  HAL_USART3 = (uint32_t)USART3,
...
typedef enum
{
  ...
  HAL_USART_CLOCK_LOW                       = LL_USART_POLARITY_LOW,
  /*! Steady high value on SCLK pin outside transmission window */
  HAL_USART_CLOCK_HIGH                      = LL_USART_POLARITY_HIGH,
...
typedef enum
{
  ...
  HAL_USART_CLOCK_PHASE_1_EDGE              = LL_USART_PHASE_1_EDGE,
  /*! USART frame phase on second clock transition */
  HAL_USART_CLOCK_PHASE_2_EDGE              = LL_USART_PHASE_2_EDGE,
...
#if defined (USE_HAL_USART_USER_DATA) && (USE_HAL_USART_USER_DATA == 1)
/** @defgroup USART_Exported_Functions_Group11 User Data Function
  * @{
  */
