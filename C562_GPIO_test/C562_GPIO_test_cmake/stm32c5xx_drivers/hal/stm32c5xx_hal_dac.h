...
typedef enum
{
  ...
  HAL_DAC_TRIGGER_LPTIM1_CH1          = LL_DAC_TRIGGER_LPTIM1_CH1,          /*!< LPTIM1 CH1 selected as external conversion trigger for DAC channel. */
...
typedef enum
{
  HAL_DAC_DATA_ALIGN_12_BITS_RIGHT = 0x00000000U, /*!< Data have to be written into 12 bits right alignment */
  HAL_DAC_DATA_ALIGN_12_BITS_LEFT  = 0x00000001U, /*!< Data have to be written into 12 bits left  alignment */
  HAL_DAC_DATA_ALIGN_8_BITS_RIGHT  = 0x00000002U  /*!< Data have to be written into  8 bits right alignment */
...
/**
  ...
  *        whatever this hal_dac_output_connection_t value.
  */
typedef enum
{
...
typedef enum
{
  HAL_DAC_SAMPLE_AND_HOLD_DISABLED = LL_DAC_OUTPUT_MODE_NORMAL,         /*!< The output is on normal mode */
  HAL_DAC_SAMPLE_AND_HOLD_ENABLED  = LL_DAC_OUTPUT_MODE_SAMPLE_AND_HOLD /*!< The output is on sample-and-hold mode.
...
typedef enum
{
  HAL_DAC_HIGH_FREQ_MODE_DISABLED     = LL_DAC_HIGH_FREQ_MODE_DISABLE,     /*!< High frequency interface mode disabled*/
...
/**
  ...
  *         declared and used has bit fields in HAL_DAC_GetLastError()
  */
