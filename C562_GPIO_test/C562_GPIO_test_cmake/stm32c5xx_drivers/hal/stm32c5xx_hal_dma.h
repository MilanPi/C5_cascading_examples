...
typedef enum
{
  ...
  HAL_LPDMA1_CH4  = (uint32_t)LPDMA1_CH4,  /*!< LPDMA1 Channel 4  */
#endif /* LPDMA1_CH4 */
#if defined(LPDMA1_CH5)
  HAL_LPDMA1_CH5  = (uint32_t)LPDMA1_CH5,  /*!< LPDMA1 Channel 5  */
#endif /* LPDMA1_CH5 */
#if defined(LPDMA1_CH6)
  HAL_LPDMA1_CH6  = (uint32_t)LPDMA1_CH6,  /*!< LPDMA1 Channel 6  */
#endif /* LPDMA1_CH6 */
#if defined(LPDMA1_CH7)
  HAL_LPDMA1_CH7  = (uint32_t)LPDMA1_CH7,  /*!< LPDMA1 Channel 7  */
#endif /* LPDMA1_CH7 */

  /* LPDMA2 channel instances */
  HAL_LPDMA2_CH0  = (uint32_t)LPDMA2_CH0,  /*!< LPDMA2 Channel 0 */
  HAL_LPDMA2_CH1  = (uint32_t)LPDMA2_CH1,  /*!< LPDMA2 Channel 1 */
  HAL_LPDMA2_CH2  = (uint32_t)LPDMA2_CH2,  /*!< LPDMA2 Channel 2 */
  HAL_LPDMA2_CH3  = (uint32_t)LPDMA2_CH3,  /*!< LPDMA2 Channel 3 */
#if defined(LPDMA2_CH4)
  HAL_LPDMA2_CH4  = (uint32_t)LPDMA2_CH4,  /*!< LPDMA2 Channel 4  */
#endif /* LPDMA2_CH4 */
#if defined(LPDMA2_CH5)
  HAL_LPDMA2_CH5  = (uint32_t)LPDMA2_CH5,  /*!< LPDMA2 Channel 5  */
#endif /* LPDMA2_CH5 */
#if defined(LPDMA2_CH6)
  HAL_LPDMA2_CH6  = (uint32_t)LPDMA2_CH6,  /*!< LPDMA2 Channel 6  */
#endif /* LPDMA2_CH6 */
#if defined(LPDMA2_CH7)
  HAL_LPDMA2_CH7  = (uint32_t)LPDMA2_CH7   /*!< LPDMA2 Channel 7  */
#endif /* LPDMA2_CH7 */
} hal_dma_channel_t;
...
#endif /* SAES */
#if defined(XSPI1)
  HAL_LPDMA1_REQUEST_XSPI1_RX      = LL_LPDMA1_REQUEST_XSPI1_RX,     /*!< LPDMA1 HW request is XSPI1_RX     */
#endif /* XSPI1 */
...
#endif /* SAES */
#if defined(XSPI1)
  HAL_LPDMA2_REQUEST_XSPI1_RX      = LL_LPDMA2_REQUEST_XSPI1_RX,     /*!< LPDMA2 HW request is XSPI1_RX     */
#endif /* XSPI1 */
                                            ...
                                            uint32_t node_addr_offset)
{
  ...
  MODIFY_REG((*(uint32_t *)(prev_node_addr + node_addr_offset)), (LL_DMA_UPDATE_ALL | DMA_CLLR_LA),
